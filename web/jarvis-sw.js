...
const CACHE_VERSION = "jarvis-mobile-shell-20260809-action2";
const SHELL = [
  "/",
  "/ui/manifest.webmanifest?v=20260809-action2",
  "/ui/jarvis-icon.svg?v=20260809-action2",
  "/ui/jarvis.css?v=20260809-action2",
  "/ui/jarvis.js?v=20260809-action2",
];

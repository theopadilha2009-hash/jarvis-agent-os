...
const CACHE_VERSION = "jarvis-mobile-shell-20260813-composer1";
const SHELL = [
  "/",
  "/ui/manifest.webmanifest?v=20260813-composer1",
  "/ui/jarvis-logo.png?v=20260813-composer1",
  "/ui/jarvis.css?v=20260813-composer1",
  "/ui/api-vault.js?v=20260813-composer1",
  "/ui/jarvis.js?v=20260813-composer1",
  "/ui/jarvis-3d.js?v=20260813-composer1",
  "/ui/aurora.js?v=20260813-composer1",
  "/ui/strands.js?v=20260813-composer1",

...
const CACHE_VERSION = "jarvis-mobile-shell-20260820-update1";
const SHELL = [
  "/",
  "/cockpit",
  "/ui/manifest.webmanifest?v=20260813-apitools1",
  "/ui/jarvis-logo.png?v=20260813-logonative1",
  "/ui/jarvis.css?v=20260820-update1",
  ...
  "/ui/jarvis.js?v=20260820-update1",

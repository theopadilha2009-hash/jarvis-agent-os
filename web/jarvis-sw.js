...
const CACHE_VERSION = "jarvis-mobile-shell-20260815-chegada1";
const SHELL = [
  "/",
  "/ui/manifest.webmanifest?v=20260813-apitools1",
  "/ui/jarvis-logo.png?v=20260813-logonative1",
  "/ui/jarvis.css?v=20260815-chegada1",
  "/ui/ui-repair.css?v=20260815-chegada1",
  ...
  "/ui/ultron-completion.css?v=20260815-chegada1",
  "/ui/responsive-polish.css?v=20260815-chegada1",
  "/ui/shell.css?v=20260815-chegada1",
  "/ui/api-vault.js?v=20260813-ultronfix1",
  "/ui/integration-history.js?v=20260813-ultronfix1",
  "/ui/feature-loader.js?v=20260815-chegada1",
  ...
  "/ui/jarvis.js?v=20260815-chegada1",
  "/ui/jarvis-3d.js?v=20260815-chegada1",

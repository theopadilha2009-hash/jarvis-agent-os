...
const CACHE_VERSION = "jarvis-mobile-shell-20260813-memory1";
const SHELL = [
  "/",
  "/ui/manifest.webmanifest?v=20260813-apitools1",
  "/ui/jarvis-logo.png?v=20260813-logonative1",
  "/ui/jarvis.css?v=20260813-memory1",
  "/ui/ui-repair.css?v=20260813-uipolish1",
  "/ui/api-panel.css?v=20260813-memory1",
  "/ui/integration-health.css?v=20260813-memory1",
  "/ui/voice-calibrator.css?v=20260813-memory1",
  "/ui/memory-explorer.css?v=20260813-memory1",
  "/ui/responsive-polish.css?v=20260813-memory1",
  "/ui/api-vault.js?v=20260813-memory1",
  "/ui/integration-history.js?v=20260813-memory1",
  "/ui/feature-loader.js?v=20260813-memory1",
  "/ui/integration-health.js?v=20260813-memory1",
  "/ui/voice-calibrator.js?v=20260813-memory1",
  "/ui/n8n-template-pack.js?v=20260813-memory1",
  "/ui/memory-explorer.js?v=20260813-memory1",
  "/ui/voice-pacing.js?v=20260813-voice2",
  "/ui/jarvis.js?v=20260813-memory1",

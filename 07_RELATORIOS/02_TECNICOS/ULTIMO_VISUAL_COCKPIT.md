...
|---------------|-----------------|------|----------|
| quality-gate  | COM PENDÊNCIAS  | live | (inline) |
| smoke-test    | PASSOU          | 19s  | 10_TESTES/SMOKE_TESTS/2026-05-24_10-11-52-494517_cli-smoke-test.md |
| release-check | PASSOU          | 2s   | 10_TESTES/RELEASE_CHECKS/2026-05-24_10-12-10-002678_release-check.md |
| safety-gate   | PASSOU          | 0s   | 10_TESTES/SAFETY_GATES/2026-05-24_10-12-11-501235_safety-gate.md |
...
- rever `git status --short` e commitar/limpar antes de seguir
- rodar `./jarvis safety-gate` e resolver gate em FALHA/PENDÊNCIA

## Blocked / pending
- git status sujo — pendências locais para commit/limpar
- quality-gate: COM PENDÊNCIAS

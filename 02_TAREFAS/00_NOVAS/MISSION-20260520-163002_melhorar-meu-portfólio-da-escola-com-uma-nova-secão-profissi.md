...
## Pedido original
melhorar meu portfólio da escola com uma nova seção profissional sobre projetos de IA e automação
...
## Ferramenta sugerida
CHATGPT_COCKPIT + CLAUDE/GEMINI manual futuro

## Modo de execução
branch/local

## Motivo do roteamento
Site/portfólio pode ser editado em branch/local e publicado só com aprovação.

...
## Tarefa
oficina revisar tarefa segura sem deploy
...
```bash
./jarvis mode-plan "oficina revisar tarefa segura sem deploy"
./jarvis readonly-run "oficina revisar tarefa segura sem deploy"
./jarvis local-exec-plan "oficina revisar tarefa segura sem deploy"
./jarvis local-exec-ready "oficina revisar tarefa segura sem deploy"
./jarvis local-exec-handoff "oficina revisar tarefa segura sem deploy"

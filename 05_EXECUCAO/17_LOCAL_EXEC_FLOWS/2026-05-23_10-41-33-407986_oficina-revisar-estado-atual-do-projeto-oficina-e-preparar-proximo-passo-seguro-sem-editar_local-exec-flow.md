...
```bash
./jarvis mode-plan "oficina revisar estado atual do projeto oficina e preparar proximo passo seguro sem editar sem deploy"
./jarvis readonly-run "oficina revisar estado atual do projeto oficina e preparar proximo passo seguro sem editar sem deploy"
./jarvis local-exec-plan "oficina revisar estado atual do projeto oficina e preparar proximo passo seguro sem editar sem deploy"
./jarvis local-exec-ready "oficina revisar estado atual do projeto oficina e preparar proximo passo seguro sem editar sem deploy"
./jarvis local-exec-handoff "oficina revisar estado atual do projeto oficina e preparar proximo passo seguro sem editar sem deploy"

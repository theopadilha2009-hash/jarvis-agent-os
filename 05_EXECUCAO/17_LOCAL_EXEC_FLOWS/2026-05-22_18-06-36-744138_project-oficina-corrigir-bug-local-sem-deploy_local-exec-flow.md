...
```bash
./jarvis mode-plan "--project oficina corrigir bug local sem deploy"
./jarvis readonly-run "--project oficina corrigir bug local sem deploy"
./jarvis local-exec-plan "--project oficina corrigir bug local sem deploy"
./jarvis local-exec-ready "--project oficina corrigir bug local sem deploy"
./jarvis local-exec-handoff "--project oficina corrigir bug local sem deploy"

...
## Tarefa
tarefa real pequena sem deploy
...
```bash
./jarvis mode-plan "tarefa real pequena sem deploy"
./jarvis readonly-run "tarefa real pequena sem deploy"
./jarvis local-exec-plan "tarefa real pequena sem deploy"
./jarvis local-exec-ready "tarefa real pequena sem deploy"
./jarvis local-exec-handoff "tarefa real pequena sem deploy"

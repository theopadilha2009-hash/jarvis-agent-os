...
FEATURE = {'slug': 'audit_optimizer', 'title': 'Jarvis Pool Audit Optimizer', 'objective': 'Generate an automated optimizer for the audit area using local repo signals.', 'domain': 'audit', 'action': 'optimizer'}

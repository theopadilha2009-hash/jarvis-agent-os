...
FEATURE = {'slug': 'release_checkpoint', 'title': 'Jarvis Pool Release Checkpoint', 'objective': 'Generate an automated checkpoint for the release area using local repo signals.', 'domain': 'release', 'action': 'checkpoint'}

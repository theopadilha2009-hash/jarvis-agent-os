...
FEATURE = {'slug': 'architecture_coordinator', 'title': 'Jarvis Pool Architecture Coordinator', 'objective': 'Generate an automated coordinator for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'coordinator'}

...
FEATURE = {'slug': 'session_planner', 'title': 'Jarvis Pool Session Planner', 'objective': 'Generate an automated planner for the session area using local repo signals.', 'domain': 'session', 'action': 'planner'}

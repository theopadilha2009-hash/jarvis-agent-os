...
FEATURE = {'slug': 'growth_planner', 'title': 'Jarvis Pool Growth Planner', 'objective': 'Generate an automated planner for the growth area using local repo signals.', 'domain': 'growth', 'action': 'planner'}

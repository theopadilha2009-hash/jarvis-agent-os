...
FEATURE = {'slug': 'validation_tracker', 'title': 'Jarvis Pool Validation Tracker', 'objective': 'Generate an automated tracker for the validation area using local repo signals.', 'domain': 'validation', 'action': 'tracker'}

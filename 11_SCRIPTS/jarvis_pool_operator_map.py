...
FEATURE = {'slug': 'operator_map', 'title': 'Jarvis Pool Operator Map', 'objective': 'Generate an automated map for the operator area using local repo signals.', 'domain': 'operator', 'action': 'map'}

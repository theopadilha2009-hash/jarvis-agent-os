...
FEATURE = {'slug': 'doctor_review', 'title': 'Jarvis Pool Doctor Review', 'objective': 'Generate an automated review for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'review'}

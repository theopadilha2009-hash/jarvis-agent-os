...
FEATURE = {'slug': 'doctor_checkpoint', 'title': 'Jarvis Pool Doctor Checkpoint', 'objective': 'Generate an automated checkpoint for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'checkpoint'}

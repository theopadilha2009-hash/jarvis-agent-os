...
FEATURE = {'slug': 'release_catalog', 'title': 'Jarvis Pool Release Catalog', 'objective': 'Generate an automated catalog for the release area using local repo signals.', 'domain': 'release', 'action': 'catalog'}

...
FEATURE = {'slug': 'autonomy_map', 'title': 'Jarvis Pool Autonomy Map', 'objective': 'Generate an automated map for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'map'}

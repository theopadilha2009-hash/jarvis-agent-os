...
FEATURE = {'slug': 'builder_checkpoint', 'title': 'Jarvis Pool Builder Checkpoint', 'objective': 'Generate an automated checkpoint for the builder area using local repo signals.', 'domain': 'builder', 'action': 'checkpoint'}

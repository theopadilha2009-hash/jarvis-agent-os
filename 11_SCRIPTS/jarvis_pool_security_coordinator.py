...
FEATURE = {'slug': 'security_coordinator', 'title': 'Jarvis Pool Security Coordinator', 'objective': 'Generate an automated coordinator for the security area using local repo signals.', 'domain': 'security', 'action': 'coordinator'}

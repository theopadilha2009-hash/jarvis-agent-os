...
FEATURE = {'slug': 'git_cleaner', 'title': 'Jarvis Pool Git Cleaner', 'objective': 'Generate an automated cleaner for the git area using local repo signals.', 'domain': 'git', 'action': 'cleaner'}

...
FEATURE = {'slug': 'doctor_check', 'title': 'Jarvis Pool Doctor Check', 'objective': 'Generate an automated check for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'check'}

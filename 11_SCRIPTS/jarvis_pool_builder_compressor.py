...
FEATURE = {'slug': 'builder_compressor', 'title': 'Jarvis Pool Builder Compressor', 'objective': 'Generate an automated compressor for the builder area using local repo signals.', 'domain': 'builder', 'action': 'compressor'}

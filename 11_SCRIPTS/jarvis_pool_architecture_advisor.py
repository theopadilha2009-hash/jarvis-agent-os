...
FEATURE = {'slug': 'architecture_advisor', 'title': 'Jarvis Pool Architecture Advisor', 'objective': 'Generate an automated advisor for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'advisor'}

...
FEATURE = {'slug': 'repo_advisor', 'title': 'Jarvis Pool Repo Advisor', 'objective': 'Generate an automated advisor for the repo area using local repo signals.', 'domain': 'repo', 'action': 'advisor'}

...
FEATURE = {'slug': 'builder_explainer', 'title': 'Jarvis Pool Builder Explainer', 'objective': 'Generate an automated explainer for the builder area using local repo signals.', 'domain': 'builder', 'action': 'explainer'}

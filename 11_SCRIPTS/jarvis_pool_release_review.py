...
FEATURE = {'slug': 'release_review', 'title': 'Jarvis Pool Release Review', 'objective': 'Generate an automated review for the release area using local repo signals.', 'domain': 'release', 'action': 'review'}

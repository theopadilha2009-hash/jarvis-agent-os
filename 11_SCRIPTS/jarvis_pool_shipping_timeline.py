...
FEATURE = {'slug': 'shipping_timeline', 'title': 'Jarvis Pool Shipping Timeline', 'objective': 'Generate an automated timeline for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'timeline'}

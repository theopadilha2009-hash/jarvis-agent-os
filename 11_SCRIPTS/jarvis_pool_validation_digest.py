...
FEATURE = {'slug': 'validation_digest', 'title': 'Jarvis Pool Validation Digest', 'objective': 'Generate an automated digest for the validation area using local repo signals.', 'domain': 'validation', 'action': 'digest'}

...
FEATURE = {'slug': 'dashboard_timeline', 'title': 'Jarvis Pool Dashboard Timeline', 'objective': 'Generate an automated timeline for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'timeline'}

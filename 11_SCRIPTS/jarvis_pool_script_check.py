...
FEATURE = {'slug': 'script_check', 'title': 'Jarvis Pool Script Check', 'objective': 'Generate an automated check for the script area using local repo signals.', 'domain': 'script', 'action': 'check'}

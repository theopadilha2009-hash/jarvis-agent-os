...
FEATURE = {'slug': 'performance_matrix', 'title': 'Jarvis Pool Performance Matrix', 'objective': 'Generate an automated matrix for the performance area using local repo signals.', 'domain': 'performance', 'action': 'matrix'}

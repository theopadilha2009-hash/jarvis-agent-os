...
FEATURE = {'slug': 'memory_digest', 'title': 'Jarvis Pool Memory Digest', 'objective': 'Generate an automated digest for the memory area using local repo signals.', 'domain': 'memory', 'action': 'digest'}

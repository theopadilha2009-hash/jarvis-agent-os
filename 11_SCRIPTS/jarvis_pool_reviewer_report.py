...
FEATURE = {'slug': 'reviewer_report', 'title': 'Jarvis Pool Reviewer Report', 'objective': 'Generate an automated report for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'report'}

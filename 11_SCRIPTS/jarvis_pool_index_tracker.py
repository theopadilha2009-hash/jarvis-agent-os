...
FEATURE = {'slug': 'index_tracker', 'title': 'Jarvis Pool Index Tracker', 'objective': 'Generate an automated tracker for the index area using local repo signals.', 'domain': 'index', 'action': 'tracker'}

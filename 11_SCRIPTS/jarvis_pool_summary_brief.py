...
FEATURE = {'slug': 'summary_brief', 'title': 'Jarvis Pool Summary Brief', 'objective': 'Generate an automated brief for the summary area using local repo signals.', 'domain': 'summary', 'action': 'brief'}

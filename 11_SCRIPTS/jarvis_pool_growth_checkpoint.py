...
FEATURE = {'slug': 'growth_checkpoint', 'title': 'Jarvis Pool Growth Checkpoint', 'objective': 'Generate an automated checkpoint for the growth area using local repo signals.', 'domain': 'growth', 'action': 'checkpoint'}

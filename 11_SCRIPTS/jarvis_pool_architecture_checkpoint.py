...
FEATURE = {'slug': 'architecture_checkpoint', 'title': 'Jarvis Pool Architecture Checkpoint', 'objective': 'Generate an automated checkpoint for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'checkpoint'}

...
FEATURE = {'slug': 'backup_guard', 'title': 'Jarvis Pool Backup Guard', 'objective': 'Generate an automated guard for the backup area using local repo signals.', 'domain': 'backup', 'action': 'guard'}

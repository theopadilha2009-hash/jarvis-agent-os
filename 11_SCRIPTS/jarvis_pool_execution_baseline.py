...
FEATURE = {'slug': 'execution_baseline', 'title': 'Jarvis Pool Execution Baseline', 'objective': 'Generate an automated baseline for the execution area using local repo signals.', 'domain': 'execution', 'action': 'baseline'}

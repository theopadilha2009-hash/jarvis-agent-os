...
FEATURE = {'slug': 'operator_review', 'title': 'Jarvis Pool Operator Review', 'objective': 'Generate an automated review for the operator area using local repo signals.', 'domain': 'operator', 'action': 'review'}

...
FEATURE = {'slug': 'git_snapshot', 'title': 'Jarvis Pool Git Snapshot', 'objective': 'Generate an automated snapshot for the git area using local repo signals.', 'domain': 'git', 'action': 'snapshot'}

...
FEATURE = {'slug': 'performance_baseline', 'title': 'Jarvis Pool Performance Baseline', 'objective': 'Generate an automated baseline for the performance area using local repo signals.', 'domain': 'performance', 'action': 'baseline'}

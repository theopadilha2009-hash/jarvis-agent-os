...
FEATURE = {'slug': 'architecture_compressor', 'title': 'Jarvis Pool Architecture Compressor', 'objective': 'Generate an automated compressor for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'compressor'}

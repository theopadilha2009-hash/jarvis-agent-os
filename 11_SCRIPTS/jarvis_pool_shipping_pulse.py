...
FEATURE = {'slug': 'shipping_pulse', 'title': 'Jarvis Pool Shipping Pulse', 'objective': 'Generate an automated pulse for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'pulse'}

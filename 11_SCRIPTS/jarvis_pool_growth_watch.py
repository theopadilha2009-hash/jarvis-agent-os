...
FEATURE = {'slug': 'growth_watch', 'title': 'Jarvis Pool Growth Watch', 'objective': 'Generate an automated watch for the growth area using local repo signals.', 'domain': 'growth', 'action': 'watch'}

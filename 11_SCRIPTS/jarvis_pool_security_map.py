...
FEATURE = {'slug': 'security_map', 'title': 'Jarvis Pool Security Map', 'objective': 'Generate an automated map for the security area using local repo signals.', 'domain': 'security', 'action': 'map'}

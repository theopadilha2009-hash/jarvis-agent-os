...
FEATURE = {'slug': 'planning_checkpoint', 'title': 'Jarvis Pool Planning Checkpoint', 'objective': 'Generate an automated checkpoint for the planning area using local repo signals.', 'domain': 'planning', 'action': 'checkpoint'}

...
FEATURE = {'slug': 'builder_scanner', 'title': 'Jarvis Pool Builder Scanner', 'objective': 'Generate an automated scanner for the builder area using local repo signals.', 'domain': 'builder', 'action': 'scanner'}

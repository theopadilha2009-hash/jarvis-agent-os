...
FEATURE = {'slug': 'dashboard_tracker', 'title': 'Jarvis Pool Dashboard Tracker', 'objective': 'Generate an automated tracker for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'tracker'}

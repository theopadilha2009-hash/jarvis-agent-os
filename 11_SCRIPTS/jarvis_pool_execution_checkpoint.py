...
FEATURE = {'slug': 'execution_checkpoint', 'title': 'Jarvis Pool Execution Checkpoint', 'objective': 'Generate an automated checkpoint for the execution area using local repo signals.', 'domain': 'execution', 'action': 'checkpoint'}

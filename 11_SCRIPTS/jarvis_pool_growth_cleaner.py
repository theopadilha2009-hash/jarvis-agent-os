...
FEATURE = {'slug': 'growth_cleaner', 'title': 'Jarvis Pool Growth Cleaner', 'objective': 'Generate an automated cleaner for the growth area using local repo signals.', 'domain': 'growth', 'action': 'cleaner'}

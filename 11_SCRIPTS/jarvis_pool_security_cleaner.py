...
FEATURE = {'slug': 'security_cleaner', 'title': 'Jarvis Pool Security Cleaner', 'objective': 'Generate an automated cleaner for the security area using local repo signals.', 'domain': 'security', 'action': 'cleaner'}

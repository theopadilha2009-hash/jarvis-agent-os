...
FEATURE = {'slug': 'health_tracker', 'title': 'Jarvis Pool Health Tracker', 'objective': 'Generate an automated tracker for the health area using local repo signals.', 'domain': 'health', 'action': 'tracker'}

...
FEATURE = {'slug': 'shipping_tracker', 'title': 'Jarvis Pool Shipping Tracker', 'objective': 'Generate an automated tracker for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'tracker'}

...
FEATURE = {'slug': 'shipping_compressor', 'title': 'Jarvis Pool Shipping Compressor', 'objective': 'Generate an automated compressor for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'compressor'}

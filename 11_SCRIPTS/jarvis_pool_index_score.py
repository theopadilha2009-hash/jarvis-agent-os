...
FEATURE = {'slug': 'index_score', 'title': 'Jarvis Pool Index Score', 'objective': 'Generate an automated score for the index area using local repo signals.', 'domain': 'index', 'action': 'score'}

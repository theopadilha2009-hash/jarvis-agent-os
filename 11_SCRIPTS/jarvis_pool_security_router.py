...
FEATURE = {'slug': 'security_router', 'title': 'Jarvis Pool Security Router', 'objective': 'Generate an automated router for the security area using local repo signals.', 'domain': 'security', 'action': 'router'}

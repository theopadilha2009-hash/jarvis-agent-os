...
FEATURE = {'slug': 'repo_check', 'title': 'Jarvis Pool Repo Check', 'objective': 'Generate an automated check for the repo area using local repo signals.', 'domain': 'repo', 'action': 'check'}

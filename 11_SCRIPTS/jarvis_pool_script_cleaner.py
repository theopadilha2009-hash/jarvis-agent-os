...
FEATURE = {'slug': 'script_cleaner', 'title': 'Jarvis Pool Script Cleaner', 'objective': 'Generate an automated cleaner for the script area using local repo signals.', 'domain': 'script', 'action': 'cleaner'}

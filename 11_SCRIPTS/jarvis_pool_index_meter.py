...
FEATURE = {'slug': 'index_meter', 'title': 'Jarvis Pool Index Meter', 'objective': 'Generate an automated meter for the index area using local repo signals.', 'domain': 'index', 'action': 'meter'}

...
FEATURE = {'slug': 'index_snapshot', 'title': 'Jarvis Pool Index Snapshot', 'objective': 'Generate an automated snapshot for the index area using local repo signals.', 'domain': 'index', 'action': 'snapshot'}

...
FEATURE = {'slug': 'builder_snapshot', 'title': 'Jarvis Pool Builder Snapshot', 'objective': 'Generate an automated snapshot for the builder area using local repo signals.', 'domain': 'builder', 'action': 'snapshot'}

...
FEATURE = {'slug': 'health_timeline', 'title': 'Jarvis Pool Health Timeline', 'objective': 'Generate an automated timeline for the health area using local repo signals.', 'domain': 'health', 'action': 'timeline'}

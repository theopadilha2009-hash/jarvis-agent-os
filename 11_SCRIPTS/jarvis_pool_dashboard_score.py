...
FEATURE = {'slug': 'dashboard_score', 'title': 'Jarvis Pool Dashboard Score', 'objective': 'Generate an automated score for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'score'}

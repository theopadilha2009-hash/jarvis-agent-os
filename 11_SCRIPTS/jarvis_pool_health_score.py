...
FEATURE = {'slug': 'health_score', 'title': 'Jarvis Pool Health Score', 'objective': 'Generate an automated score for the health area using local repo signals.', 'domain': 'health', 'action': 'score'}

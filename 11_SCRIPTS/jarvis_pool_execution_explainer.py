...
FEATURE = {'slug': 'execution_explainer', 'title': 'Jarvis Pool Execution Explainer', 'objective': 'Generate an automated explainer for the execution area using local repo signals.', 'domain': 'execution', 'action': 'explainer'}

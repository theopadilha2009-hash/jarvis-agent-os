...
FEATURE = {'slug': 'release_check', 'title': 'Jarvis Pool Release Check', 'objective': 'Generate an automated check for the release area using local repo signals.', 'domain': 'release', 'action': 'check'}

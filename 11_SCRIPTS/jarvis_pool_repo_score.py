...
FEATURE = {'slug': 'repo_score', 'title': 'Jarvis Pool Repo Score', 'objective': 'Generate an automated score for the repo area using local repo signals.', 'domain': 'repo', 'action': 'score'}

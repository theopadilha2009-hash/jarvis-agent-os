...
FEATURE = {'slug': 'integration_index', 'title': 'Jarvis Pool Integration Index', 'objective': 'Generate an automated index for the integration area using local repo signals.', 'domain': 'integration', 'action': 'index'}

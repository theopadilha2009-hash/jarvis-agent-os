...
FEATURE = {'slug': 'release_guard', 'title': 'Jarvis Pool Release Guard', 'objective': 'Generate an automated guard for the release area using local repo signals.', 'domain': 'release', 'action': 'guard'}

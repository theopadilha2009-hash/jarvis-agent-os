...
FEATURE = {'slug': 'builder_index', 'title': 'Jarvis Pool Builder Index', 'objective': 'Generate an automated index for the builder area using local repo signals.', 'domain': 'builder', 'action': 'index'}

...
FEATURE = {'slug': 'release_brief', 'title': 'Jarvis Pool Release Brief', 'objective': 'Generate an automated brief for the release area using local repo signals.', 'domain': 'release', 'action': 'brief'}

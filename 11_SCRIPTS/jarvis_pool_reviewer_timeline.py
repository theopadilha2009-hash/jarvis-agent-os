...
FEATURE = {'slug': 'reviewer_timeline', 'title': 'Jarvis Pool Reviewer Timeline', 'objective': 'Generate an automated timeline for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'timeline'}

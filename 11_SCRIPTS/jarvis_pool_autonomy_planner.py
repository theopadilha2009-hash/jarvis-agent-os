...
FEATURE = {'slug': 'autonomy_planner', 'title': 'Jarvis Pool Autonomy Planner', 'objective': 'Generate an automated planner for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'planner'}

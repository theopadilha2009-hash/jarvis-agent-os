...
FEATURE = {'slug': 'operator_check', 'title': 'Jarvis Pool Operator Check', 'objective': 'Generate an automated check for the operator area using local repo signals.', 'domain': 'operator', 'action': 'check'}

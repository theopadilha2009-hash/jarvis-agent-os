...
FEATURE = {'slug': 'reviewer_digest', 'title': 'Jarvis Pool Reviewer Digest', 'objective': 'Generate an automated digest for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'digest'}

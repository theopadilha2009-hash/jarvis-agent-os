...
FEATURE = {'slug': 'metrics_brief', 'title': 'Jarvis Pool Metrics Brief', 'objective': 'Generate an automated brief for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'brief'}

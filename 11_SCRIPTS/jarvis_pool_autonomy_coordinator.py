...
FEATURE = {'slug': 'autonomy_coordinator', 'title': 'Jarvis Pool Autonomy Coordinator', 'objective': 'Generate an automated coordinator for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'coordinator'}

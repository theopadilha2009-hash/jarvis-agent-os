...
FEATURE = {'slug': 'doctor_watch', 'title': 'Jarvis Pool Doctor Watch', 'objective': 'Generate an automated watch for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'watch'}

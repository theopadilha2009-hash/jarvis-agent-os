...
FEATURE = {'slug': 'runbook_scanner', 'title': 'Jarvis Pool Runbook Scanner', 'objective': 'Generate an automated scanner for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'scanner'}

...
FEATURE = {'slug': 'planning_baseline', 'title': 'Jarvis Pool Planning Baseline', 'objective': 'Generate an automated baseline for the planning area using local repo signals.', 'domain': 'planning', 'action': 'baseline'}

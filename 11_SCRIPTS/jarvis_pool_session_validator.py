...
FEATURE = {'slug': 'session_validator', 'title': 'Jarvis Pool Session Validator', 'objective': 'Generate an automated validator for the session area using local repo signals.', 'domain': 'session', 'action': 'validator'}

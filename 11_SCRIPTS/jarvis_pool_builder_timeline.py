...
FEATURE = {'slug': 'builder_timeline', 'title': 'Jarvis Pool Builder Timeline', 'objective': 'Generate an automated timeline for the builder area using local repo signals.', 'domain': 'builder', 'action': 'timeline'}

...
FEATURE = {'slug': 'git_coordinator', 'title': 'Jarvis Pool Git Coordinator', 'objective': 'Generate an automated coordinator for the git area using local repo signals.', 'domain': 'git', 'action': 'coordinator'}

...
FEATURE = {'slug': 'index_catalog', 'title': 'Jarvis Pool Index Catalog', 'objective': 'Generate an automated catalog for the index area using local repo signals.', 'domain': 'index', 'action': 'catalog'}

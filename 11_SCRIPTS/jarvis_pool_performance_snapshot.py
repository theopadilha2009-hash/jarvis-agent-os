...
FEATURE = {'slug': 'performance_snapshot', 'title': 'Jarvis Pool Performance Snapshot', 'objective': 'Generate an automated snapshot for the performance area using local repo signals.', 'domain': 'performance', 'action': 'snapshot'}

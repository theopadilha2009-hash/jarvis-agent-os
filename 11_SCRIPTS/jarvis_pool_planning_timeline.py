...
FEATURE = {'slug': 'planning_timeline', 'title': 'Jarvis Pool Planning Timeline', 'objective': 'Generate an automated timeline for the planning area using local repo signals.', 'domain': 'planning', 'action': 'timeline'}

...
FEATURE = {'slug': 'validation_score', 'title': 'Jarvis Pool Validation Score', 'objective': 'Generate an automated score for the validation area using local repo signals.', 'domain': 'validation', 'action': 'score'}

...
FEATURE = {'slug': 'reviewer_check', 'title': 'Jarvis Pool Reviewer Check', 'objective': 'Generate an automated check for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'check'}

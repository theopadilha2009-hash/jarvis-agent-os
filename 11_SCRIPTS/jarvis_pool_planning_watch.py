...
FEATURE = {'slug': 'planning_watch', 'title': 'Jarvis Pool Planning Watch', 'objective': 'Generate an automated watch for the planning area using local repo signals.', 'domain': 'planning', 'action': 'watch'}

...
FEATURE = {'slug': 'marathon_report', 'title': 'Jarvis Pool Marathon Report', 'objective': 'Generate an automated report for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'report'}

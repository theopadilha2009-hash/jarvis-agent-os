...
FEATURE = {'slug': 'index_checkpoint', 'title': 'Jarvis Pool Index Checkpoint', 'objective': 'Generate an automated checkpoint for the index area using local repo signals.', 'domain': 'index', 'action': 'checkpoint'}

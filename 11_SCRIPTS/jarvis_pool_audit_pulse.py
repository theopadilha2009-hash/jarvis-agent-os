...
FEATURE = {'slug': 'audit_pulse', 'title': 'Jarvis Pool Audit Pulse', 'objective': 'Generate an automated pulse for the audit area using local repo signals.', 'domain': 'audit', 'action': 'pulse'}

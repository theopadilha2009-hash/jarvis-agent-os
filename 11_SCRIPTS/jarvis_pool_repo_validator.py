...
FEATURE = {'slug': 'repo_validator', 'title': 'Jarvis Pool Repo Validator', 'objective': 'Generate an automated validator for the repo area using local repo signals.', 'domain': 'repo', 'action': 'validator'}

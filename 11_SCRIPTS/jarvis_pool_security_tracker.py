...
FEATURE = {'slug': 'security_tracker', 'title': 'Jarvis Pool Security Tracker', 'objective': 'Generate an automated tracker for the security area using local repo signals.', 'domain': 'security', 'action': 'tracker'}

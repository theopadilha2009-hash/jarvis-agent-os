...
FEATURE = {'slug': 'session_pulse', 'title': 'Jarvis Pool Session Pulse', 'objective': 'Generate an automated pulse for the session area using local repo signals.', 'domain': 'session', 'action': 'pulse'}

...
FEATURE = {'slug': 'backup_meter', 'title': 'Jarvis Pool Backup Meter', 'objective': 'Generate an automated meter for the backup area using local repo signals.', 'domain': 'backup', 'action': 'meter'}

...
FEATURE = {'slug': 'runbook_index', 'title': 'Jarvis Pool Runbook Index', 'objective': 'Generate an automated index for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'index'}

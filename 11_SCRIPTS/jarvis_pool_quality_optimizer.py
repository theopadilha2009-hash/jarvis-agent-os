...
FEATURE = {'slug': 'quality_optimizer', 'title': 'Jarvis Pool Quality Optimizer', 'objective': 'Generate an automated optimizer for the quality area using local repo signals.', 'domain': 'quality', 'action': 'optimizer'}

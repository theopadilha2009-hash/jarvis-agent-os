...
FEATURE = {'slug': 'architecture_watch', 'title': 'Jarvis Pool Architecture Watch', 'objective': 'Generate an automated watch for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'watch'}

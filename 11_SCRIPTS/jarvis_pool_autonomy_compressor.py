...
FEATURE = {'slug': 'autonomy_compressor', 'title': 'Jarvis Pool Autonomy Compressor', 'objective': 'Generate an automated compressor for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'compressor'}

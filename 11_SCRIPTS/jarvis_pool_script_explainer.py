...
FEATURE = {'slug': 'script_explainer', 'title': 'Jarvis Pool Script Explainer', 'objective': 'Generate an automated explainer for the script area using local repo signals.', 'domain': 'script', 'action': 'explainer'}

...
FEATURE = {'slug': 'reviewer_snapshot', 'title': 'Jarvis Pool Reviewer Snapshot', 'objective': 'Generate an automated snapshot for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'snapshot'}

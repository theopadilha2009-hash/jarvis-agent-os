...
FEATURE = {'slug': 'backup_matrix', 'title': 'Jarvis Pool Backup Matrix', 'objective': 'Generate an automated matrix for the backup area using local repo signals.', 'domain': 'backup', 'action': 'matrix'}

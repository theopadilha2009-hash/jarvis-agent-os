...
FEATURE = {'slug': 'integration_meter', 'title': 'Jarvis Pool Integration Meter', 'objective': 'Generate an automated meter for the integration area using local repo signals.', 'domain': 'integration', 'action': 'meter'}

...
FEATURE = {'slug': 'health_checkpoint', 'title': 'Jarvis Pool Health Checkpoint', 'objective': 'Generate an automated checkpoint for the health area using local repo signals.', 'domain': 'health', 'action': 'checkpoint'}

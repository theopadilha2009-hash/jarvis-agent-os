...
FEATURE = {'slug': 'script_planner', 'title': 'Jarvis Pool Script Planner', 'objective': 'Generate an automated planner for the script area using local repo signals.', 'domain': 'script', 'action': 'planner'}

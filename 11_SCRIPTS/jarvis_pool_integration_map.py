...
FEATURE = {'slug': 'integration_map', 'title': 'Jarvis Pool Integration Map', 'objective': 'Generate an automated map for the integration area using local repo signals.', 'domain': 'integration', 'action': 'map'}

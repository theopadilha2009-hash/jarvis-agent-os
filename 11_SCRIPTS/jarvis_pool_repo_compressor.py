...
FEATURE = {'slug': 'repo_compressor', 'title': 'Jarvis Pool Repo Compressor', 'objective': 'Generate an automated compressor for the repo area using local repo signals.', 'domain': 'repo', 'action': 'compressor'}

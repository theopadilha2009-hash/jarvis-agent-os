...
FEATURE = {'slug': 'audit_builder', 'title': 'Jarvis Pool Audit Builder', 'objective': 'Generate an automated builder for the audit area using local repo signals.', 'domain': 'audit', 'action': 'builder'}

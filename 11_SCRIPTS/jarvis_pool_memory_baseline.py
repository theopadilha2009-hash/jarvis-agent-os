...
FEATURE = {'slug': 'memory_baseline', 'title': 'Jarvis Pool Memory Baseline', 'objective': 'Generate an automated baseline for the memory area using local repo signals.', 'domain': 'memory', 'action': 'baseline'}

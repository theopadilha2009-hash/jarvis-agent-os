...
FEATURE = {'slug': 'git_report', 'title': 'Jarvis Pool Git Report', 'objective': 'Generate an automated report for the git area using local repo signals.', 'domain': 'git', 'action': 'report'}

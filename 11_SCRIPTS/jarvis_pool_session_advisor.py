...
FEATURE = {'slug': 'session_advisor', 'title': 'Jarvis Pool Session Advisor', 'objective': 'Generate an automated advisor for the session area using local repo signals.', 'domain': 'session', 'action': 'advisor'}

...
FEATURE = {'slug': 'repo_review', 'title': 'Jarvis Pool Repo Review', 'objective': 'Generate an automated review for the repo area using local repo signals.', 'domain': 'repo', 'action': 'review'}

...
FEATURE = {'slug': 'growth_coordinator', 'title': 'Jarvis Pool Growth Coordinator', 'objective': 'Generate an automated coordinator for the growth area using local repo signals.', 'domain': 'growth', 'action': 'coordinator'}

...
FEATURE = {'slug': 'audit_advisor', 'title': 'Jarvis Pool Audit Advisor', 'objective': 'Generate an automated advisor for the audit area using local repo signals.', 'domain': 'audit', 'action': 'advisor'}

...
FEATURE = {'slug': 'dashboard_checkpoint', 'title': 'Jarvis Pool Dashboard Checkpoint', 'objective': 'Generate an automated checkpoint for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'checkpoint'}

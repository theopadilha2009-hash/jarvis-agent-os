...
FEATURE = {'slug': 'operator_cleaner', 'title': 'Jarvis Pool Operator Cleaner', 'objective': 'Generate an automated cleaner for the operator area using local repo signals.', 'domain': 'operator', 'action': 'cleaner'}

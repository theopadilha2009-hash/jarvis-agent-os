...
FEATURE = {'slug': 'marathon_compressor', 'title': 'Jarvis Pool Marathon Compressor', 'objective': 'Generate an automated compressor for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'compressor'}

...
FEATURE = {'slug': 'doctor_matrix', 'title': 'Jarvis Pool Doctor Matrix', 'objective': 'Generate an automated matrix for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'matrix'}

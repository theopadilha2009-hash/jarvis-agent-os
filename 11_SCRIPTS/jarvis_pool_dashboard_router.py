...
FEATURE = {'slug': 'dashboard_router', 'title': 'Jarvis Pool Dashboard Router', 'objective': 'Generate an automated router for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'router'}

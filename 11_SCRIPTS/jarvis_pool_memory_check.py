...
FEATURE = {'slug': 'memory_check', 'title': 'Jarvis Pool Memory Check', 'objective': 'Generate an automated check for the memory area using local repo signals.', 'domain': 'memory', 'action': 'check'}

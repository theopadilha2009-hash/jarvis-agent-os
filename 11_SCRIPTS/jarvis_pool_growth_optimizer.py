...
FEATURE = {'slug': 'growth_optimizer', 'title': 'Jarvis Pool Growth Optimizer', 'objective': 'Generate an automated optimizer for the growth area using local repo signals.', 'domain': 'growth', 'action': 'optimizer'}

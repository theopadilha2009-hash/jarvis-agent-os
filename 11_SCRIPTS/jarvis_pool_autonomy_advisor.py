...
FEATURE = {'slug': 'autonomy_advisor', 'title': 'Jarvis Pool Autonomy Advisor', 'objective': 'Generate an automated advisor for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'advisor'}

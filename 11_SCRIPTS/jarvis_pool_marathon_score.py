...
FEATURE = {'slug': 'marathon_score', 'title': 'Jarvis Pool Marathon Score', 'objective': 'Generate an automated score for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'score'}

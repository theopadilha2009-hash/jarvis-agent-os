...
FEATURE = {'slug': 'session_baseline', 'title': 'Jarvis Pool Session Baseline', 'objective': 'Generate an automated baseline for the session area using local repo signals.', 'domain': 'session', 'action': 'baseline'}

...
FEATURE = {'slug': 'index_router', 'title': 'Jarvis Pool Index Router', 'objective': 'Generate an automated router for the index area using local repo signals.', 'domain': 'index', 'action': 'router'}

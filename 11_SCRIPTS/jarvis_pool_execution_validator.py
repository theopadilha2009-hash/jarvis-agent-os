...
FEATURE = {'slug': 'execution_validator', 'title': 'Jarvis Pool Execution Validator', 'objective': 'Generate an automated validator for the execution area using local repo signals.', 'domain': 'execution', 'action': 'validator'}

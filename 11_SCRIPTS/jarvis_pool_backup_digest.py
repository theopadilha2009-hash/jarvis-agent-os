...
FEATURE = {'slug': 'backup_digest', 'title': 'Jarvis Pool Backup Digest', 'objective': 'Generate an automated digest for the backup area using local repo signals.', 'domain': 'backup', 'action': 'digest'}

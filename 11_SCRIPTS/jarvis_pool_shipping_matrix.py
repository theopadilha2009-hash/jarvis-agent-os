...
FEATURE = {'slug': 'shipping_matrix', 'title': 'Jarvis Pool Shipping Matrix', 'objective': 'Generate an automated matrix for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'matrix'}

...
FEATURE = {'slug': 'git_watch', 'title': 'Jarvis Pool Git Watch', 'objective': 'Generate an automated watch for the git area using local repo signals.', 'domain': 'git', 'action': 'watch'}

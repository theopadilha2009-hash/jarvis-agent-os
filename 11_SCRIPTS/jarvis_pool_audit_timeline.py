...
FEATURE = {'slug': 'audit_timeline', 'title': 'Jarvis Pool Audit Timeline', 'objective': 'Generate an automated timeline for the audit area using local repo signals.', 'domain': 'audit', 'action': 'timeline'}

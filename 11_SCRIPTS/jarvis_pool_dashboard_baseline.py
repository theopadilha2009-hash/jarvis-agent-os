...
FEATURE = {'slug': 'dashboard_baseline', 'title': 'Jarvis Pool Dashboard Baseline', 'objective': 'Generate an automated baseline for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'baseline'}

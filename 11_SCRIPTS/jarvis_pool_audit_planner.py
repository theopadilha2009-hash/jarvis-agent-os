...
FEATURE = {'slug': 'audit_planner', 'title': 'Jarvis Pool Audit Planner', 'objective': 'Generate an automated planner for the audit area using local repo signals.', 'domain': 'audit', 'action': 'planner'}

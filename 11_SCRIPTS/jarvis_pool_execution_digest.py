...
FEATURE = {'slug': 'execution_digest', 'title': 'Jarvis Pool Execution Digest', 'objective': 'Generate an automated digest for the execution area using local repo signals.', 'domain': 'execution', 'action': 'digest'}

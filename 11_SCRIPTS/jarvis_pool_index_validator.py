...
FEATURE = {'slug': 'index_validator', 'title': 'Jarvis Pool Index Validator', 'objective': 'Generate an automated validator for the index area using local repo signals.', 'domain': 'index', 'action': 'validator'}

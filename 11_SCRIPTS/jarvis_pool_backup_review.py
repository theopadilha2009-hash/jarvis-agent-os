...
FEATURE = {'slug': 'backup_review', 'title': 'Jarvis Pool Backup Review', 'objective': 'Generate an automated review for the backup area using local repo signals.', 'domain': 'backup', 'action': 'review'}

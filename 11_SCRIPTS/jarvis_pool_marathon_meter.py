...
FEATURE = {'slug': 'marathon_meter', 'title': 'Jarvis Pool Marathon Meter', 'objective': 'Generate an automated meter for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'meter'}

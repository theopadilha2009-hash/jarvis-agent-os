...
FEATURE = {'slug': 'validation_map', 'title': 'Jarvis Pool Validation Map', 'objective': 'Generate an automated map for the validation area using local repo signals.', 'domain': 'validation', 'action': 'map'}

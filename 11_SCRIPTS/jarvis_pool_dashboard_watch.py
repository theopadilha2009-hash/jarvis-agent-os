...
FEATURE = {'slug': 'dashboard_watch', 'title': 'Jarvis Pool Dashboard Watch', 'objective': 'Generate an automated watch for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'watch'}

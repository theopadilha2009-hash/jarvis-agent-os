...
FEATURE = {'slug': 'summary_index', 'title': 'Jarvis Pool Summary Index', 'objective': 'Generate an automated index for the summary area using local repo signals.', 'domain': 'summary', 'action': 'index'}

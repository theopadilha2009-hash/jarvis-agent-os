...
FEATURE = {'slug': 'planning_guard', 'title': 'Jarvis Pool Planning Guard', 'objective': 'Generate an automated guard for the planning area using local repo signals.', 'domain': 'planning', 'action': 'guard'}

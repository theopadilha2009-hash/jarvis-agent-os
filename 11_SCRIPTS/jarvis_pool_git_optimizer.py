...
FEATURE = {'slug': 'git_optimizer', 'title': 'Jarvis Pool Git Optimizer', 'objective': 'Generate an automated optimizer for the git area using local repo signals.', 'domain': 'git', 'action': 'optimizer'}

...
FEATURE = {'slug': 'runbook_coordinator', 'title': 'Jarvis Pool Runbook Coordinator', 'objective': 'Generate an automated coordinator for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'coordinator'}

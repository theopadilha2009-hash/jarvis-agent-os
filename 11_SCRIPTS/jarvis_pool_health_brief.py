...
FEATURE = {'slug': 'health_brief', 'title': 'Jarvis Pool Health Brief', 'objective': 'Generate an automated brief for the health area using local repo signals.', 'domain': 'health', 'action': 'brief'}

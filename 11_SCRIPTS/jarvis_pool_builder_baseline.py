...
FEATURE = {'slug': 'builder_baseline', 'title': 'Jarvis Pool Builder Baseline', 'objective': 'Generate an automated baseline for the builder area using local repo signals.', 'domain': 'builder', 'action': 'baseline'}

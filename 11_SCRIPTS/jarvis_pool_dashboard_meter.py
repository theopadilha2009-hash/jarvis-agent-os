...
FEATURE = {'slug': 'dashboard_meter', 'title': 'Jarvis Pool Dashboard Meter', 'objective': 'Generate an automated meter for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'meter'}

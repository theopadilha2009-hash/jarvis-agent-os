...
FEATURE = {'slug': 'git_timeline', 'title': 'Jarvis Pool Git Timeline', 'objective': 'Generate an automated timeline for the git area using local repo signals.', 'domain': 'git', 'action': 'timeline'}

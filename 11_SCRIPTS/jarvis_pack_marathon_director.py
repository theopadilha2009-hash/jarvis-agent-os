...
FEATURE = {'slug': 'marathon_director', 'title': 'Jarvis Pack Marathon Director', 'mission': 'Read marathon state and recommend the next safe build-run size, duration, and command.', 'focus': 'marathon', 'checks': ['marathon_state', 'remaining_pool', 'recent_commits', 'repo_clean']}

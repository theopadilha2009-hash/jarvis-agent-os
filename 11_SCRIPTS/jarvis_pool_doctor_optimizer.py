...
FEATURE = {'slug': 'doctor_optimizer', 'title': 'Jarvis Pool Doctor Optimizer', 'objective': 'Generate an automated optimizer for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'optimizer'}

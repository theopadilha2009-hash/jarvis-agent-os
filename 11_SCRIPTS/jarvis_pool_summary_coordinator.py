...
FEATURE = {'slug': 'summary_coordinator', 'title': 'Jarvis Pool Summary Coordinator', 'objective': 'Generate an automated coordinator for the summary area using local repo signals.', 'domain': 'summary', 'action': 'coordinator'}

...
FEATURE = {'slug': 'session_report', 'title': 'Jarvis Pool Session Report', 'objective': 'Generate an automated report for the session area using local repo signals.', 'domain': 'session', 'action': 'report'}

...
FEATURE = {'slug': 'session_guard', 'title': 'Jarvis Pool Session Guard', 'objective': 'Generate an automated guard for the session area using local repo signals.', 'domain': 'session', 'action': 'guard'}

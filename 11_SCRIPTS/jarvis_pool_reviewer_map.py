...
FEATURE = {'slug': 'reviewer_map', 'title': 'Jarvis Pool Reviewer Map', 'objective': 'Generate an automated map for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'map'}

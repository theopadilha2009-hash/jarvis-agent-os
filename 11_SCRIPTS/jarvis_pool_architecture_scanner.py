...
FEATURE = {'slug': 'architecture_scanner', 'title': 'Jarvis Pool Architecture Scanner', 'objective': 'Generate an automated scanner for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'scanner'}

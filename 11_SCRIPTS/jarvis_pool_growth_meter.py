...
FEATURE = {'slug': 'growth_meter', 'title': 'Jarvis Pool Growth Meter', 'objective': 'Generate an automated meter for the growth area using local repo signals.', 'domain': 'growth', 'action': 'meter'}

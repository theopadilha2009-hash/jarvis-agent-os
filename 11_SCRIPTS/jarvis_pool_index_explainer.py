...
FEATURE = {'slug': 'index_explainer', 'title': 'Jarvis Pool Index Explainer', 'objective': 'Generate an automated explainer for the index area using local repo signals.', 'domain': 'index', 'action': 'explainer'}

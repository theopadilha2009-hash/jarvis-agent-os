...
FEATURE = {'slug': 'validation_report', 'title': 'Jarvis Pool Validation Report', 'objective': 'Generate an automated report for the validation area using local repo signals.', 'domain': 'validation', 'action': 'report'}

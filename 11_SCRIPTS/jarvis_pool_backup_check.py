...
FEATURE = {'slug': 'backup_check', 'title': 'Jarvis Pool Backup Check', 'objective': 'Generate an automated check for the backup area using local repo signals.', 'domain': 'backup', 'action': 'check'}

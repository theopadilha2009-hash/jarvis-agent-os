...
FEATURE = {'slug': 'audit_meter', 'title': 'Jarvis Pool Audit Meter', 'objective': 'Generate an automated meter for the audit area using local repo signals.', 'domain': 'audit', 'action': 'meter'}

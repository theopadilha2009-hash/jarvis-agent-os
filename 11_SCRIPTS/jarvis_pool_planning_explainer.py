...
FEATURE = {'slug': 'planning_explainer', 'title': 'Jarvis Pool Planning Explainer', 'objective': 'Generate an automated explainer for the planning area using local repo signals.', 'domain': 'planning', 'action': 'explainer'}

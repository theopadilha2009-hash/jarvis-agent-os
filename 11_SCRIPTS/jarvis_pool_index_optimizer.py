...
FEATURE = {'slug': 'index_optimizer', 'title': 'Jarvis Pool Index Optimizer', 'objective': 'Generate an automated optimizer for the index area using local repo signals.', 'domain': 'index', 'action': 'optimizer'}

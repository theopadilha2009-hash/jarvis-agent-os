...
FEATURE = {'slug': 'marathon_advisor', 'title': 'Jarvis Pool Marathon Advisor', 'objective': 'Generate an automated advisor for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'advisor'}

...
FEATURE = {'slug': 'metrics_digest', 'title': 'Jarvis Pool Metrics Digest', 'objective': 'Generate an automated digest for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'digest'}

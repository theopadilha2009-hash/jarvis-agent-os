...
FEATURE = {'slug': 'memory_timeline', 'title': 'Jarvis Pool Memory Timeline', 'objective': 'Generate an automated timeline for the memory area using local repo signals.', 'domain': 'memory', 'action': 'timeline'}

...
FEATURE = {'slug': 'performance_brief', 'title': 'Jarvis Pool Performance Brief', 'objective': 'Generate an automated brief for the performance area using local repo signals.', 'domain': 'performance', 'action': 'brief'}

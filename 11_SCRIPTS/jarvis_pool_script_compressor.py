...
FEATURE = {'slug': 'script_compressor', 'title': 'Jarvis Pool Script Compressor', 'objective': 'Generate an automated compressor for the script area using local repo signals.', 'domain': 'script', 'action': 'compressor'}

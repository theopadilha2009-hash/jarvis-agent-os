...
FEATURE = {'slug': 'metrics_coordinator', 'title': 'Jarvis Pool Metrics Coordinator', 'objective': 'Generate an automated coordinator for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'coordinator'}

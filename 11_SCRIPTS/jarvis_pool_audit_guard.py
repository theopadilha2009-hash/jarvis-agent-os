...
FEATURE = {'slug': 'audit_guard', 'title': 'Jarvis Pool Audit Guard', 'objective': 'Generate an automated guard for the audit area using local repo signals.', 'domain': 'audit', 'action': 'guard'}

...
FEATURE = {'slug': 'doctor_compressor', 'title': 'Jarvis Pool Doctor Compressor', 'objective': 'Generate an automated compressor for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'compressor'}

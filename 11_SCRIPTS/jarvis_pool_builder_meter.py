...
FEATURE = {'slug': 'builder_meter', 'title': 'Jarvis Pool Builder Meter', 'objective': 'Generate an automated meter for the builder area using local repo signals.', 'domain': 'builder', 'action': 'meter'}

...
FEATURE = {'slug': 'marathon_digest', 'title': 'Jarvis Pool Marathon Digest', 'objective': 'Generate an automated digest for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'digest'}

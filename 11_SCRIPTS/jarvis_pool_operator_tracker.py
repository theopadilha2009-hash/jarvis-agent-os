...
FEATURE = {'slug': 'operator_tracker', 'title': 'Jarvis Pool Operator Tracker', 'objective': 'Generate an automated tracker for the operator area using local repo signals.', 'domain': 'operator', 'action': 'tracker'}

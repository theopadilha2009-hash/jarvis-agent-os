...
FEATURE = {'slug': 'shipping_baseline', 'title': 'Jarvis Pool Shipping Baseline', 'objective': 'Generate an automated baseline for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'baseline'}

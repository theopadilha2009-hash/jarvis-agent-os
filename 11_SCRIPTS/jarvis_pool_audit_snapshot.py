...
FEATURE = {'slug': 'audit_snapshot', 'title': 'Jarvis Pool Audit Snapshot', 'objective': 'Generate an automated snapshot for the audit area using local repo signals.', 'domain': 'audit', 'action': 'snapshot'}

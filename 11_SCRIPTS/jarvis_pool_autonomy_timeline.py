...
FEATURE = {'slug': 'autonomy_timeline', 'title': 'Jarvis Pool Autonomy Timeline', 'objective': 'Generate an automated timeline for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'timeline'}

...
FEATURE = {'slug': 'doctor_catalog', 'title': 'Jarvis Pool Doctor Catalog', 'objective': 'Generate an automated catalog for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'catalog'}

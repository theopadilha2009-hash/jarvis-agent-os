...
FEATURE = {'slug': 'metrics_validator', 'title': 'Jarvis Pool Metrics Validator', 'objective': 'Generate an automated validator for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'validator'}

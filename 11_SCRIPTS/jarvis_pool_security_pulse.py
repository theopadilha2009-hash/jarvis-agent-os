...
FEATURE = {'slug': 'security_pulse', 'title': 'Jarvis Pool Security Pulse', 'objective': 'Generate an automated pulse for the security area using local repo signals.', 'domain': 'security', 'action': 'pulse'}

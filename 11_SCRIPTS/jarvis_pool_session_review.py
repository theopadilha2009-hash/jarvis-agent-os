...
FEATURE = {'slug': 'session_review', 'title': 'Jarvis Pool Session Review', 'objective': 'Generate an automated review for the session area using local repo signals.', 'domain': 'session', 'action': 'review'}

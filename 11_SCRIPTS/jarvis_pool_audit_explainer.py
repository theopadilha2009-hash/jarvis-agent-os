...
FEATURE = {'slug': 'audit_explainer', 'title': 'Jarvis Pool Audit Explainer', 'objective': 'Generate an automated explainer for the audit area using local repo signals.', 'domain': 'audit', 'action': 'explainer'}

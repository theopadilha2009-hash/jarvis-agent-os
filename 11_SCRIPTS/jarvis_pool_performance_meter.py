...
FEATURE = {'slug': 'performance_meter', 'title': 'Jarvis Pool Performance Meter', 'objective': 'Generate an automated meter for the performance area using local repo signals.', 'domain': 'performance', 'action': 'meter'}

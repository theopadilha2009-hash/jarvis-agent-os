...
FEATURE = {'slug': 'integration_advisor', 'title': 'Jarvis Pool Integration Advisor', 'objective': 'Generate an automated advisor for the integration area using local repo signals.', 'domain': 'integration', 'action': 'advisor'}

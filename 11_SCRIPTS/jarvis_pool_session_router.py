...
FEATURE = {'slug': 'session_router', 'title': 'Jarvis Pool Session Router', 'objective': 'Generate an automated router for the session area using local repo signals.', 'domain': 'session', 'action': 'router'}

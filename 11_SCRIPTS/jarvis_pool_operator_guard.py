...
FEATURE = {'slug': 'operator_guard', 'title': 'Jarvis Pool Operator Guard', 'objective': 'Generate an automated guard for the operator area using local repo signals.', 'domain': 'operator', 'action': 'guard'}

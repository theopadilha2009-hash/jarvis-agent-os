...
FEATURE = {'slug': 'quality_gate', 'title': 'Jarvis Pack Quality Gate', 'mission': 'Run a stronger local quality gate across Python syntax, git state, file growth, and execution health.', 'focus': 'quality', 'checks': ['py_compile', 'git_status', 'script_growth', 'execution_growth', 'sensitive_file_names']}

...
FEATURE = {'slug': 'release_tracker', 'title': 'Jarvis Pool Release Tracker', 'objective': 'Generate an automated tracker for the release area using local repo signals.', 'domain': 'release', 'action': 'tracker'}

...
FEATURE = {'slug': 'audit_score', 'title': 'Jarvis Pool Audit Score', 'objective': 'Generate an automated score for the audit area using local repo signals.', 'domain': 'audit', 'action': 'score'}

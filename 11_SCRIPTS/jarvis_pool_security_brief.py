...
FEATURE = {'slug': 'security_brief', 'title': 'Jarvis Pool Security Brief', 'objective': 'Generate an automated brief for the security area using local repo signals.', 'domain': 'security', 'action': 'brief'}

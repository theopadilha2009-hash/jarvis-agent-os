...
FEATURE = {'slug': 'summary_advisor', 'title': 'Jarvis Pool Summary Advisor', 'objective': 'Generate an automated advisor for the summary area using local repo signals.', 'domain': 'summary', 'action': 'advisor'}

...
FEATURE = {'slug': 'runbook_snapshot', 'title': 'Jarvis Pool Runbook Snapshot', 'objective': 'Generate an automated snapshot for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'snapshot'}

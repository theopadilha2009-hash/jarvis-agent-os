...
FEATURE = {'slug': 'metrics_watch', 'title': 'Jarvis Pool Metrics Watch', 'objective': 'Generate an automated watch for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'watch'}

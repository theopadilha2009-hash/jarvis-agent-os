...
FEATURE = {'slug': 'session_watch', 'title': 'Jarvis Pool Session Watch', 'objective': 'Generate an automated watch for the session area using local repo signals.', 'domain': 'session', 'action': 'watch'}

...
FEATURE = {'slug': 'session_builder', 'title': 'Jarvis Pool Session Builder', 'objective': 'Generate an automated builder for the session area using local repo signals.', 'domain': 'session', 'action': 'builder'}

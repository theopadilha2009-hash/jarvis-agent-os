...
FEATURE = {'slug': 'doctor_report', 'title': 'Jarvis Pool Doctor Report', 'objective': 'Generate an automated report for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'report'}

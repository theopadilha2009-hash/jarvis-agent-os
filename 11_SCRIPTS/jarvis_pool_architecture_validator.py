...
FEATURE = {'slug': 'architecture_validator', 'title': 'Jarvis Pool Architecture Validator', 'objective': 'Generate an automated validator for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'validator'}

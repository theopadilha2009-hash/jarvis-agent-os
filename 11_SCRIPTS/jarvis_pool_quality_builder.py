...
FEATURE = {'slug': 'quality_builder', 'title': 'Jarvis Pool Quality Builder', 'objective': 'Generate an automated builder for the quality area using local repo signals.', 'domain': 'quality', 'action': 'builder'}

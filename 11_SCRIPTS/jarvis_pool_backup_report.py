...
FEATURE = {'slug': 'backup_report', 'title': 'Jarvis Pool Backup Report', 'objective': 'Generate an automated report for the backup area using local repo signals.', 'domain': 'backup', 'action': 'report'}

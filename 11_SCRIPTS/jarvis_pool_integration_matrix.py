...
FEATURE = {'slug': 'integration_matrix', 'title': 'Jarvis Pool Integration Matrix', 'objective': 'Generate an automated matrix for the integration area using local repo signals.', 'domain': 'integration', 'action': 'matrix'}

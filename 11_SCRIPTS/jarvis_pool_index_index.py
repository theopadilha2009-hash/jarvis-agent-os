...
FEATURE = {'slug': 'index_index', 'title': 'Jarvis Pool Index Index', 'objective': 'Generate an automated index for the index area using local repo signals.', 'domain': 'index', 'action': 'index'}

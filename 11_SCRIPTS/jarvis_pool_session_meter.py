...
FEATURE = {'slug': 'session_meter', 'title': 'Jarvis Pool Session Meter', 'objective': 'Generate an automated meter for the session area using local repo signals.', 'domain': 'session', 'action': 'meter'}

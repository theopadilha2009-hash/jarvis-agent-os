...
FEATURE = {'slug': 'security_advisor', 'title': 'Jarvis Pool Security Advisor', 'objective': 'Generate an automated advisor for the security area using local repo signals.', 'domain': 'security', 'action': 'advisor'}

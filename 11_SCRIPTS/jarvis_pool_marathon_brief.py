...
FEATURE = {'slug': 'marathon_brief', 'title': 'Jarvis Pool Marathon Brief', 'objective': 'Generate an automated brief for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'brief'}

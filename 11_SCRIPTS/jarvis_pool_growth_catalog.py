...
FEATURE = {'slug': 'growth_catalog', 'title': 'Jarvis Pool Growth Catalog', 'objective': 'Generate an automated catalog for the growth area using local repo signals.', 'domain': 'growth', 'action': 'catalog'}

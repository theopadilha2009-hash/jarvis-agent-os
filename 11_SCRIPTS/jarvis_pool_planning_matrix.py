...
FEATURE = {'slug': 'planning_matrix', 'title': 'Jarvis Pool Planning Matrix', 'objective': 'Generate an automated matrix for the planning area using local repo signals.', 'domain': 'planning', 'action': 'matrix'}

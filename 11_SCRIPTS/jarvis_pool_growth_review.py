...
FEATURE = {'slug': 'growth_review', 'title': 'Jarvis Pool Growth Review', 'objective': 'Generate an automated review for the growth area using local repo signals.', 'domain': 'growth', 'action': 'review'}

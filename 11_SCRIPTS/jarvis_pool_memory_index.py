...
FEATURE = {'slug': 'memory_index', 'title': 'Jarvis Pool Memory Index', 'objective': 'Generate an automated index for the memory area using local repo signals.', 'domain': 'memory', 'action': 'index'}

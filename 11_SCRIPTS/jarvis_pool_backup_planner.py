...
FEATURE = {'slug': 'backup_planner', 'title': 'Jarvis Pool Backup Planner', 'objective': 'Generate an automated planner for the backup area using local repo signals.', 'domain': 'backup', 'action': 'planner'}

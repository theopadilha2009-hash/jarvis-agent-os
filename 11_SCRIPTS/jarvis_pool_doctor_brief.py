...
FEATURE = {'slug': 'doctor_brief', 'title': 'Jarvis Pool Doctor Brief', 'objective': 'Generate an automated brief for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'brief'}

...
FEATURE = {'slug': 'release_builder', 'title': 'Jarvis Pool Release Builder', 'objective': 'Generate an automated builder for the release area using local repo signals.', 'domain': 'release', 'action': 'builder'}

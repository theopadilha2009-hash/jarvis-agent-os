...
FEATURE = {'slug': 'audit_checkpoint', 'title': 'Jarvis Pool Audit Checkpoint', 'objective': 'Generate an automated checkpoint for the audit area using local repo signals.', 'domain': 'audit', 'action': 'checkpoint'}

...
FEATURE = {'slug': 'index_matrix', 'title': 'Jarvis Pool Index Matrix', 'objective': 'Generate an automated matrix for the index area using local repo signals.', 'domain': 'index', 'action': 'matrix'}

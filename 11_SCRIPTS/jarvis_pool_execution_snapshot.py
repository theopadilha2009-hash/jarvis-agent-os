...
FEATURE = {'slug': 'execution_snapshot', 'title': 'Jarvis Pool Execution Snapshot', 'objective': 'Generate an automated snapshot for the execution area using local repo signals.', 'domain': 'execution', 'action': 'snapshot'}

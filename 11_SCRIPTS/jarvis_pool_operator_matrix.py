...
FEATURE = {'slug': 'operator_matrix', 'title': 'Jarvis Pool Operator Matrix', 'objective': 'Generate an automated matrix for the operator area using local repo signals.', 'domain': 'operator', 'action': 'matrix'}

...
FEATURE = {'slug': 'metrics_report', 'title': 'Jarvis Pool Metrics Report', 'objective': 'Generate an automated report for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'report'}

...
FEATURE = {'slug': 'quality_brief', 'title': 'Jarvis Pool Quality Brief', 'objective': 'Generate an automated brief for the quality area using local repo signals.', 'domain': 'quality', 'action': 'brief'}

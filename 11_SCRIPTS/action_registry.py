...
ACTION_SPECS = (
    ...
    ActionSpec("volume_set", "Volume do Mac", "Ajustar o volume de saída do sistema, sem shell livre.", "mac", "runtime_write", "explicit_request", True, intents=("volume_set", "system_volume")),
    ...
    ActionSpec(
        "spotify_control",
        "Controlar Spotify",
        "Tocar, pausar, navegar, ajustar volume e consultar estado no Spotify instalado.",
        "mac",
        "runtime_write",
        "explicit_request",
        True,
        intents=("spotify_control",),
        parameters=_object_schema(
            operation={"type": "string", "enum": ["status", "play", "pause", "next", "previous", "volume", "shuffle", "repeat", "search", "play-uri"]},
            value={"type": "string"},
        ),
    ),
    ...
    ActionSpec("wifi_telemetry", "Telemetria de Wi-Fi", "Consultar SSID, IP local, sinal e status da rede sem fio.", "mac", "read_only", "none", True, intents=("wifi_info", "wifi_status", "wifi_passwords")),
    ...
    ActionSpec("qr_code", "Gerar QR Code", "Gerar código QR em SVG ou terminal a partir de texto ou URL.", "mac", "read_only", "none", False, intents=("qr", "qr_code")),

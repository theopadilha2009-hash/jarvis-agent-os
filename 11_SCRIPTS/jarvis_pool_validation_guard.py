...
FEATURE = {'slug': 'validation_guard', 'title': 'Jarvis Pool Validation Guard', 'objective': 'Generate an automated guard for the validation area using local repo signals.', 'domain': 'validation', 'action': 'guard'}

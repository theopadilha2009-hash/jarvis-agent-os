...
FEATURE = {'slug': 'planning_brief', 'title': 'Jarvis Pool Planning Brief', 'objective': 'Generate an automated brief for the planning area using local repo signals.', 'domain': 'planning', 'action': 'brief'}

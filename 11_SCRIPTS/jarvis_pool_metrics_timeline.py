...
FEATURE = {'slug': 'metrics_timeline', 'title': 'Jarvis Pool Metrics Timeline', 'objective': 'Generate an automated timeline for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'timeline'}

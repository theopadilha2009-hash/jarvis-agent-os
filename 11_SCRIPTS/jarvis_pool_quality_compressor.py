...
FEATURE = {'slug': 'quality_compressor', 'title': 'Jarvis Pool Quality Compressor', 'objective': 'Generate an automated compressor for the quality area using local repo signals.', 'domain': 'quality', 'action': 'compressor'}

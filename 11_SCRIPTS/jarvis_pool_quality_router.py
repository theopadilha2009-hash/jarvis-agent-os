...
FEATURE = {'slug': 'quality_router', 'title': 'Jarvis Pool Quality Router', 'objective': 'Generate an automated router for the quality area using local repo signals.', 'domain': 'quality', 'action': 'router'}

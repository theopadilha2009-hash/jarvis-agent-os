...
FEATURE = {'slug': 'execution_index', 'title': 'Jarvis Pool Execution Index', 'objective': 'Generate an automated index for the execution area using local repo signals.', 'domain': 'execution', 'action': 'index'}

...
FEATURE = {'slug': 'planning_catalog', 'title': 'Jarvis Pool Planning Catalog', 'objective': 'Generate an automated catalog for the planning area using local repo signals.', 'domain': 'planning', 'action': 'catalog'}

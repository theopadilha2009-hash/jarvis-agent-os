...
FEATURE = {'slug': 'dashboard_guard', 'title': 'Jarvis Pool Dashboard Guard', 'objective': 'Generate an automated guard for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'guard'}

...
FEATURE = {'slug': 'doctor_digest', 'title': 'Jarvis Pool Doctor Digest', 'objective': 'Generate an automated digest for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'digest'}

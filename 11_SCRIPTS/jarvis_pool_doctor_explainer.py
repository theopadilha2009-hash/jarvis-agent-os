...
FEATURE = {'slug': 'doctor_explainer', 'title': 'Jarvis Pool Doctor Explainer', 'objective': 'Generate an automated explainer for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'explainer'}

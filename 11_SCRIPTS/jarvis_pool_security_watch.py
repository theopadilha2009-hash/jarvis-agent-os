...
FEATURE = {'slug': 'security_watch', 'title': 'Jarvis Pool Security Watch', 'objective': 'Generate an automated watch for the security area using local repo signals.', 'domain': 'security', 'action': 'watch'}

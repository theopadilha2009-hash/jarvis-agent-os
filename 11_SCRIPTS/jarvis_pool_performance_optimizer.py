...
FEATURE = {'slug': 'performance_optimizer', 'title': 'Jarvis Pool Performance Optimizer', 'objective': 'Generate an automated optimizer for the performance area using local repo signals.', 'domain': 'performance', 'action': 'optimizer'}

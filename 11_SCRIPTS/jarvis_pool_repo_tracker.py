...
FEATURE = {'slug': 'repo_tracker', 'title': 'Jarvis Pool Repo Tracker', 'objective': 'Generate an automated tracker for the repo area using local repo signals.', 'domain': 'repo', 'action': 'tracker'}

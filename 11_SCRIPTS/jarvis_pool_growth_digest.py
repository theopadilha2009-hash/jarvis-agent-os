...
FEATURE = {'slug': 'growth_digest', 'title': 'Jarvis Pool Growth Digest', 'objective': 'Generate an automated digest for the growth area using local repo signals.', 'domain': 'growth', 'action': 'digest'}

...
FEATURE = {'slug': 'growth_snapshot', 'title': 'Jarvis Pool Growth Snapshot', 'objective': 'Generate an automated snapshot for the growth area using local repo signals.', 'domain': 'growth', 'action': 'snapshot'}

...
FEATURE = {'slug': 'builder_validator', 'title': 'Jarvis Pool Builder Validator', 'objective': 'Generate an automated validator for the builder area using local repo signals.', 'domain': 'builder', 'action': 'validator'}

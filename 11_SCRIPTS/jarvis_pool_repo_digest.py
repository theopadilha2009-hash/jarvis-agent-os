...
FEATURE = {'slug': 'repo_digest', 'title': 'Jarvis Pool Repo Digest', 'objective': 'Generate an automated digest for the repo area using local repo signals.', 'domain': 'repo', 'action': 'digest'}

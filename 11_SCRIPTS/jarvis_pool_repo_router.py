...
FEATURE = {'slug': 'repo_router', 'title': 'Jarvis Pool Repo Router', 'objective': 'Generate an automated router for the repo area using local repo signals.', 'domain': 'repo', 'action': 'router'}

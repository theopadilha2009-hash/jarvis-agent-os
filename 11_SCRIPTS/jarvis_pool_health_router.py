...
FEATURE = {'slug': 'health_router', 'title': 'Jarvis Pool Health Router', 'objective': 'Generate an automated router for the health area using local repo signals.', 'domain': 'health', 'action': 'router'}

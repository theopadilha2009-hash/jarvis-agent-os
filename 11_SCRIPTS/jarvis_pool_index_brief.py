...
FEATURE = {'slug': 'index_brief', 'title': 'Jarvis Pool Index Brief', 'objective': 'Generate an automated brief for the index area using local repo signals.', 'domain': 'index', 'action': 'brief'}

...
FEATURE = {'slug': 'quality_cleaner', 'title': 'Jarvis Pool Quality Cleaner', 'objective': 'Generate an automated cleaner for the quality area using local repo signals.', 'domain': 'quality', 'action': 'cleaner'}

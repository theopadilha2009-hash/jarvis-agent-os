...
FEATURE = {'slug': 'execution_timeline', 'title': 'Jarvis Pool Execution Timeline', 'objective': 'Generate an automated timeline for the execution area using local repo signals.', 'domain': 'execution', 'action': 'timeline'}

...
FEATURE = {'slug': 'validation_coordinator', 'title': 'Jarvis Pool Validation Coordinator', 'objective': 'Generate an automated coordinator for the validation area using local repo signals.', 'domain': 'validation', 'action': 'coordinator'}

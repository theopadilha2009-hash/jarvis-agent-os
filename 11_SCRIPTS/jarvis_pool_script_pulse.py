...
FEATURE = {'slug': 'script_pulse', 'title': 'Jarvis Pool Script Pulse', 'objective': 'Generate an automated pulse for the script area using local repo signals.', 'domain': 'script', 'action': 'pulse'}

...
FEATURE = {'slug': 'doctor_router', 'title': 'Jarvis Pool Doctor Router', 'objective': 'Generate an automated router for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'router'}

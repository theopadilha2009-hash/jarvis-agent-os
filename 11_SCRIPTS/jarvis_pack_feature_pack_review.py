...
FEATURE = {'slug': 'feature_pack_review', 'title': 'Jarvis Pack Feature Review', 'mission': 'Review generated auto/pool features and separate useful growth from shallow duplication.', 'focus': 'review', 'checks': ['auto_features', 'pool_features', 'families', 'duplication_pressure']}

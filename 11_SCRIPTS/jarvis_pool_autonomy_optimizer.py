...
FEATURE = {'slug': 'autonomy_optimizer', 'title': 'Jarvis Pool Autonomy Optimizer', 'objective': 'Generate an automated optimizer for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'optimizer'}

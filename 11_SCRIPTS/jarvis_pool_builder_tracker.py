...
FEATURE = {'slug': 'builder_tracker', 'title': 'Jarvis Pool Builder Tracker', 'objective': 'Generate an automated tracker for the builder area using local repo signals.', 'domain': 'builder', 'action': 'tracker'}

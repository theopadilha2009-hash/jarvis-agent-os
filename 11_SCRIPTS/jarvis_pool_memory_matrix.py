...
FEATURE = {'slug': 'memory_matrix', 'title': 'Jarvis Pool Memory Matrix', 'objective': 'Generate an automated matrix for the memory area using local repo signals.', 'domain': 'memory', 'action': 'matrix'}

...
FEATURE = {'slug': 'metrics_meter', 'title': 'Jarvis Pool Metrics Meter', 'objective': 'Generate an automated meter for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'meter'}

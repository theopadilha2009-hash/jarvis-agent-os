...
FEATURE = {'slug': 'metrics_builder', 'title': 'Jarvis Pool Metrics Builder', 'objective': 'Generate an automated builder for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'builder'}

...
FEATURE = {'slug': 'security_planner', 'title': 'Jarvis Pool Security Planner', 'objective': 'Generate an automated planner for the security area using local repo signals.', 'domain': 'security', 'action': 'planner'}

...
FEATURE = {'slug': 'reviewer_optimizer', 'title': 'Jarvis Pool Reviewer Optimizer', 'objective': 'Generate an automated optimizer for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'optimizer'}

...
FEATURE = {'slug': 'planning_check', 'title': 'Jarvis Pool Planning Check', 'objective': 'Generate an automated check for the planning area using local repo signals.', 'domain': 'planning', 'action': 'check'}

...
FEATURE = {'slug': 'reviewer_score', 'title': 'Jarvis Pool Reviewer Score', 'objective': 'Generate an automated score for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'score'}

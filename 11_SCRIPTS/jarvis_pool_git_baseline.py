...
FEATURE = {'slug': 'git_baseline', 'title': 'Jarvis Pool Git Baseline', 'objective': 'Generate an automated baseline for the git area using local repo signals.', 'domain': 'git', 'action': 'baseline'}

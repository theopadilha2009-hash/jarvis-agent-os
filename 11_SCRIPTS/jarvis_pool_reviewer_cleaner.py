...
FEATURE = {'slug': 'reviewer_cleaner', 'title': 'Jarvis Pool Reviewer Cleaner', 'objective': 'Generate an automated cleaner for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'cleaner'}

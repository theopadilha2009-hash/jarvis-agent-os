...
FEATURE = {'slug': 'summary_compressor', 'title': 'Jarvis Pool Summary Compressor', 'objective': 'Generate an automated compressor for the summary area using local repo signals.', 'domain': 'summary', 'action': 'compressor'}

...
FEATURE = {'slug': 'autonomy_explainer', 'title': 'Jarvis Pool Autonomy Explainer', 'objective': 'Generate an automated explainer for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'explainer'}

...
FEATURE = {'slug': 'metrics_catalog', 'title': 'Jarvis Pool Metrics Catalog', 'objective': 'Generate an automated catalog for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'catalog'}

...
FEATURE = {'slug': 'architecture_pulse', 'title': 'Jarvis Pool Architecture Pulse', 'objective': 'Generate an automated pulse for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'pulse'}

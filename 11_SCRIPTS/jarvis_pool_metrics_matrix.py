...
FEATURE = {'slug': 'metrics_matrix', 'title': 'Jarvis Pool Metrics Matrix', 'objective': 'Generate an automated matrix for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'matrix'}

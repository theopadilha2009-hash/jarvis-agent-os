...
FEATURE = {'slug': 'security_matrix', 'title': 'Jarvis Pool Security Matrix', 'objective': 'Generate an automated matrix for the security area using local repo signals.', 'domain': 'security', 'action': 'matrix'}

...
FEATURE = {'slug': 'validation_validator', 'title': 'Jarvis Pool Validation Validator', 'objective': 'Generate an automated validator for the validation area using local repo signals.', 'domain': 'validation', 'action': 'validator'}

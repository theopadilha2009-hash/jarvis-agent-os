...
FEATURE = {'slug': 'index_cleaner', 'title': 'Jarvis Pool Index Cleaner', 'objective': 'Generate an automated cleaner for the index area using local repo signals.', 'domain': 'index', 'action': 'cleaner'}

...
FEATURE = {'slug': 'execution_scanner', 'title': 'Jarvis Pool Execution Scanner', 'objective': 'Generate an automated scanner for the execution area using local repo signals.', 'domain': 'execution', 'action': 'scanner'}

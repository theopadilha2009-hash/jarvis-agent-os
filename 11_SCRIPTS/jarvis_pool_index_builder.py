...
FEATURE = {'slug': 'index_builder', 'title': 'Jarvis Pool Index Builder', 'objective': 'Generate an automated builder for the index area using local repo signals.', 'domain': 'index', 'action': 'builder'}

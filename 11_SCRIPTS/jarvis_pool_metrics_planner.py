...
FEATURE = {'slug': 'metrics_planner', 'title': 'Jarvis Pool Metrics Planner', 'objective': 'Generate an automated planner for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'planner'}

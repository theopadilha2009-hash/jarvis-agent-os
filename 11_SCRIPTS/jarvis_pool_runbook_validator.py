...
FEATURE = {'slug': 'runbook_validator', 'title': 'Jarvis Pool Runbook Validator', 'objective': 'Generate an automated validator for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'validator'}

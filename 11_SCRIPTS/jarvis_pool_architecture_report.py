...
FEATURE = {'slug': 'architecture_report', 'title': 'Jarvis Pool Architecture Report', 'objective': 'Generate an automated report for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'report'}

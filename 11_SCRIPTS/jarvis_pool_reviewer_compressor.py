...
FEATURE = {'slug': 'reviewer_compressor', 'title': 'Jarvis Pool Reviewer Compressor', 'objective': 'Generate an automated compressor for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'compressor'}

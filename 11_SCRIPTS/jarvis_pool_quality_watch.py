...
FEATURE = {'slug': 'quality_watch', 'title': 'Jarvis Pool Quality Watch', 'objective': 'Generate an automated watch for the quality area using local repo signals.', 'domain': 'quality', 'action': 'watch'}

...
FEATURE = {'slug': 'performance_digest', 'title': 'Jarvis Pool Performance Digest', 'objective': 'Generate an automated digest for the performance area using local repo signals.', 'domain': 'performance', 'action': 'digest'}

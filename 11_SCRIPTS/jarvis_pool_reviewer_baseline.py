...
FEATURE = {'slug': 'reviewer_baseline', 'title': 'Jarvis Pool Reviewer Baseline', 'objective': 'Generate an automated baseline for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'baseline'}

...
FEATURE = {'slug': 'architecture_catalog', 'title': 'Jarvis Pool Architecture Catalog', 'objective': 'Generate an automated catalog for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'catalog'}

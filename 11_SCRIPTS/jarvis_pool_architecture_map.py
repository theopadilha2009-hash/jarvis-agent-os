...
FEATURE = {'slug': 'architecture_map', 'title': 'Jarvis Pool Architecture Map', 'objective': 'Generate an automated map for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'map'}

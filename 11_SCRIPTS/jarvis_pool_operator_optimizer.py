...
FEATURE = {'slug': 'operator_optimizer', 'title': 'Jarvis Pool Operator Optimizer', 'objective': 'Generate an automated optimizer for the operator area using local repo signals.', 'domain': 'operator', 'action': 'optimizer'}

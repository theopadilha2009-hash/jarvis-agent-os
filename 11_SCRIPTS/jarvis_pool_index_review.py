...
FEATURE = {'slug': 'index_review', 'title': 'Jarvis Pool Index Review', 'objective': 'Generate an automated review for the index area using local repo signals.', 'domain': 'index', 'action': 'review'}

...
FEATURE = {'slug': 'script_builder', 'title': 'Jarvis Pool Script Builder', 'objective': 'Generate an automated builder for the script area using local repo signals.', 'domain': 'script', 'action': 'builder'}

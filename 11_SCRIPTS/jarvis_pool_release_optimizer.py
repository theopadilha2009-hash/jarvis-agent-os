...
FEATURE = {'slug': 'release_optimizer', 'title': 'Jarvis Pool Release Optimizer', 'objective': 'Generate an automated optimizer for the release area using local repo signals.', 'domain': 'release', 'action': 'optimizer'}

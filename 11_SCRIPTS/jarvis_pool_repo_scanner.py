...
FEATURE = {'slug': 'repo_scanner', 'title': 'Jarvis Pool Repo Scanner', 'objective': 'Generate an automated scanner for the repo area using local repo signals.', 'domain': 'repo', 'action': 'scanner'}

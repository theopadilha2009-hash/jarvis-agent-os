...
FEATURE = {'slug': 'runbook_check', 'title': 'Jarvis Pool Runbook Check', 'objective': 'Generate an automated check for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'check'}

...
FEATURE = {'slug': 'dashboard_check', 'title': 'Jarvis Pool Dashboard Check', 'objective': 'Generate an automated check for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'check'}

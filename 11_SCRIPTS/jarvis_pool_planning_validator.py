...
FEATURE = {'slug': 'planning_validator', 'title': 'Jarvis Pool Planning Validator', 'objective': 'Generate an automated validator for the planning area using local repo signals.', 'domain': 'planning', 'action': 'validator'}

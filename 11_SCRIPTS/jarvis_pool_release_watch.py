...
FEATURE = {'slug': 'release_watch', 'title': 'Jarvis Pool Release Watch', 'objective': 'Generate an automated watch for the release area using local repo signals.', 'domain': 'release', 'action': 'watch'}

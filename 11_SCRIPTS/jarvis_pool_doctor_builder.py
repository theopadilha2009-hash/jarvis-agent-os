...
FEATURE = {'slug': 'doctor_builder', 'title': 'Jarvis Pool Doctor Builder', 'objective': 'Generate an automated builder for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'builder'}

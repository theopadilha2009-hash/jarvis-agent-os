...
FEATURE = {'slug': 'quality_coordinator', 'title': 'Jarvis Pool Quality Coordinator', 'objective': 'Generate an automated coordinator for the quality area using local repo signals.', 'domain': 'quality', 'action': 'coordinator'}

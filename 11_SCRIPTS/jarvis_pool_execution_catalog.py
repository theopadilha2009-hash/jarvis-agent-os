...
FEATURE = {'slug': 'execution_catalog', 'title': 'Jarvis Pool Execution Catalog', 'objective': 'Generate an automated catalog for the execution area using local repo signals.', 'domain': 'execution', 'action': 'catalog'}

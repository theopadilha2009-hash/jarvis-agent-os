...
FEATURE = {'slug': 'runbook_explainer', 'title': 'Jarvis Pool Runbook Explainer', 'objective': 'Generate an automated explainer for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'explainer'}

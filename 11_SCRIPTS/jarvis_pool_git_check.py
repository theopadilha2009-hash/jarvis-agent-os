...
FEATURE = {'slug': 'git_check', 'title': 'Jarvis Pool Git Check', 'objective': 'Generate an automated check for the git area using local repo signals.', 'domain': 'git', 'action': 'check'}

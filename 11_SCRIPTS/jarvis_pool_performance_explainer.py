...
FEATURE = {'slug': 'performance_explainer', 'title': 'Jarvis Pool Performance Explainer', 'objective': 'Generate an automated explainer for the performance area using local repo signals.', 'domain': 'performance', 'action': 'explainer'}

...
FEATURE = {'slug': 'repo_watch', 'title': 'Jarvis Pool Repo Watch', 'objective': 'Generate an automated watch for the repo area using local repo signals.', 'domain': 'repo', 'action': 'watch'}

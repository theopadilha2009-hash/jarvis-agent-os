...
FEATURE = {'slug': 'index_report', 'title': 'Jarvis Pool Index Report', 'objective': 'Generate an automated report for the index area using local repo signals.', 'domain': 'index', 'action': 'report'}

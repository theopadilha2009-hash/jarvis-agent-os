...
FEATURE = {'slug': 'shipping_brief', 'title': 'Jarvis Pool Shipping Brief', 'objective': 'Generate an automated brief for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'brief'}

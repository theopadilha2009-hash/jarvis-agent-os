...
FEATURE = {'slug': 'security_explainer', 'title': 'Jarvis Pool Security Explainer', 'objective': 'Generate an automated explainer for the security area using local repo signals.', 'domain': 'security', 'action': 'explainer'}

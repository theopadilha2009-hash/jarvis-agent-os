...
FEATURE = {'slug': 'integration_scanner', 'title': 'Jarvis Pool Integration Scanner', 'objective': 'Generate an automated scanner for the integration area using local repo signals.', 'domain': 'integration', 'action': 'scanner'}

...
FEATURE = {'slug': 'shipping_explainer', 'title': 'Jarvis Pool Shipping Explainer', 'objective': 'Generate an automated explainer for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'explainer'}

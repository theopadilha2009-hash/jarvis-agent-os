...
FEATURE = {'slug': 'summary_map', 'title': 'Jarvis Pool Summary Map', 'objective': 'Generate an automated map for the summary area using local repo signals.', 'domain': 'summary', 'action': 'map'}

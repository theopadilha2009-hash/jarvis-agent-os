...
FEATURE = {'slug': 'builder_planner', 'title': 'Jarvis Pool Builder Planner', 'objective': 'Generate an automated planner for the builder area using local repo signals.', 'domain': 'builder', 'action': 'planner'}

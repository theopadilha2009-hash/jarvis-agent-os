...
FEATURE = {'slug': 'release_explainer', 'title': 'Jarvis Pool Release Explainer', 'objective': 'Generate an automated explainer for the release area using local repo signals.', 'domain': 'release', 'action': 'explainer'}

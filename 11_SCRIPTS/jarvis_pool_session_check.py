...
FEATURE = {'slug': 'session_check', 'title': 'Jarvis Pool Session Check', 'objective': 'Generate an automated check for the session area using local repo signals.', 'domain': 'session', 'action': 'check'}

...
FEATURE = {'slug': 'health_map', 'title': 'Jarvis Pool Health Map', 'objective': 'Generate an automated map for the health area using local repo signals.', 'domain': 'health', 'action': 'map'}

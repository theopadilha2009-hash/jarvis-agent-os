...
FEATURE = {'slug': 'memory_watch', 'title': 'Jarvis Pool Memory Watch', 'objective': 'Generate an automated watch for the memory area using local repo signals.', 'domain': 'memory', 'action': 'watch'}

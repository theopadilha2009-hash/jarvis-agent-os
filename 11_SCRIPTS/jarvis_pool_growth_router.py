...
FEATURE = {'slug': 'growth_router', 'title': 'Jarvis Pool Growth Router', 'objective': 'Generate an automated router for the growth area using local repo signals.', 'domain': 'growth', 'action': 'router'}

...
FEATURE = {'slug': 'script_tracker', 'title': 'Jarvis Pool Script Tracker', 'objective': 'Generate an automated tracker for the script area using local repo signals.', 'domain': 'script', 'action': 'tracker'}

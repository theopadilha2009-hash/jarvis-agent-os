...
FEATURE = {'slug': 'performance_builder', 'title': 'Jarvis Pool Performance Builder', 'objective': 'Generate an automated builder for the performance area using local repo signals.', 'domain': 'performance', 'action': 'builder'}

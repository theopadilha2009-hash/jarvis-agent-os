...
FEATURE = {'slug': 'script_review', 'title': 'Jarvis Pool Script Review', 'objective': 'Generate an automated review for the script area using local repo signals.', 'domain': 'script', 'action': 'review'}

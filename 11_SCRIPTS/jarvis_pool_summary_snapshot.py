...
FEATURE = {'slug': 'summary_snapshot', 'title': 'Jarvis Pool Summary Snapshot', 'objective': 'Generate an automated snapshot for the summary area using local repo signals.', 'domain': 'summary', 'action': 'snapshot'}

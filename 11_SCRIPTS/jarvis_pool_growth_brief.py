...
FEATURE = {'slug': 'growth_brief', 'title': 'Jarvis Pool Growth Brief', 'objective': 'Generate an automated brief for the growth area using local repo signals.', 'domain': 'growth', 'action': 'brief'}

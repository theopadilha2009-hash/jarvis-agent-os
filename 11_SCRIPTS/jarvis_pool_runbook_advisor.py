...
FEATURE = {'slug': 'runbook_advisor', 'title': 'Jarvis Pool Runbook Advisor', 'objective': 'Generate an automated advisor for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'advisor'}

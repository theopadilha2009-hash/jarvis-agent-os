...
FEATURE = {'slug': 'runbook_tracker', 'title': 'Jarvis Pool Runbook Tracker', 'objective': 'Generate an automated tracker for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'tracker'}

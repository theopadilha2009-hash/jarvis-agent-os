...
FEATURE = {'slug': 'execution_pulse', 'title': 'Jarvis Pool Execution Pulse', 'objective': 'Generate an automated pulse for the execution area using local repo signals.', 'domain': 'execution', 'action': 'pulse'}

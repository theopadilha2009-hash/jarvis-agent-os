...
FEATURE = {'slug': 'performance_advisor', 'title': 'Jarvis Pool Performance Advisor', 'objective': 'Generate an automated advisor for the performance area using local repo signals.', 'domain': 'performance', 'action': 'advisor'}

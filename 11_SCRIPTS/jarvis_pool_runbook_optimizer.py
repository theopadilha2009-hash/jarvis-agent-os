...
FEATURE = {'slug': 'runbook_optimizer', 'title': 'Jarvis Pool Runbook Optimizer', 'objective': 'Generate an automated optimizer for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'optimizer'}

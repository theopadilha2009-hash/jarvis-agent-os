...
FEATURE = {'slug': 'architecture_planner', 'title': 'Jarvis Pool Architecture Planner', 'objective': 'Generate an automated planner for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'planner'}

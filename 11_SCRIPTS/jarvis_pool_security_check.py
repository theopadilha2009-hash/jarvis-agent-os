...
FEATURE = {'slug': 'security_check', 'title': 'Jarvis Pool Security Check', 'objective': 'Generate an automated check for the security area using local repo signals.', 'domain': 'security', 'action': 'check'}

...
FEATURE = {'slug': 'planning_review', 'title': 'Jarvis Pool Planning Review', 'objective': 'Generate an automated review for the planning area using local repo signals.', 'domain': 'planning', 'action': 'review'}

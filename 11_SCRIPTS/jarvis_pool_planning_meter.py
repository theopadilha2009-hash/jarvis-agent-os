...
FEATURE = {'slug': 'planning_meter', 'title': 'Jarvis Pool Planning Meter', 'objective': 'Generate an automated meter for the planning area using local repo signals.', 'domain': 'planning', 'action': 'meter'}

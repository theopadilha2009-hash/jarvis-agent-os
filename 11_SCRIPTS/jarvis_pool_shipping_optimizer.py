...
FEATURE = {'slug': 'shipping_optimizer', 'title': 'Jarvis Pool Shipping Optimizer', 'objective': 'Generate an automated optimizer for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'optimizer'}

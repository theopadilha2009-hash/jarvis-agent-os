...
FEATURE = {'slug': 'integration_router', 'title': 'Jarvis Pool Integration Router', 'objective': 'Generate an automated router for the integration area using local repo signals.', 'domain': 'integration', 'action': 'router'}

...
FEATURE = {'slug': 'runbook_pulse', 'title': 'Jarvis Pool Runbook Pulse', 'objective': 'Generate an automated pulse for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'pulse'}

...
FEATURE = {'slug': 'backup_catalog', 'title': 'Jarvis Pool Backup Catalog', 'objective': 'Generate an automated catalog for the backup area using local repo signals.', 'domain': 'backup', 'action': 'catalog'}

...
FEATURE = {'slug': 'summary_builder', 'title': 'Jarvis Pool Summary Builder', 'objective': 'Generate an automated builder for the summary area using local repo signals.', 'domain': 'summary', 'action': 'builder'}

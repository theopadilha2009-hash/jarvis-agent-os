...
FEATURE = {'slug': 'growth_scanner', 'title': 'Jarvis Pool Growth Scanner', 'objective': 'Generate an automated scanner for the growth area using local repo signals.', 'domain': 'growth', 'action': 'scanner'}

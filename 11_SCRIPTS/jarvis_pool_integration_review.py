...
FEATURE = {'slug': 'integration_review', 'title': 'Jarvis Pool Integration Review', 'objective': 'Generate an automated review for the integration area using local repo signals.', 'domain': 'integration', 'action': 'review'}

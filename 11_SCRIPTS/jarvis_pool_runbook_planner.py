...
FEATURE = {'slug': 'runbook_planner', 'title': 'Jarvis Pool Runbook Planner', 'objective': 'Generate an automated planner for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'planner'}

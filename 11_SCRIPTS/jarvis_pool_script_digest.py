...
FEATURE = {'slug': 'script_digest', 'title': 'Jarvis Pool Script Digest', 'objective': 'Generate an automated digest for the script area using local repo signals.', 'domain': 'script', 'action': 'digest'}

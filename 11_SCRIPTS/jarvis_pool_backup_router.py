...
FEATURE = {'slug': 'backup_router', 'title': 'Jarvis Pool Backup Router', 'objective': 'Generate an automated router for the backup area using local repo signals.', 'domain': 'backup', 'action': 'router'}

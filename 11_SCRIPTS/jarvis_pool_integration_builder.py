...
FEATURE = {'slug': 'integration_builder', 'title': 'Jarvis Pool Integration Builder', 'objective': 'Generate an automated builder for the integration area using local repo signals.', 'domain': 'integration', 'action': 'builder'}

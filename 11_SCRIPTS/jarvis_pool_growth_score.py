...
FEATURE = {'slug': 'growth_score', 'title': 'Jarvis Pool Growth Score', 'objective': 'Generate an automated score for the growth area using local repo signals.', 'domain': 'growth', 'action': 'score'}

...
FEATURE = {'slug': 'summary_tracker', 'title': 'Jarvis Pool Summary Tracker', 'objective': 'Generate an automated tracker for the summary area using local repo signals.', 'domain': 'summary', 'action': 'tracker'}

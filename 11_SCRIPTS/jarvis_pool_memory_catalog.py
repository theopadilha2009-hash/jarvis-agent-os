...
FEATURE = {'slug': 'memory_catalog', 'title': 'Jarvis Pool Memory Catalog', 'objective': 'Generate an automated catalog for the memory area using local repo signals.', 'domain': 'memory', 'action': 'catalog'}

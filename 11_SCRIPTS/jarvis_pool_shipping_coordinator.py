...
FEATURE = {'slug': 'shipping_coordinator', 'title': 'Jarvis Pool Shipping Coordinator', 'objective': 'Generate an automated coordinator for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'coordinator'}

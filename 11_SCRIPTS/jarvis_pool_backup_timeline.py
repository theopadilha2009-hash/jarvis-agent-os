...
FEATURE = {'slug': 'backup_timeline', 'title': 'Jarvis Pool Backup Timeline', 'objective': 'Generate an automated timeline for the backup area using local repo signals.', 'domain': 'backup', 'action': 'timeline'}

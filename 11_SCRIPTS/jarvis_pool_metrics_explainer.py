...
FEATURE = {'slug': 'metrics_explainer', 'title': 'Jarvis Pool Metrics Explainer', 'objective': 'Generate an automated explainer for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'explainer'}

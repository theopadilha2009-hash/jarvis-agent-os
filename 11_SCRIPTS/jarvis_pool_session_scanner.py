...
FEATURE = {'slug': 'session_scanner', 'title': 'Jarvis Pool Session Scanner', 'objective': 'Generate an automated scanner for the session area using local repo signals.', 'domain': 'session', 'action': 'scanner'}

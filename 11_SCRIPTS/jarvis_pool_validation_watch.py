...
FEATURE = {'slug': 'validation_watch', 'title': 'Jarvis Pool Validation Watch', 'objective': 'Generate an automated watch for the validation area using local repo signals.', 'domain': 'validation', 'action': 'watch'}

...
FEATURE = {'slug': 'runbook_baseline', 'title': 'Jarvis Pool Runbook Baseline', 'objective': 'Generate an automated baseline for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'baseline'}

...
FEATURE = {'slug': 'performance_score', 'title': 'Jarvis Pool Performance Score', 'objective': 'Generate an automated score for the performance area using local repo signals.', 'domain': 'performance', 'action': 'score'}

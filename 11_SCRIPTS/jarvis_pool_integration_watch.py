...
FEATURE = {'slug': 'integration_watch', 'title': 'Jarvis Pool Integration Watch', 'objective': 'Generate an automated watch for the integration area using local repo signals.', 'domain': 'integration', 'action': 'watch'}

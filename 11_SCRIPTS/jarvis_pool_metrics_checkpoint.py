...
FEATURE = {'slug': 'metrics_checkpoint', 'title': 'Jarvis Pool Metrics Checkpoint', 'objective': 'Generate an automated checkpoint for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'checkpoint'}

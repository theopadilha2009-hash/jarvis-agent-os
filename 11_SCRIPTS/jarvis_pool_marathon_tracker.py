...
FEATURE = {'slug': 'marathon_tracker', 'title': 'Jarvis Pool Marathon Tracker', 'objective': 'Generate an automated tracker for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'tracker'}

...
FEATURE = {'slug': 'dashboard_builder', 'title': 'Jarvis Pool Dashboard Builder', 'objective': 'Generate an automated builder for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'builder'}

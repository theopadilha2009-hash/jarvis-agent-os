...
FEATURE = {'slug': 'backup_index', 'title': 'Jarvis Pool Backup Index', 'objective': 'Generate an automated index for the backup area using local repo signals.', 'domain': 'backup', 'action': 'index'}

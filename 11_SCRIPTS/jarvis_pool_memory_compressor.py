...
FEATURE = {'slug': 'memory_compressor', 'title': 'Jarvis Pool Memory Compressor', 'objective': 'Generate an automated compressor for the memory area using local repo signals.', 'domain': 'memory', 'action': 'compressor'}

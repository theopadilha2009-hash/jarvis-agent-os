...
FEATURE = {'slug': 'marathon_timeline', 'title': 'Jarvis Pool Marathon Timeline', 'objective': 'Generate an automated timeline for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'timeline'}

...
FEATURE = {'slug': 'validation_index', 'title': 'Jarvis Pool Validation Index', 'objective': 'Generate an automated index for the validation area using local repo signals.', 'domain': 'validation', 'action': 'index'}

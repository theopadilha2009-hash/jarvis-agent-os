...
FEATURE = {'slug': 'security_snapshot', 'title': 'Jarvis Pool Security Snapshot', 'objective': 'Generate an automated snapshot for the security area using local repo signals.', 'domain': 'security', 'action': 'snapshot'}

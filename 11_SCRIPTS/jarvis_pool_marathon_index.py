...
FEATURE = {'slug': 'marathon_index', 'title': 'Jarvis Pool Marathon Index', 'objective': 'Generate an automated index for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'index'}

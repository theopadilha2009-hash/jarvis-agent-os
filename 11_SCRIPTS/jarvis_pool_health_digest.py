...
FEATURE = {'slug': 'health_digest', 'title': 'Jarvis Pool Health Digest', 'objective': 'Generate an automated digest for the health area using local repo signals.', 'domain': 'health', 'action': 'digest'}

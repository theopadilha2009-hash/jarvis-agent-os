...
FEATURE = {'slug': 'health_snapshot', 'title': 'Jarvis Pool Health Snapshot', 'objective': 'Generate an automated snapshot for the health area using local repo signals.', 'domain': 'health', 'action': 'snapshot'}

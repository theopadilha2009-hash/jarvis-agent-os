...
FEATURE = {'slug': 'integration_guard', 'title': 'Jarvis Pool Integration Guard', 'objective': 'Generate an automated guard for the integration area using local repo signals.', 'domain': 'integration', 'action': 'guard'}

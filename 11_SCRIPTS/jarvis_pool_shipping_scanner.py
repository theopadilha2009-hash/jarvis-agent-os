...
FEATURE = {'slug': 'shipping_scanner', 'title': 'Jarvis Pool Shipping Scanner', 'objective': 'Generate an automated scanner for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'scanner'}

...
FEATURE = {'slug': 'security_baseline', 'title': 'Jarvis Pool Security Baseline', 'objective': 'Generate an automated baseline for the security area using local repo signals.', 'domain': 'security', 'action': 'baseline'}

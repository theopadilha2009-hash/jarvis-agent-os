...
FEATURE = {'slug': 'performance_guard', 'title': 'Jarvis Pool Performance Guard', 'objective': 'Generate an automated guard for the performance area using local repo signals.', 'domain': 'performance', 'action': 'guard'}

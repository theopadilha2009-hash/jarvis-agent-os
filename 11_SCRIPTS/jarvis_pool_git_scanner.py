...
FEATURE = {'slug': 'git_scanner', 'title': 'Jarvis Pool Git Scanner', 'objective': 'Generate an automated scanner for the git area using local repo signals.', 'domain': 'git', 'action': 'scanner'}

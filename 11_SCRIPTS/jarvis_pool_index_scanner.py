...
FEATURE = {'slug': 'index_scanner', 'title': 'Jarvis Pool Index Scanner', 'objective': 'Generate an automated scanner for the index area using local repo signals.', 'domain': 'index', 'action': 'scanner'}

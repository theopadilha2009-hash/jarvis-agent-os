...
FEATURE = {'slug': 'shipping_advisor', 'title': 'Jarvis Pool Shipping Advisor', 'objective': 'Generate an automated advisor for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'advisor'}

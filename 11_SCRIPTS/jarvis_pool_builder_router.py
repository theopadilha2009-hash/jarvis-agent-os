...
FEATURE = {'slug': 'builder_router', 'title': 'Jarvis Pool Builder Router', 'objective': 'Generate an automated router for the builder area using local repo signals.', 'domain': 'builder', 'action': 'router'}

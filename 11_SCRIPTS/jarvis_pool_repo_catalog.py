...
FEATURE = {'slug': 'repo_catalog', 'title': 'Jarvis Pool Repo Catalog', 'objective': 'Generate an automated catalog for the repo area using local repo signals.', 'domain': 'repo', 'action': 'catalog'}

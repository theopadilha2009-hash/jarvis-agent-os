...
FEATURE = {'slug': 'summary_guard', 'title': 'Jarvis Pool Summary Guard', 'objective': 'Generate an automated guard for the summary area using local repo signals.', 'domain': 'summary', 'action': 'guard'}

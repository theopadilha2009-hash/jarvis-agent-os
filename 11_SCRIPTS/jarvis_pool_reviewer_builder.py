...
FEATURE = {'slug': 'reviewer_builder', 'title': 'Jarvis Pool Reviewer Builder', 'objective': 'Generate an automated builder for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'builder'}

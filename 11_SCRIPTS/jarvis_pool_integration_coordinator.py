...
FEATURE = {'slug': 'integration_coordinator', 'title': 'Jarvis Pool Integration Coordinator', 'objective': 'Generate an automated coordinator for the integration area using local repo signals.', 'domain': 'integration', 'action': 'coordinator'}

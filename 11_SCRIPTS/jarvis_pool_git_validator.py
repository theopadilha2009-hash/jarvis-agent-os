...
FEATURE = {'slug': 'git_validator', 'title': 'Jarvis Pool Git Validator', 'objective': 'Generate an automated validator for the git area using local repo signals.', 'domain': 'git', 'action': 'validator'}

...
FEATURE = {'slug': 'health_advisor', 'title': 'Jarvis Pool Health Advisor', 'objective': 'Generate an automated advisor for the health area using local repo signals.', 'domain': 'health', 'action': 'advisor'}

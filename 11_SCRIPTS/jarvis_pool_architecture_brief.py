...
FEATURE = {'slug': 'architecture_brief', 'title': 'Jarvis Pool Architecture Brief', 'objective': 'Generate an automated brief for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'brief'}

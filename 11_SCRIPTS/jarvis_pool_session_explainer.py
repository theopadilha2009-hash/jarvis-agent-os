...
FEATURE = {'slug': 'session_explainer', 'title': 'Jarvis Pool Session Explainer', 'objective': 'Generate an automated explainer for the session area using local repo signals.', 'domain': 'session', 'action': 'explainer'}

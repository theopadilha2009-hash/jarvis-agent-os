...
FEATURE = {'slug': 'autonomy_catalog', 'title': 'Jarvis Pool Autonomy Catalog', 'objective': 'Generate an automated catalog for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'catalog'}

...
FEATURE = {'slug': 'quality_score', 'title': 'Jarvis Pool Quality Score', 'objective': 'Generate an automated score for the quality area using local repo signals.', 'domain': 'quality', 'action': 'score'}

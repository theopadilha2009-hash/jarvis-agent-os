...
FEATURE = {'slug': 'planning_pulse', 'title': 'Jarvis Pool Planning Pulse', 'objective': 'Generate an automated pulse for the planning area using local repo signals.', 'domain': 'planning', 'action': 'pulse'}

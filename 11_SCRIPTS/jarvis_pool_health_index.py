...
FEATURE = {'slug': 'health_index', 'title': 'Jarvis Pool Health Index', 'objective': 'Generate an automated index for the health area using local repo signals.', 'domain': 'health', 'action': 'index'}

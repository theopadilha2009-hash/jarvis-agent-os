...
FEATURE = {'slug': 'summary_scanner', 'title': 'Jarvis Pool Summary Scanner', 'objective': 'Generate an automated scanner for the summary area using local repo signals.', 'domain': 'summary', 'action': 'scanner'}

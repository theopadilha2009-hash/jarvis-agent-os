...
FEATURE = {'slug': 'reviewer_planner', 'title': 'Jarvis Pool Reviewer Planner', 'objective': 'Generate an automated planner for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'planner'}

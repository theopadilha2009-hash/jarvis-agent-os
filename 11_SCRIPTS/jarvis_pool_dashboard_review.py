...
FEATURE = {'slug': 'dashboard_review', 'title': 'Jarvis Pool Dashboard Review', 'objective': 'Generate an automated review for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'review'}

...
FEATURE = {'slug': 'growth_tracker', 'title': 'Jarvis Pool Growth Tracker', 'objective': 'Generate an automated tracker for the growth area using local repo signals.', 'domain': 'growth', 'action': 'tracker'}

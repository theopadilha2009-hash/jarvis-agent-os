...
FEATURE = {'slug': 'doctor_timeline', 'title': 'Jarvis Pool Doctor Timeline', 'objective': 'Generate an automated timeline for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'timeline'}

...
FEATURE = {'slug': 'feature_backlog_snapshot', 'title': 'Jarvis Auto Feature Backlog Snapshot', 'objective': 'Create a lightweight snapshot of generated feature candidates and next build direction.'}

...
FEATURE = {'slug': 'quality_digest', 'title': 'Jarvis Pool Quality Digest', 'objective': 'Generate an automated digest for the quality area using local repo signals.', 'domain': 'quality', 'action': 'digest'}

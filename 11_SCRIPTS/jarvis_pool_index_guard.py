...
FEATURE = {'slug': 'index_guard', 'title': 'Jarvis Pool Index Guard', 'objective': 'Generate an automated guard for the index area using local repo signals.', 'domain': 'index', 'action': 'guard'}

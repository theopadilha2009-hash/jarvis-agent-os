...
FEATURE = {'slug': 'doctor_validator', 'title': 'Jarvis Pool Doctor Validator', 'objective': 'Generate an automated validator for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'validator'}

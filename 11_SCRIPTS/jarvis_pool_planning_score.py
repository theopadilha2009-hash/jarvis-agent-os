...
FEATURE = {'slug': 'planning_score', 'title': 'Jarvis Pool Planning Score', 'objective': 'Generate an automated score for the planning area using local repo signals.', 'domain': 'planning', 'action': 'score'}

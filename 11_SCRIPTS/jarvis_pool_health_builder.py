...
FEATURE = {'slug': 'health_builder', 'title': 'Jarvis Pool Health Builder', 'objective': 'Generate an automated builder for the health area using local repo signals.', 'domain': 'health', 'action': 'builder'}

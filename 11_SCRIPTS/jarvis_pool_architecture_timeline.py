...
FEATURE = {'slug': 'architecture_timeline', 'title': 'Jarvis Pool Architecture Timeline', 'objective': 'Generate an automated timeline for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'timeline'}

...
FEATURE = {'slug': 'memory_checkpoint', 'title': 'Jarvis Pool Memory Checkpoint', 'objective': 'Generate an automated checkpoint for the memory area using local repo signals.', 'domain': 'memory', 'action': 'checkpoint'}

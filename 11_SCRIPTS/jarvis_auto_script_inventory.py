...
FEATURE = {'slug': 'script_inventory', 'title': 'Jarvis Auto Script Inventory', 'objective': 'Generate an inventory of Jarvis scripts and identify the largest automation files.'}

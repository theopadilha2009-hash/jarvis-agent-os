...
FEATURE = {'slug': 'operator_watch', 'title': 'Jarvis Pool Operator Watch', 'objective': 'Generate an automated watch for the operator area using local repo signals.', 'domain': 'operator', 'action': 'watch'}

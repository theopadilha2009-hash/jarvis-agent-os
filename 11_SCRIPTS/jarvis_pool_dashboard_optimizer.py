...
FEATURE = {'slug': 'dashboard_optimizer', 'title': 'Jarvis Pool Dashboard Optimizer', 'objective': 'Generate an automated optimizer for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'optimizer'}

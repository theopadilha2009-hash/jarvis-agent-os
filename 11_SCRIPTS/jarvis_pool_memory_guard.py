...
FEATURE = {'slug': 'memory_guard', 'title': 'Jarvis Pool Memory Guard', 'objective': 'Generate an automated guard for the memory area using local repo signals.', 'domain': 'memory', 'action': 'guard'}

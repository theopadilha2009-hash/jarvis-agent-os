...
FEATURE = {'slug': 'session_snapshot', 'title': 'Jarvis Pool Session Snapshot', 'objective': 'Generate an automated snapshot for the session area using local repo signals.', 'domain': 'session', 'action': 'snapshot'}

...
FEATURE = {'slug': 'audit_map', 'title': 'Jarvis Pool Audit Map', 'objective': 'Generate an automated map for the audit area using local repo signals.', 'domain': 'audit', 'action': 'map'}

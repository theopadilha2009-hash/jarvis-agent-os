...
FEATURE = {'slug': 'builder_report', 'title': 'Jarvis Pool Builder Report', 'objective': 'Generate an automated report for the builder area using local repo signals.', 'domain': 'builder', 'action': 'report'}

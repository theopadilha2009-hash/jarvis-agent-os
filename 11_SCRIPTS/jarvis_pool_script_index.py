...
FEATURE = {'slug': 'script_index', 'title': 'Jarvis Pool Script Index', 'objective': 'Generate an automated index for the script area using local repo signals.', 'domain': 'script', 'action': 'index'}

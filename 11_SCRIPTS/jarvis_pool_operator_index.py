...
FEATURE = {'slug': 'operator_index', 'title': 'Jarvis Pool Operator Index', 'objective': 'Generate an automated index for the operator area using local repo signals.', 'domain': 'operator', 'action': 'index'}

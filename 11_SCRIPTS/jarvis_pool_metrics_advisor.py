...
FEATURE = {'slug': 'metrics_advisor', 'title': 'Jarvis Pool Metrics Advisor', 'objective': 'Generate an automated advisor for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'advisor'}

...
FEATURE = {'slug': 'metrics_baseline', 'title': 'Jarvis Pool Metrics Baseline', 'objective': 'Generate an automated baseline for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'baseline'}

...
FEATURE = {'slug': 'audit_watch', 'title': 'Jarvis Pool Audit Watch', 'objective': 'Generate an automated watch for the audit area using local repo signals.', 'domain': 'audit', 'action': 'watch'}

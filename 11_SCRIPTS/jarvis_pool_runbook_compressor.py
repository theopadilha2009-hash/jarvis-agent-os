...
FEATURE = {'slug': 'runbook_compressor', 'title': 'Jarvis Pool Runbook Compressor', 'objective': 'Generate an automated compressor for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'compressor'}

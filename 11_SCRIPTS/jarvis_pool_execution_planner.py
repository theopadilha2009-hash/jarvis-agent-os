...
FEATURE = {'slug': 'execution_planner', 'title': 'Jarvis Pool Execution Planner', 'objective': 'Generate an automated planner for the execution area using local repo signals.', 'domain': 'execution', 'action': 'planner'}

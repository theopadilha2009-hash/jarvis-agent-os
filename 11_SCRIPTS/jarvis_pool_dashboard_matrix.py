...
FEATURE = {'slug': 'dashboard_matrix', 'title': 'Jarvis Pool Dashboard Matrix', 'objective': 'Generate an automated matrix for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'matrix'}

...
FEATURE = {'slug': 'audit_review', 'title': 'Jarvis Pool Audit Review', 'objective': 'Generate an automated review for the audit area using local repo signals.', 'domain': 'audit', 'action': 'review'}

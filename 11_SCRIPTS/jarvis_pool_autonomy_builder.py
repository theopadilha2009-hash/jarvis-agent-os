...
FEATURE = {'slug': 'autonomy_builder', 'title': 'Jarvis Pool Autonomy Builder', 'objective': 'Generate an automated builder for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'builder'}

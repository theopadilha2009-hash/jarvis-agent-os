...
FEATURE = {'slug': 'operator_builder', 'title': 'Jarvis Pool Operator Builder', 'objective': 'Generate an automated builder for the operator area using local repo signals.', 'domain': 'operator', 'action': 'builder'}

...
FEATURE = {'slug': 'integration_catalog', 'title': 'Jarvis Pool Integration Catalog', 'objective': 'Generate an automated catalog for the integration area using local repo signals.', 'domain': 'integration', 'action': 'catalog'}

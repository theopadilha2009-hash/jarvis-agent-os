...
FEATURE = {'slug': 'reviewer_index', 'title': 'Jarvis Pool Reviewer Index', 'objective': 'Generate an automated index for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'index'}

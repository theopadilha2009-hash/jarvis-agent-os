...
FEATURE = {'slug': 'architecture_meter', 'title': 'Jarvis Pool Architecture Meter', 'objective': 'Generate an automated meter for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'meter'}

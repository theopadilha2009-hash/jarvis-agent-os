...
FEATURE = {'slug': 'repo_signal_router', 'title': 'Jarvis Pack Repo Signal Router', 'mission': 'Convert local repo signals into clear next routes: improve speed, build features, clean outputs, or review quality.', 'focus': 'routing', 'checks': ['profiler', 'git_status', 'line_count', 'script_count', 'execution_count']}

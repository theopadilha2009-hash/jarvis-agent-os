...
FEATURE = {'slug': 'execution_report', 'title': 'Jarvis Pool Execution Report', 'objective': 'Generate an automated report for the execution area using local repo signals.', 'domain': 'execution', 'action': 'report'}

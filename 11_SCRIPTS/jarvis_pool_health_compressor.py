...
FEATURE = {'slug': 'health_compressor', 'title': 'Jarvis Pool Health Compressor', 'objective': 'Generate an automated compressor for the health area using local repo signals.', 'domain': 'health', 'action': 'compressor'}

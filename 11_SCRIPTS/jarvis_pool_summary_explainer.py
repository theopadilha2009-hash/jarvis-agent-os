...
FEATURE = {'slug': 'summary_explainer', 'title': 'Jarvis Pool Summary Explainer', 'objective': 'Generate an automated explainer for the summary area using local repo signals.', 'domain': 'summary', 'action': 'explainer'}

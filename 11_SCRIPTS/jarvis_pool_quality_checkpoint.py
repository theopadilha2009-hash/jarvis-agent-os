...
FEATURE = {'slug': 'quality_checkpoint', 'title': 'Jarvis Pool Quality Checkpoint', 'objective': 'Generate an automated checkpoint for the quality area using local repo signals.', 'domain': 'quality', 'action': 'checkpoint'}

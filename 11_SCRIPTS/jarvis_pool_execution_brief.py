...
FEATURE = {'slug': 'execution_brief', 'title': 'Jarvis Pool Execution Brief', 'objective': 'Generate an automated brief for the execution area using local repo signals.', 'domain': 'execution', 'action': 'brief'}

...
FEATURE = {'slug': 'summary_meter', 'title': 'Jarvis Pool Summary Meter', 'objective': 'Generate an automated meter for the summary area using local repo signals.', 'domain': 'summary', 'action': 'meter'}

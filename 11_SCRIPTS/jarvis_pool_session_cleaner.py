...
FEATURE = {'slug': 'session_cleaner', 'title': 'Jarvis Pool Session Cleaner', 'objective': 'Generate an automated cleaner for the session area using local repo signals.', 'domain': 'session', 'action': 'cleaner'}

...
FEATURE = {'slug': 'operator_compressor', 'title': 'Jarvis Pool Operator Compressor', 'objective': 'Generate an automated compressor for the operator area using local repo signals.', 'domain': 'operator', 'action': 'compressor'}

...
FEATURE = {'slug': 'health_check', 'title': 'Jarvis Pool Health Check', 'objective': 'Generate an automated check for the health area using local repo signals.', 'domain': 'health', 'action': 'check'}

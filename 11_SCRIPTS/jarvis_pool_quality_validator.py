...
FEATURE = {'slug': 'quality_validator', 'title': 'Jarvis Pool Quality Validator', 'objective': 'Generate an automated validator for the quality area using local repo signals.', 'domain': 'quality', 'action': 'validator'}

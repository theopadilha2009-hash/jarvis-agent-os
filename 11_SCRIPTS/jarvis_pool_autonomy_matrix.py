...
FEATURE = {'slug': 'autonomy_matrix', 'title': 'Jarvis Pool Autonomy Matrix', 'objective': 'Generate an automated matrix for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'matrix'}

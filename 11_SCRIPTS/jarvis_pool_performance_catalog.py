...
FEATURE = {'slug': 'performance_catalog', 'title': 'Jarvis Pool Performance Catalog', 'objective': 'Generate an automated catalog for the performance area using local repo signals.', 'domain': 'performance', 'action': 'catalog'}

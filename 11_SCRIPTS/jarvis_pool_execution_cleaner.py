...
FEATURE = {'slug': 'execution_cleaner', 'title': 'Jarvis Pool Execution Cleaner', 'objective': 'Generate an automated cleaner for the execution area using local repo signals.', 'domain': 'execution', 'action': 'cleaner'}

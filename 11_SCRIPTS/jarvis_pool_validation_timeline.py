...
FEATURE = {'slug': 'validation_timeline', 'title': 'Jarvis Pool Validation Timeline', 'objective': 'Generate an automated timeline for the validation area using local repo signals.', 'domain': 'validation', 'action': 'timeline'}

...
FEATURE = {'slug': 'operator_snapshot', 'title': 'Jarvis Pool Operator Snapshot', 'objective': 'Generate an automated snapshot for the operator area using local repo signals.', 'domain': 'operator', 'action': 'snapshot'}

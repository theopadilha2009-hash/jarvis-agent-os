...
FEATURE = {'slug': 'performance_validator', 'title': 'Jarvis Pool Performance Validator', 'objective': 'Generate an automated validator for the performance area using local repo signals.', 'domain': 'performance', 'action': 'validator'}

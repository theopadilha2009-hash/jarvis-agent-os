...
FEATURE = {'slug': 'repo_optimizer', 'title': 'Jarvis Pool Repo Optimizer', 'objective': 'Generate an automated optimizer for the repo area using local repo signals.', 'domain': 'repo', 'action': 'optimizer'}

...
FEATURE = {'slug': 'git_review', 'title': 'Jarvis Pool Git Review', 'objective': 'Generate an automated review for the git area using local repo signals.', 'domain': 'git', 'action': 'review'}

...
FEATURE = {'slug': 'audit_report', 'title': 'Jarvis Pool Audit Report', 'objective': 'Generate an automated report for the audit area using local repo signals.', 'domain': 'audit', 'action': 'report'}

...
FEATURE = {'slug': 'planning_scanner', 'title': 'Jarvis Pool Planning Scanner', 'objective': 'Generate an automated scanner for the planning area using local repo signals.', 'domain': 'planning', 'action': 'scanner'}

...
FEATURE = {'slug': 'backup_validator', 'title': 'Jarvis Pool Backup Validator', 'objective': 'Generate an automated validator for the backup area using local repo signals.', 'domain': 'backup', 'action': 'validator'}

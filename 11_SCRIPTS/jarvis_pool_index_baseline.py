...
FEATURE = {'slug': 'index_baseline', 'title': 'Jarvis Pool Index Baseline', 'objective': 'Generate an automated baseline for the index area using local repo signals.', 'domain': 'index', 'action': 'baseline'}

...
FEATURE = {'slug': 'runbook_checkpoint', 'title': 'Jarvis Pool Runbook Checkpoint', 'objective': 'Generate an automated checkpoint for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'checkpoint'}

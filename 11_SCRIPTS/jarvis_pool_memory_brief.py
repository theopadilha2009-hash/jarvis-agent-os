...
FEATURE = {'slug': 'memory_brief', 'title': 'Jarvis Pool Memory Brief', 'objective': 'Generate an automated brief for the memory area using local repo signals.', 'domain': 'memory', 'action': 'brief'}

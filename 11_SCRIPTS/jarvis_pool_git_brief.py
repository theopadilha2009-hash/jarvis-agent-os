...
FEATURE = {'slug': 'git_brief', 'title': 'Jarvis Pool Git Brief', 'objective': 'Generate an automated brief for the git area using local repo signals.', 'domain': 'git', 'action': 'brief'}

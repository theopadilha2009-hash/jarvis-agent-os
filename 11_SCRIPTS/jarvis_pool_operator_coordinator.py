...
FEATURE = {'slug': 'operator_coordinator', 'title': 'Jarvis Pool Operator Coordinator', 'objective': 'Generate an automated coordinator for the operator area using local repo signals.', 'domain': 'operator', 'action': 'coordinator'}

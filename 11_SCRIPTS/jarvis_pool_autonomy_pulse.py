...
FEATURE = {'slug': 'autonomy_pulse', 'title': 'Jarvis Pool Autonomy Pulse', 'objective': 'Generate an automated pulse for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'pulse'}

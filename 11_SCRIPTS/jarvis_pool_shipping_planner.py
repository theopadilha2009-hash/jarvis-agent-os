...
FEATURE = {'slug': 'shipping_planner', 'title': 'Jarvis Pool Shipping Planner', 'objective': 'Generate an automated planner for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'planner'}

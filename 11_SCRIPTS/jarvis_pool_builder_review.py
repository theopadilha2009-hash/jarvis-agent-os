...
FEATURE = {'slug': 'builder_review', 'title': 'Jarvis Pool Builder Review', 'objective': 'Generate an automated review for the builder area using local repo signals.', 'domain': 'builder', 'action': 'review'}

...
FEATURE = {'slug': 'growth_report', 'title': 'Jarvis Pool Growth Report', 'objective': 'Generate an automated report for the growth area using local repo signals.', 'domain': 'growth', 'action': 'report'}

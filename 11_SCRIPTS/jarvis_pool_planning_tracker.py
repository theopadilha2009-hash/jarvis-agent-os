...
FEATURE = {'slug': 'planning_tracker', 'title': 'Jarvis Pool Planning Tracker', 'objective': 'Generate an automated tracker for the planning area using local repo signals.', 'domain': 'planning', 'action': 'tracker'}

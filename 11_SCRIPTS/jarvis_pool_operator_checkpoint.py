...
FEATURE = {'slug': 'operator_checkpoint', 'title': 'Jarvis Pool Operator Checkpoint', 'objective': 'Generate an automated checkpoint for the operator area using local repo signals.', 'domain': 'operator', 'action': 'checkpoint'}

...
FEATURE = {'slug': 'validation_advisor', 'title': 'Jarvis Pool Validation Advisor', 'objective': 'Generate an automated advisor for the validation area using local repo signals.', 'domain': 'validation', 'action': 'advisor'}

...
FEATURE = {'slug': 'autonomy_validator', 'title': 'Jarvis Pool Autonomy Validator', 'objective': 'Generate an automated validator for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'validator'}

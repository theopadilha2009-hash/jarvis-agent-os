...
FEATURE = {'slug': 'marathon_map', 'title': 'Jarvis Pool Marathon Map', 'objective': 'Generate an automated map for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'map'}

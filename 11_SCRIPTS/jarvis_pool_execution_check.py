...
FEATURE = {'slug': 'execution_check', 'title': 'Jarvis Pool Execution Check', 'objective': 'Generate an automated check for the execution area using local repo signals.', 'domain': 'execution', 'action': 'check'}

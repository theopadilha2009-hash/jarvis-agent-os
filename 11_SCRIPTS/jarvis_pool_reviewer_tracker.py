...
FEATURE = {'slug': 'reviewer_tracker', 'title': 'Jarvis Pool Reviewer Tracker', 'objective': 'Generate an automated tracker for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'tracker'}

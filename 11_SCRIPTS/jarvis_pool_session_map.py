...
FEATURE = {'slug': 'session_map', 'title': 'Jarvis Pool Session Map', 'objective': 'Generate an automated map for the session area using local repo signals.', 'domain': 'session', 'action': 'map'}

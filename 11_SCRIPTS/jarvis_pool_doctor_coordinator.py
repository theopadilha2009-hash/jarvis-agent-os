...
FEATURE = {'slug': 'doctor_coordinator', 'title': 'Jarvis Pool Doctor Coordinator', 'objective': 'Generate an automated coordinator for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'coordinator'}

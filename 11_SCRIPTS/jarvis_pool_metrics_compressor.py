...
FEATURE = {'slug': 'metrics_compressor', 'title': 'Jarvis Pool Metrics Compressor', 'objective': 'Generate an automated compressor for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'compressor'}

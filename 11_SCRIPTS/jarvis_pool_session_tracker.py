...
FEATURE = {'slug': 'session_tracker', 'title': 'Jarvis Pool Session Tracker', 'objective': 'Generate an automated tracker for the session area using local repo signals.', 'domain': 'session', 'action': 'tracker'}

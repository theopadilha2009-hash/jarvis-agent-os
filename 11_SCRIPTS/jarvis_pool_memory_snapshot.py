...
FEATURE = {'slug': 'memory_snapshot', 'title': 'Jarvis Pool Memory Snapshot', 'objective': 'Generate an automated snapshot for the memory area using local repo signals.', 'domain': 'memory', 'action': 'snapshot'}

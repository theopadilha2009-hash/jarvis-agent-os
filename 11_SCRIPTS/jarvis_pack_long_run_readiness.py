...
FEATURE = {'slug': 'long_run_readiness', 'title': 'Jarvis Pack Long Run Readiness', 'mission': 'Score whether Jarvis is ready for 30–60 minute autonomous building sessions.', 'focus': 'autonomy', 'checks': ['clean_repo', 'pool_remaining', 'profiler_speed', 'validation_surface', 'push_safety']}

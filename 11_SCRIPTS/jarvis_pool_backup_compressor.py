...
FEATURE = {'slug': 'backup_compressor', 'title': 'Jarvis Pool Backup Compressor', 'objective': 'Generate an automated compressor for the backup area using local repo signals.', 'domain': 'backup', 'action': 'compressor'}

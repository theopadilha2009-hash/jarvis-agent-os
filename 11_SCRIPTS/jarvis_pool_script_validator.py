...
FEATURE = {'slug': 'script_validator', 'title': 'Jarvis Pool Script Validator', 'objective': 'Generate an automated validator for the script area using local repo signals.', 'domain': 'script', 'action': 'validator'}

...
FEATURE = {'slug': 'memory_report', 'title': 'Jarvis Pool Memory Report', 'objective': 'Generate an automated report for the memory area using local repo signals.', 'domain': 'memory', 'action': 'report'}

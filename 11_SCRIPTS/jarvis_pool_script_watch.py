...
FEATURE = {'slug': 'script_watch', 'title': 'Jarvis Pool Script Watch', 'objective': 'Generate an automated watch for the script area using local repo signals.', 'domain': 'script', 'action': 'watch'}

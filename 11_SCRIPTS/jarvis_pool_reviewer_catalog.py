...
FEATURE = {'slug': 'reviewer_catalog', 'title': 'Jarvis Pool Reviewer Catalog', 'objective': 'Generate an automated catalog for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'catalog'}

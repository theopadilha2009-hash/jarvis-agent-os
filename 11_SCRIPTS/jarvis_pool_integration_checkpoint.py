...
FEATURE = {'slug': 'integration_checkpoint', 'title': 'Jarvis Pool Integration Checkpoint', 'objective': 'Generate an automated checkpoint for the integration area using local repo signals.', 'domain': 'integration', 'action': 'checkpoint'}

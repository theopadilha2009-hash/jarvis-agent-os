...
FEATURE = {'slug': 'architecture_optimizer', 'title': 'Jarvis Pool Architecture Optimizer', 'objective': 'Generate an automated optimizer for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'optimizer'}

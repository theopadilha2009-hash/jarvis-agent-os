...
FEATURE = {'slug': 'autonomy_check', 'title': 'Jarvis Pool Autonomy Check', 'objective': 'Generate an automated check for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'check'}

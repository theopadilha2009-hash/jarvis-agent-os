...
FEATURE = {'slug': 'memory_scanner', 'title': 'Jarvis Pool Memory Scanner', 'objective': 'Generate an automated scanner for the memory area using local repo signals.', 'domain': 'memory', 'action': 'scanner'}

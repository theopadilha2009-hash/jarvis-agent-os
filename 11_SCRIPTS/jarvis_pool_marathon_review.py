...
FEATURE = {'slug': 'marathon_review', 'title': 'Jarvis Pool Marathon Review', 'objective': 'Generate an automated review for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'review'}

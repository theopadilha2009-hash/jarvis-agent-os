...
FEATURE = {'slug': 'quality_planner', 'title': 'Jarvis Pool Quality Planner', 'objective': 'Generate an automated planner for the quality area using local repo signals.', 'domain': 'quality', 'action': 'planner'}

...
FEATURE = {'slug': 'summary_optimizer', 'title': 'Jarvis Pool Summary Optimizer', 'objective': 'Generate an automated optimizer for the summary area using local repo signals.', 'domain': 'summary', 'action': 'optimizer'}

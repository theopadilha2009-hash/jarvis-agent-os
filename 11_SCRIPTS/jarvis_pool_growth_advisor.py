...
FEATURE = {'slug': 'growth_advisor', 'title': 'Jarvis Pool Growth Advisor', 'objective': 'Generate an automated advisor for the growth area using local repo signals.', 'domain': 'growth', 'action': 'advisor'}

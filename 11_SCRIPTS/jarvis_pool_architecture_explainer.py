...
FEATURE = {'slug': 'architecture_explainer', 'title': 'Jarvis Pool Architecture Explainer', 'objective': 'Generate an automated explainer for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'explainer'}

...
FEATURE = {'slug': 'quality_guard', 'title': 'Jarvis Pool Quality Guard', 'objective': 'Generate an automated guard for the quality area using local repo signals.', 'domain': 'quality', 'action': 'guard'}

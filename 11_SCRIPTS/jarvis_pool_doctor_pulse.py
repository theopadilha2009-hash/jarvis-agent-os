...
FEATURE = {'slug': 'doctor_pulse', 'title': 'Jarvis Pool Doctor Pulse', 'objective': 'Generate an automated pulse for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'pulse'}

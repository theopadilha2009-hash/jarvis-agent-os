...
FEATURE = {'slug': 'runbook_digest', 'title': 'Jarvis Pool Runbook Digest', 'objective': 'Generate an automated digest for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'digest'}

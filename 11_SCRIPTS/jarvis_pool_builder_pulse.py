...
FEATURE = {'slug': 'builder_pulse', 'title': 'Jarvis Pool Builder Pulse', 'objective': 'Generate an automated pulse for the builder area using local repo signals.', 'domain': 'builder', 'action': 'pulse'}

...
FEATURE = {'slug': 'dashboard_digest', 'title': 'Jarvis Pool Dashboard Digest', 'objective': 'Generate an automated digest for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'digest'}

...
FEATURE = {'slug': 'runbook_cleaner', 'title': 'Jarvis Pool Runbook Cleaner', 'objective': 'Generate an automated cleaner for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'cleaner'}

...
FEATURE = {'slug': 'runbook_watch', 'title': 'Jarvis Pool Runbook Watch', 'objective': 'Generate an automated watch for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'watch'}

...
FEATURE = {'slug': 'backup_optimizer', 'title': 'Jarvis Pool Backup Optimizer', 'objective': 'Generate an automated optimizer for the backup area using local repo signals.', 'domain': 'backup', 'action': 'optimizer'}

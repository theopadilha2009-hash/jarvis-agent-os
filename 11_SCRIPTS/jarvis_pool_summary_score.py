...
FEATURE = {'slug': 'summary_score', 'title': 'Jarvis Pool Summary Score', 'objective': 'Generate an automated score for the summary area using local repo signals.', 'domain': 'summary', 'action': 'score'}

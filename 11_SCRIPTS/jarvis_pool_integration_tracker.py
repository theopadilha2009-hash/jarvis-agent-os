...
FEATURE = {'slug': 'integration_tracker', 'title': 'Jarvis Pool Integration Tracker', 'objective': 'Generate an automated tracker for the integration area using local repo signals.', 'domain': 'integration', 'action': 'tracker'}

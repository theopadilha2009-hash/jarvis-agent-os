...
FEATURE = {'slug': 'autonomy_index', 'title': 'Jarvis Pool Autonomy Index', 'objective': 'Generate an automated index for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'index'}

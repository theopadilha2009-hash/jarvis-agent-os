...
FEATURE = {'slug': 'index_compressor', 'title': 'Jarvis Pool Index Compressor', 'objective': 'Generate an automated compressor for the index area using local repo signals.', 'domain': 'index', 'action': 'compressor'}

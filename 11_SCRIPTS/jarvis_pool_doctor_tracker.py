...
FEATURE = {'slug': 'doctor_tracker', 'title': 'Jarvis Pool Doctor Tracker', 'objective': 'Generate an automated tracker for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'tracker'}

...
FEATURE = {'slug': 'session_digest', 'title': 'Jarvis Pool Session Digest', 'objective': 'Generate an automated digest for the session area using local repo signals.', 'domain': 'session', 'action': 'digest'}

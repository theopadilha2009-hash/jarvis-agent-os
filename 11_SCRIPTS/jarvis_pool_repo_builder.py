...
FEATURE = {'slug': 'repo_builder', 'title': 'Jarvis Pool Repo Builder', 'objective': 'Generate an automated builder for the repo area using local repo signals.', 'domain': 'repo', 'action': 'builder'}

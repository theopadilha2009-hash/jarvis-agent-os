...
FEATURE = {'slug': 'integration_planner', 'title': 'Jarvis Pool Integration Planner', 'objective': 'Generate an automated planner for the integration area using local repo signals.', 'domain': 'integration', 'action': 'planner'}

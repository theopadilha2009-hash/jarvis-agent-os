...
FEATURE = {'slug': 'summary_review', 'title': 'Jarvis Pool Summary Review', 'objective': 'Generate an automated review for the summary area using local repo signals.', 'domain': 'summary', 'action': 'review'}

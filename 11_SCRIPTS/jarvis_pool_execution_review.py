...
FEATURE = {'slug': 'execution_review', 'title': 'Jarvis Pool Execution Review', 'objective': 'Generate an automated review for the execution area using local repo signals.', 'domain': 'execution', 'action': 'review'}

...
FEATURE = {'slug': 'dashboard_planner', 'title': 'Jarvis Pool Dashboard Planner', 'objective': 'Generate an automated planner for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'planner'}

...
FEATURE = {'slug': 'execution_compressor', 'title': 'Jarvis Pool Execution Compressor', 'objective': 'Generate an automated compressor for the execution area using local repo signals.', 'domain': 'execution', 'action': 'compressor'}

...
FEATURE = {'slug': 'git_builder', 'title': 'Jarvis Pool Git Builder', 'objective': 'Generate an automated builder for the git area using local repo signals.', 'domain': 'git', 'action': 'builder'}

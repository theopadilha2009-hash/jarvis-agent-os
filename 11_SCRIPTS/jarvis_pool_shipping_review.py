...
FEATURE = {'slug': 'shipping_review', 'title': 'Jarvis Pool Shipping Review', 'objective': 'Generate an automated review for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'review'}

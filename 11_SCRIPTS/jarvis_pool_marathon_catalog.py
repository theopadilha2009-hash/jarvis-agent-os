...
FEATURE = {'slug': 'marathon_catalog', 'title': 'Jarvis Pool Marathon Catalog', 'objective': 'Generate an automated catalog for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'catalog'}

...
FEATURE = {'slug': 'audit_tracker', 'title': 'Jarvis Pool Audit Tracker', 'objective': 'Generate an automated tracker for the audit area using local repo signals.', 'domain': 'audit', 'action': 'tracker'}

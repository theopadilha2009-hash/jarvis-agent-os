...
FEATURE = {'slug': 'backup_brief', 'title': 'Jarvis Pool Backup Brief', 'objective': 'Generate an automated brief for the backup area using local repo signals.', 'domain': 'backup', 'action': 'brief'}

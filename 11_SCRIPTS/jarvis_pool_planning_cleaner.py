...
FEATURE = {'slug': 'planning_cleaner', 'title': 'Jarvis Pool Planning Cleaner', 'objective': 'Generate an automated cleaner for the planning area using local repo signals.', 'domain': 'planning', 'action': 'cleaner'}

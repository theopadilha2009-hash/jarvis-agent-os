...
FEATURE = {'slug': 'index_check', 'title': 'Jarvis Pool Index Check', 'objective': 'Generate an automated check for the index area using local repo signals.', 'domain': 'index', 'action': 'check'}

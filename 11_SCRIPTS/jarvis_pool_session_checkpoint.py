...
FEATURE = {'slug': 'session_checkpoint', 'title': 'Jarvis Pool Session Checkpoint', 'objective': 'Generate an automated checkpoint for the session area using local repo signals.', 'domain': 'session', 'action': 'checkpoint'}

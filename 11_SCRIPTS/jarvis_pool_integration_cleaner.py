...
FEATURE = {'slug': 'integration_cleaner', 'title': 'Jarvis Pool Integration Cleaner', 'objective': 'Generate an automated cleaner for the integration area using local repo signals.', 'domain': 'integration', 'action': 'cleaner'}

...
FEATURE = {'slug': 'validation_review', 'title': 'Jarvis Pool Validation Review', 'objective': 'Generate an automated review for the validation area using local repo signals.', 'domain': 'validation', 'action': 'review'}

...
FEATURE = {'slug': 'performance_timeline', 'title': 'Jarvis Pool Performance Timeline', 'objective': 'Generate an automated timeline for the performance area using local repo signals.', 'domain': 'performance', 'action': 'timeline'}

...
FEATURE = {'slug': 'growth_compressor', 'title': 'Jarvis Pool Growth Compressor', 'objective': 'Generate an automated compressor for the growth area using local repo signals.', 'domain': 'growth', 'action': 'compressor'}

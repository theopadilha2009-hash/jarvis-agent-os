...
FEATURE = {'slug': 'metrics_score', 'title': 'Jarvis Pool Metrics Score', 'objective': 'Generate an automated score for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'score'}

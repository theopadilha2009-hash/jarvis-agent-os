...
FEATURE = {'slug': 'index_advisor', 'title': 'Jarvis Pool Index Advisor', 'objective': 'Generate an automated advisor for the index area using local repo signals.', 'domain': 'index', 'action': 'advisor'}

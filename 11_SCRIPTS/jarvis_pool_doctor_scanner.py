...
FEATURE = {'slug': 'doctor_scanner', 'title': 'Jarvis Pool Doctor Scanner', 'objective': 'Generate an automated scanner for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'scanner'}

...
FEATURE = {'slug': 'performance_checkpoint', 'title': 'Jarvis Pool Performance Checkpoint', 'objective': 'Generate an automated checkpoint for the performance area using local repo signals.', 'domain': 'performance', 'action': 'checkpoint'}

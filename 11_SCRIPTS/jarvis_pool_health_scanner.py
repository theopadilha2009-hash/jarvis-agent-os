...
FEATURE = {'slug': 'health_scanner', 'title': 'Jarvis Pool Health Scanner', 'objective': 'Generate an automated scanner for the health area using local repo signals.', 'domain': 'health', 'action': 'scanner'}

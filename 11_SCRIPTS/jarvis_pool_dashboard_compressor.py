...
FEATURE = {'slug': 'dashboard_compressor', 'title': 'Jarvis Pool Dashboard Compressor', 'objective': 'Generate an automated compressor for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'compressor'}

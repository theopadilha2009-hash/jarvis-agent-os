...
FEATURE = {'slug': 'growth_timeline', 'title': 'Jarvis Pool Growth Timeline', 'objective': 'Generate an automated timeline for the growth area using local repo signals.', 'domain': 'growth', 'action': 'timeline'}

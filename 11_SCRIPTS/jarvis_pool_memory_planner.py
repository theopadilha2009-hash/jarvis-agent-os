...
FEATURE = {'slug': 'memory_planner', 'title': 'Jarvis Pool Memory Planner', 'objective': 'Generate an automated planner for the memory area using local repo signals.', 'domain': 'memory', 'action': 'planner'}

...
FEATURE = {'slug': 'summary_watch', 'title': 'Jarvis Pool Summary Watch', 'objective': 'Generate an automated watch for the summary area using local repo signals.', 'domain': 'summary', 'action': 'watch'}

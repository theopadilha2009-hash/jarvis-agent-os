...
FEATURE = {'slug': 'operator_catalog', 'title': 'Jarvis Pool Operator Catalog', 'objective': 'Generate an automated catalog for the operator area using local repo signals.', 'domain': 'operator', 'action': 'catalog'}

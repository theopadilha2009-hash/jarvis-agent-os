...
FEATURE = {'slug': 'operator_pulse', 'title': 'Jarvis Pool Operator Pulse', 'objective': 'Generate an automated pulse for the operator area using local repo signals.', 'domain': 'operator', 'action': 'pulse'}

...
FEATURE = {'slug': 'shipping_builder', 'title': 'Jarvis Pool Shipping Builder', 'objective': 'Generate an automated builder for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'builder'}

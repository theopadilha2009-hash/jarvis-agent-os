...
FEATURE = {'slug': 'audit_catalog', 'title': 'Jarvis Pool Audit Catalog', 'objective': 'Generate an automated catalog for the audit area using local repo signals.', 'domain': 'audit', 'action': 'catalog'}

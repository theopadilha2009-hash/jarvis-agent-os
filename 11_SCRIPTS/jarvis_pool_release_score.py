...
FEATURE = {'slug': 'release_score', 'title': 'Jarvis Pool Release Score', 'objective': 'Generate an automated score for the release area using local repo signals.', 'domain': 'release', 'action': 'score'}

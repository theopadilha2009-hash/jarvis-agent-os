...
FEATURE = {'slug': 'growth_index', 'title': 'Jarvis Pool Growth Index', 'objective': 'Generate an automated index for the growth area using local repo signals.', 'domain': 'growth', 'action': 'index'}

...
FEATURE = {'slug': 'repo_report', 'title': 'Jarvis Pool Repo Report', 'objective': 'Generate an automated report for the repo area using local repo signals.', 'domain': 'repo', 'action': 'report'}

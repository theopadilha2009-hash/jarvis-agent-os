...
FEATURE = {'slug': 'security_optimizer', 'title': 'Jarvis Pool Security Optimizer', 'objective': 'Generate an automated optimizer for the security area using local repo signals.', 'domain': 'security', 'action': 'optimizer'}

...
FEATURE = {'slug': 'growth_map', 'title': 'Jarvis Pool Growth Map', 'objective': 'Generate an automated map for the growth area using local repo signals.', 'domain': 'growth', 'action': 'map'}

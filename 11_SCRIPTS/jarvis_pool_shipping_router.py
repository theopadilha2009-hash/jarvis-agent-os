...
FEATURE = {'slug': 'shipping_router', 'title': 'Jarvis Pool Shipping Router', 'objective': 'Generate an automated router for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'router'}

...
FEATURE = {'slug': 'planning_builder', 'title': 'Jarvis Pool Planning Builder', 'objective': 'Generate an automated builder for the planning area using local repo signals.', 'domain': 'planning', 'action': 'builder'}

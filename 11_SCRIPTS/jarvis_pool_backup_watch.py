...
FEATURE = {'slug': 'backup_watch', 'title': 'Jarvis Pool Backup Watch', 'objective': 'Generate an automated watch for the backup area using local repo signals.', 'domain': 'backup', 'action': 'watch'}

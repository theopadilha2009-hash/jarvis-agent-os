...
FEATURE = {'slug': 'architecture_cleaner', 'title': 'Jarvis Pool Architecture Cleaner', 'objective': 'Generate an automated cleaner for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'cleaner'}

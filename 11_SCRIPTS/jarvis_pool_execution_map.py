...
FEATURE = {'slug': 'execution_map', 'title': 'Jarvis Pool Execution Map', 'objective': 'Generate an automated map for the execution area using local repo signals.', 'domain': 'execution', 'action': 'map'}

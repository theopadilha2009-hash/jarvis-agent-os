...
FEATURE = {'slug': 'audit_compressor', 'title': 'Jarvis Pool Audit Compressor', 'objective': 'Generate an automated compressor for the audit area using local repo signals.', 'domain': 'audit', 'action': 'compressor'}

...
FEATURE = {'slug': 'security_guard', 'title': 'Jarvis Pool Security Guard', 'objective': 'Generate an automated guard for the security area using local repo signals.', 'domain': 'security', 'action': 'guard'}

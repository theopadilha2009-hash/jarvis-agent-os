...
FEATURE = {'slug': 'reviewer_scanner', 'title': 'Jarvis Pool Reviewer Scanner', 'objective': 'Generate an automated scanner for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'scanner'}

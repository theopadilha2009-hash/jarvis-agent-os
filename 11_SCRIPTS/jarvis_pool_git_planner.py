...
FEATURE = {'slug': 'git_planner', 'title': 'Jarvis Pool Git Planner', 'objective': 'Generate an automated planner for the git area using local repo signals.', 'domain': 'git', 'action': 'planner'}

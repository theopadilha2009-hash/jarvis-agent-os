...
FEATURE = {'slug': 'security_score', 'title': 'Jarvis Pool Security Score', 'objective': 'Generate an automated score for the security area using local repo signals.', 'domain': 'security', 'action': 'score'}

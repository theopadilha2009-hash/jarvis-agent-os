...
FEATURE = {'slug': 'dashboard_map', 'title': 'Jarvis Pool Dashboard Map', 'objective': 'Generate an automated map for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'map'}

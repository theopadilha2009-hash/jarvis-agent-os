...
FEATURE = {'slug': 'git_pulse', 'title': 'Jarvis Pool Git Pulse', 'objective': 'Generate an automated pulse for the git area using local repo signals.', 'domain': 'git', 'action': 'pulse'}

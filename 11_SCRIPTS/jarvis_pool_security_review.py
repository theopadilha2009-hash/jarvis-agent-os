...
FEATURE = {'slug': 'security_review', 'title': 'Jarvis Pool Security Review', 'objective': 'Generate an automated review for the security area using local repo signals.', 'domain': 'security', 'action': 'review'}

...
FEATURE = {'slug': 'execution_coordinator', 'title': 'Jarvis Pool Execution Coordinator', 'objective': 'Generate an automated coordinator for the execution area using local repo signals.', 'domain': 'execution', 'action': 'coordinator'}

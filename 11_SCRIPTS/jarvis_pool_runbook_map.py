...
FEATURE = {'slug': 'runbook_map', 'title': 'Jarvis Pool Runbook Map', 'objective': 'Generate an automated map for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'map'}

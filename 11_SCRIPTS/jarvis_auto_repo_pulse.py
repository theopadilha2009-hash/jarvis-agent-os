...
FEATURE = {'slug': 'repo_pulse', 'title': 'Jarvis Auto Repo Pulse', 'objective': 'Generate a compact repository pulse with git status, recent commits, script count, and execution count.'}

...
FEATURE = {'slug': 'metrics_review', 'title': 'Jarvis Pool Metrics Review', 'objective': 'Generate an automated review for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'review'}

...
FEATURE = {'slug': 'doctor_baseline', 'title': 'Jarvis Pool Doctor Baseline', 'objective': 'Generate an automated baseline for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'baseline'}

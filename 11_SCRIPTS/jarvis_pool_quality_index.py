...
FEATURE = {'slug': 'quality_index', 'title': 'Jarvis Pool Quality Index', 'objective': 'Generate an automated index for the quality area using local repo signals.', 'domain': 'quality', 'action': 'index'}

...
FEATURE = {'slug': 'execution_tracker', 'title': 'Jarvis Pool Execution Tracker', 'objective': 'Generate an automated tracker for the execution area using local repo signals.', 'domain': 'execution', 'action': 'tracker'}

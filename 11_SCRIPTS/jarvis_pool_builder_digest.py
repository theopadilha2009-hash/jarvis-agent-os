...
FEATURE = {'slug': 'builder_digest', 'title': 'Jarvis Pool Builder Digest', 'objective': 'Generate an automated digest for the builder area using local repo signals.', 'domain': 'builder', 'action': 'digest'}

...
FEATURE = {'slug': 'audit_check', 'title': 'Jarvis Pool Audit Check', 'objective': 'Generate an automated check for the audit area using local repo signals.', 'domain': 'audit', 'action': 'check'}

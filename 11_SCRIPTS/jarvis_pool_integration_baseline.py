...
FEATURE = {'slug': 'integration_baseline', 'title': 'Jarvis Pool Integration Baseline', 'objective': 'Generate an automated baseline for the integration area using local repo signals.', 'domain': 'integration', 'action': 'baseline'}

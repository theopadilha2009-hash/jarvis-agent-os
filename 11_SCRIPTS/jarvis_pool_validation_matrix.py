...
FEATURE = {'slug': 'validation_matrix', 'title': 'Jarvis Pool Validation Matrix', 'objective': 'Generate an automated matrix for the validation area using local repo signals.', 'domain': 'validation', 'action': 'matrix'}

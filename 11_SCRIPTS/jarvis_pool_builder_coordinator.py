...
FEATURE = {'slug': 'builder_coordinator', 'title': 'Jarvis Pool Builder Coordinator', 'objective': 'Generate an automated coordinator for the builder area using local repo signals.', 'domain': 'builder', 'action': 'coordinator'}

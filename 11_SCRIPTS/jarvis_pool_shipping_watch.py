...
FEATURE = {'slug': 'shipping_watch', 'title': 'Jarvis Pool Shipping Watch', 'objective': 'Generate an automated watch for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'watch'}

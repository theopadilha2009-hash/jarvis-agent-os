...
FEATURE = {'slug': 'planning_snapshot', 'title': 'Jarvis Pool Planning Snapshot', 'objective': 'Generate an automated snapshot for the planning area using local repo signals.', 'domain': 'planning', 'action': 'snapshot'}

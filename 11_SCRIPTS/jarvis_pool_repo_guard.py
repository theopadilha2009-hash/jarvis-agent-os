...
FEATURE = {'slug': 'repo_guard', 'title': 'Jarvis Pool Repo Guard', 'objective': 'Generate an automated guard for the repo area using local repo signals.', 'domain': 'repo', 'action': 'guard'}

...
FEATURE = {'slug': 'summary_timeline', 'title': 'Jarvis Pool Summary Timeline', 'objective': 'Generate an automated timeline for the summary area using local repo signals.', 'domain': 'summary', 'action': 'timeline'}

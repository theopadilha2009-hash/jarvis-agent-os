...
FEATURE = {'slug': 'autonomy_guard', 'title': 'Jarvis Pool Autonomy Guard', 'objective': 'Generate an automated guard for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'guard'}

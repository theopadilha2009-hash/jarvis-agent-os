...
FEATURE = {'slug': 'doctor_snapshot', 'title': 'Jarvis Pool Doctor Snapshot', 'objective': 'Generate an automated snapshot for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'snapshot'}

...
FEATURE = {'slug': 'security_report', 'title': 'Jarvis Pool Security Report', 'objective': 'Generate an automated report for the security area using local repo signals.', 'domain': 'security', 'action': 'report'}

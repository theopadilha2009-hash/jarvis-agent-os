...
FEATURE = {'slug': 'performance_map', 'title': 'Jarvis Pool Performance Map', 'objective': 'Generate an automated map for the performance area using local repo signals.', 'domain': 'performance', 'action': 'map'}

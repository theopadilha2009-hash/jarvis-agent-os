...
FEATURE = {'slug': 'marathon_pulse', 'title': 'Jarvis Pool Marathon Pulse', 'objective': 'Generate an automated pulse for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'pulse'}

...
FEATURE = {'slug': 'reviewer_meter', 'title': 'Jarvis Pool Reviewer Meter', 'objective': 'Generate an automated meter for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'meter'}

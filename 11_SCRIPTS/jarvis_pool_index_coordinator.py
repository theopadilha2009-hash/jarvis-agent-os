...
FEATURE = {'slug': 'index_coordinator', 'title': 'Jarvis Pool Index Coordinator', 'objective': 'Generate an automated coordinator for the index area using local repo signals.', 'domain': 'index', 'action': 'coordinator'}

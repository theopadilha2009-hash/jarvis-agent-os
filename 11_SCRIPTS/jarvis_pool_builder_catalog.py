...
FEATURE = {'slug': 'builder_catalog', 'title': 'Jarvis Pool Builder Catalog', 'objective': 'Generate an automated catalog for the builder area using local repo signals.', 'domain': 'builder', 'action': 'catalog'}

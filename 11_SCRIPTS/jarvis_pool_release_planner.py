...
FEATURE = {'slug': 'release_planner', 'title': 'Jarvis Pool Release Planner', 'objective': 'Generate an automated planner for the release area using local repo signals.', 'domain': 'release', 'action': 'planner'}

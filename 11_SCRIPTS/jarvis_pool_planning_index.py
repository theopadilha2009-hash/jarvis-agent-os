...
FEATURE = {'slug': 'planning_index', 'title': 'Jarvis Pool Planning Index', 'objective': 'Generate an automated index for the planning area using local repo signals.', 'domain': 'planning', 'action': 'index'}

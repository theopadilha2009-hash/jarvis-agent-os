...
FEATURE = {'slug': 'autonomy_report', 'title': 'Jarvis Pool Autonomy Report', 'objective': 'Generate an automated report for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'report'}

...
FEATURE = {'slug': 'doctor_score', 'title': 'Jarvis Pool Doctor Score', 'objective': 'Generate an automated score for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'score'}

...
FEATURE = {'slug': 'summary_report', 'title': 'Jarvis Pool Summary Report', 'objective': 'Generate an automated report for the summary area using local repo signals.', 'domain': 'summary', 'action': 'report'}

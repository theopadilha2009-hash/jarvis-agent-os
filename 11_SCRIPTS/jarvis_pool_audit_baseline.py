...
FEATURE = {'slug': 'audit_baseline', 'title': 'Jarvis Pool Audit Baseline', 'objective': 'Generate an automated baseline for the audit area using local repo signals.', 'domain': 'audit', 'action': 'baseline'}

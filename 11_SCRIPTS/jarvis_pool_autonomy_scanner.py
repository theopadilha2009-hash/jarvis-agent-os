...
FEATURE = {'slug': 'autonomy_scanner', 'title': 'Jarvis Pool Autonomy Scanner', 'objective': 'Generate an automated scanner for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'scanner'}

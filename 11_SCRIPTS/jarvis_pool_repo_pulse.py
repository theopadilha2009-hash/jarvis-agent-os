...
FEATURE = {'slug': 'repo_pulse', 'title': 'Jarvis Pool Repo Pulse', 'objective': 'Generate an automated pulse for the repo area using local repo signals.', 'domain': 'repo', 'action': 'pulse'}

...
FEATURE = {'slug': 'backup_map', 'title': 'Jarvis Pool Backup Map', 'objective': 'Generate an automated map for the backup area using local repo signals.', 'domain': 'backup', 'action': 'map'}

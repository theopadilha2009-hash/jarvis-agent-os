...
FEATURE = {'slug': 'execution_matrix', 'title': 'Jarvis Pool Execution Matrix', 'objective': 'Generate an automated matrix for the execution area using local repo signals.', 'domain': 'execution', 'action': 'matrix'}

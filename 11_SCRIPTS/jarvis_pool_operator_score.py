...
FEATURE = {'slug': 'operator_score', 'title': 'Jarvis Pool Operator Score', 'objective': 'Generate an automated score for the operator area using local repo signals.', 'domain': 'operator', 'action': 'score'}

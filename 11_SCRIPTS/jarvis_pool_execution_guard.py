...
FEATURE = {'slug': 'execution_guard', 'title': 'Jarvis Pool Execution Guard', 'objective': 'Generate an automated guard for the execution area using local repo signals.', 'domain': 'execution', 'action': 'guard'}

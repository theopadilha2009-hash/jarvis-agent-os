...
FEATURE = {'slug': 'runbook_timeline', 'title': 'Jarvis Pool Runbook Timeline', 'objective': 'Generate an automated timeline for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'timeline'}

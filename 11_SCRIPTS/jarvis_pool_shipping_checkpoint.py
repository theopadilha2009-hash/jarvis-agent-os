...
FEATURE = {'slug': 'shipping_checkpoint', 'title': 'Jarvis Pool Shipping Checkpoint', 'objective': 'Generate an automated checkpoint for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'checkpoint'}

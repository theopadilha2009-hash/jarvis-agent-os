...
FEATURE = {'slug': 'builder_map', 'title': 'Jarvis Pool Builder Map', 'objective': 'Generate an automated map for the builder area using local repo signals.', 'domain': 'builder', 'action': 'map'}

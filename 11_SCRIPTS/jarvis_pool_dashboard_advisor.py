...
FEATURE = {'slug': 'dashboard_advisor', 'title': 'Jarvis Pool Dashboard Advisor', 'objective': 'Generate an automated advisor for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'advisor'}

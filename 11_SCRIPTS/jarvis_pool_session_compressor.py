...
FEATURE = {'slug': 'session_compressor', 'title': 'Jarvis Pool Session Compressor', 'objective': 'Generate an automated compressor for the session area using local repo signals.', 'domain': 'session', 'action': 'compressor'}

...
FEATURE = {'slug': 'marathon_explainer', 'title': 'Jarvis Pool Marathon Explainer', 'objective': 'Generate an automated explainer for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'explainer'}

...
FEATURE = {'slug': 'git_compressor', 'title': 'Jarvis Pool Git Compressor', 'objective': 'Generate an automated compressor for the git area using local repo signals.', 'domain': 'git', 'action': 'compressor'}

...
FEATURE = {'slug': 'dashboard_validator', 'title': 'Jarvis Pool Dashboard Validator', 'objective': 'Generate an automated validator for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'validator'}

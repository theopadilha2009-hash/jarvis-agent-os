...
FEATURE = {'slug': 'validation_catalog', 'title': 'Jarvis Pool Validation Catalog', 'objective': 'Generate an automated catalog for the validation area using local repo signals.', 'domain': 'validation', 'action': 'catalog'}

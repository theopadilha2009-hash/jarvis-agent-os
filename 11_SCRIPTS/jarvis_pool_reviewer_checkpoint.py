...
FEATURE = {'slug': 'reviewer_checkpoint', 'title': 'Jarvis Pool Reviewer Checkpoint', 'objective': 'Generate an automated checkpoint for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'checkpoint'}

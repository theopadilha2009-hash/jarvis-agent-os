...
FEATURE = {'slug': 'memory_coordinator', 'title': 'Jarvis Pool Memory Coordinator', 'objective': 'Generate an automated coordinator for the memory area using local repo signals.', 'domain': 'memory', 'action': 'coordinator'}

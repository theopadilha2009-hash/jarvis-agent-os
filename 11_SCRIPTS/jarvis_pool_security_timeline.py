...
FEATURE = {'slug': 'security_timeline', 'title': 'Jarvis Pool Security Timeline', 'objective': 'Generate an automated timeline for the security area using local repo signals.', 'domain': 'security', 'action': 'timeline'}

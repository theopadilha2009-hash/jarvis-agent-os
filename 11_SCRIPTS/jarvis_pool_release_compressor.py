...
FEATURE = {'slug': 'release_compressor', 'title': 'Jarvis Pool Release Compressor', 'objective': 'Generate an automated compressor for the release area using local repo signals.', 'domain': 'release', 'action': 'compressor'}

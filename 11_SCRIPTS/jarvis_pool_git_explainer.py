...
FEATURE = {'slug': 'git_explainer', 'title': 'Jarvis Pool Git Explainer', 'objective': 'Generate an automated explainer for the git area using local repo signals.', 'domain': 'git', 'action': 'explainer'}

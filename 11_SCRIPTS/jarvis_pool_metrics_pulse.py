...
FEATURE = {'slug': 'metrics_pulse', 'title': 'Jarvis Pool Metrics Pulse', 'objective': 'Generate an automated pulse for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'pulse'}

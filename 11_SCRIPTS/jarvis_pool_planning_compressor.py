...
FEATURE = {'slug': 'planning_compressor', 'title': 'Jarvis Pool Planning Compressor', 'objective': 'Generate an automated compressor for the planning area using local repo signals.', 'domain': 'planning', 'action': 'compressor'}

...
FEATURE = {'slug': 'performance_watch', 'title': 'Jarvis Pool Performance Watch', 'objective': 'Generate an automated watch for the performance area using local repo signals.', 'domain': 'performance', 'action': 'watch'}

...
FEATURE = {'slug': 'repo_map', 'title': 'Jarvis Pool Repo Map', 'objective': 'Generate an automated map for the repo area using local repo signals.', 'domain': 'repo', 'action': 'map'}

...
FEATURE = {'slug': 'integration_brief', 'title': 'Jarvis Pool Integration Brief', 'objective': 'Generate an automated brief for the integration area using local repo signals.', 'domain': 'integration', 'action': 'brief'}

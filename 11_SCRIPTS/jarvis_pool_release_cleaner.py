...
FEATURE = {'slug': 'release_cleaner', 'title': 'Jarvis Pool Release Cleaner', 'objective': 'Generate an automated cleaner for the release area using local repo signals.', 'domain': 'release', 'action': 'cleaner'}

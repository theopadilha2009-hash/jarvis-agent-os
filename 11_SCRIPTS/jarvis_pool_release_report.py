...
FEATURE = {'slug': 'release_report', 'title': 'Jarvis Pool Release Report', 'objective': 'Generate an automated report for the release area using local repo signals.', 'domain': 'release', 'action': 'report'}

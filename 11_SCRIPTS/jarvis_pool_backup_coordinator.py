...
FEATURE = {'slug': 'backup_coordinator', 'title': 'Jarvis Pool Backup Coordinator', 'objective': 'Generate an automated coordinator for the backup area using local repo signals.', 'domain': 'backup', 'action': 'coordinator'}

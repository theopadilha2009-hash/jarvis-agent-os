...
FEATURE = {'slug': 'autonomy_score', 'title': 'Jarvis Pool Autonomy Score', 'objective': 'Generate an automated score for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'score'}

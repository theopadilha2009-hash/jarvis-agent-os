...
FEATURE = {'slug': 'integration_validator', 'title': 'Jarvis Pool Integration Validator', 'objective': 'Generate an automated validator for the integration area using local repo signals.', 'domain': 'integration', 'action': 'validator'}

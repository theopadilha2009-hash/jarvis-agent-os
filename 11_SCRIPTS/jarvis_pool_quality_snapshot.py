...
FEATURE = {'slug': 'quality_snapshot', 'title': 'Jarvis Pool Quality Snapshot', 'objective': 'Generate an automated snapshot for the quality area using local repo signals.', 'domain': 'quality', 'action': 'snapshot'}

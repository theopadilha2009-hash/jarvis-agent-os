...
FEATURE = {'slug': 'index_map', 'title': 'Jarvis Pool Index Map', 'objective': 'Generate an automated map for the index area using local repo signals.', 'domain': 'index', 'action': 'map'}

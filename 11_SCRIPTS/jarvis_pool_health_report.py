...
FEATURE = {'slug': 'health_report', 'title': 'Jarvis Pool Health Report', 'objective': 'Generate an automated report for the health area using local repo signals.', 'domain': 'health', 'action': 'report'}

...
FEATURE = {'slug': 'release_snapshot', 'title': 'Jarvis Pool Release Snapshot', 'objective': 'Generate an automated snapshot for the release area using local repo signals.', 'domain': 'release', 'action': 'snapshot'}

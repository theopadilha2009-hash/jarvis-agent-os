...
FEATURE = {'slug': 'release_advisor', 'title': 'Jarvis Pool Release Advisor', 'objective': 'Generate an automated advisor for the release area using local repo signals.', 'domain': 'release', 'action': 'advisor'}

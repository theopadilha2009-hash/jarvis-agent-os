...
FEATURE = {'slug': 'summary_cleaner', 'title': 'Jarvis Pool Summary Cleaner', 'objective': 'Generate an automated cleaner for the summary area using local repo signals.', 'domain': 'summary', 'action': 'cleaner'}

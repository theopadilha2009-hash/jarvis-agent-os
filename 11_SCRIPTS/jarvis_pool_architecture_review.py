...
FEATURE = {'slug': 'architecture_review', 'title': 'Jarvis Pool Architecture Review', 'objective': 'Generate an automated review for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'review'}

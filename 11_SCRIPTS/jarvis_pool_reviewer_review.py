...
FEATURE = {'slug': 'reviewer_review', 'title': 'Jarvis Pool Reviewer Review', 'objective': 'Generate an automated review for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'review'}

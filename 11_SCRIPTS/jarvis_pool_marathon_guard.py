...
FEATURE = {'slug': 'marathon_guard', 'title': 'Jarvis Pool Marathon Guard', 'objective': 'Generate an automated guard for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'guard'}

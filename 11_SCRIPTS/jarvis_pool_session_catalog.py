...
FEATURE = {'slug': 'session_catalog', 'title': 'Jarvis Pool Session Catalog', 'objective': 'Generate an automated catalog for the session area using local repo signals.', 'domain': 'session', 'action': 'catalog'}

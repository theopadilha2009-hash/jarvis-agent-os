...
FEATURE = {'slug': 'memory_cleaner', 'title': 'Jarvis Pool Memory Cleaner', 'objective': 'Generate an automated cleaner for the memory area using local repo signals.', 'domain': 'memory', 'action': 'cleaner'}

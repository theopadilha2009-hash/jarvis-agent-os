...
FEATURE = {'slug': 'dashboard_coordinator', 'title': 'Jarvis Pool Dashboard Coordinator', 'objective': 'Generate an automated coordinator for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'coordinator'}

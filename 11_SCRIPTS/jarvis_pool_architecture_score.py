...
FEATURE = {'slug': 'architecture_score', 'title': 'Jarvis Pool Architecture Score', 'objective': 'Generate an automated score for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'score'}

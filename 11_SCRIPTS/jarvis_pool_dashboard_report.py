...
FEATURE = {'slug': 'dashboard_report', 'title': 'Jarvis Pool Dashboard Report', 'objective': 'Generate an automated report for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'report'}

...
FEATURE = {'slug': 'dashboard_brief', 'title': 'Jarvis Pool Dashboard Brief', 'objective': 'Generate an automated brief for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'brief'}

...
FEATURE = {'slug': 'integration_optimizer', 'title': 'Jarvis Pool Integration Optimizer', 'objective': 'Generate an automated optimizer for the integration area using local repo signals.', 'domain': 'integration', 'action': 'optimizer'}

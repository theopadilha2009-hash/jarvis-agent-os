...
FEATURE = {'slug': 'release_scanner', 'title': 'Jarvis Pool Release Scanner', 'objective': 'Generate an automated scanner for the release area using local repo signals.', 'domain': 'release', 'action': 'scanner'}

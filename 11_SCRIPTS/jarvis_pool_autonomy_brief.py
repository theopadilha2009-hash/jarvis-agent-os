...
FEATURE = {'slug': 'autonomy_brief', 'title': 'Jarvis Pool Autonomy Brief', 'objective': 'Generate an automated brief for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'brief'}

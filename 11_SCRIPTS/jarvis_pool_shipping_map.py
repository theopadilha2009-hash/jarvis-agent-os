...
FEATURE = {'slug': 'shipping_map', 'title': 'Jarvis Pool Shipping Map', 'objective': 'Generate an automated map for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'map'}

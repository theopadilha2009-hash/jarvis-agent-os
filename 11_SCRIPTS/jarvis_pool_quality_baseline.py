...
FEATURE = {'slug': 'quality_baseline', 'title': 'Jarvis Pool Quality Baseline', 'objective': 'Generate an automated baseline for the quality area using local repo signals.', 'domain': 'quality', 'action': 'baseline'}

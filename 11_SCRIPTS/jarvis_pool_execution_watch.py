...
FEATURE = {'slug': 'execution_watch', 'title': 'Jarvis Pool Execution Watch', 'objective': 'Generate an automated watch for the execution area using local repo signals.', 'domain': 'execution', 'action': 'watch'}

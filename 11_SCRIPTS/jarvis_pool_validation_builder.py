...
FEATURE = {'slug': 'validation_builder', 'title': 'Jarvis Pool Validation Builder', 'objective': 'Generate an automated builder for the validation area using local repo signals.', 'domain': 'validation', 'action': 'builder'}

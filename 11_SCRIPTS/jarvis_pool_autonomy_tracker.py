...
FEATURE = {'slug': 'autonomy_tracker', 'title': 'Jarvis Pool Autonomy Tracker', 'objective': 'Generate an automated tracker for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'tracker'}

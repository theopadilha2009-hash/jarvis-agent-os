...
FEATURE = {'slug': 'security_index', 'title': 'Jarvis Pool Security Index', 'objective': 'Generate an automated index for the security area using local repo signals.', 'domain': 'security', 'action': 'index'}

...
FEATURE = {'slug': 'reviewer_coordinator', 'title': 'Jarvis Pool Reviewer Coordinator', 'objective': 'Generate an automated coordinator for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'coordinator'}

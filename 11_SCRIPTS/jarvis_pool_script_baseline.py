...
FEATURE = {'slug': 'script_baseline', 'title': 'Jarvis Pool Script Baseline', 'objective': 'Generate an automated baseline for the script area using local repo signals.', 'domain': 'script', 'action': 'baseline'}

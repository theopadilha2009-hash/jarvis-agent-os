...
FEATURE = {'slug': 'builder_cleaner', 'title': 'Jarvis Pool Builder Cleaner', 'objective': 'Generate an automated cleaner for the builder area using local repo signals.', 'domain': 'builder', 'action': 'cleaner'}

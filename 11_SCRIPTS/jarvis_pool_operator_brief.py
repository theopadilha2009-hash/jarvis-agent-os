...
FEATURE = {'slug': 'operator_brief', 'title': 'Jarvis Pool Operator Brief', 'objective': 'Generate an automated brief for the operator area using local repo signals.', 'domain': 'operator', 'action': 'brief'}

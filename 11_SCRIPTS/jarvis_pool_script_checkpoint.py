...
FEATURE = {'slug': 'script_checkpoint', 'title': 'Jarvis Pool Script Checkpoint', 'objective': 'Generate an automated checkpoint for the script area using local repo signals.', 'domain': 'script', 'action': 'checkpoint'}

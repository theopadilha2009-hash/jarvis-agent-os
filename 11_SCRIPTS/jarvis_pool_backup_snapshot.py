...
FEATURE = {'slug': 'backup_snapshot', 'title': 'Jarvis Pool Backup Snapshot', 'objective': 'Generate an automated snapshot for the backup area using local repo signals.', 'domain': 'backup', 'action': 'snapshot'}

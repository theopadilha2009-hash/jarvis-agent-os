...
FEATURE = {'slug': 'doctor_index', 'title': 'Jarvis Pool Doctor Index', 'objective': 'Generate an automated index for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'index'}

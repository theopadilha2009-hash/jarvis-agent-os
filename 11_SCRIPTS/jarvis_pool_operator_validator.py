...
FEATURE = {'slug': 'operator_validator', 'title': 'Jarvis Pool Operator Validator', 'objective': 'Generate an automated validator for the operator area using local repo signals.', 'domain': 'operator', 'action': 'validator'}

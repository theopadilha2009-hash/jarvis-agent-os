...
FEATURE = {'slug': 'release_digest', 'title': 'Jarvis Pool Release Digest', 'objective': 'Generate an automated digest for the release area using local repo signals.', 'domain': 'release', 'action': 'digest'}

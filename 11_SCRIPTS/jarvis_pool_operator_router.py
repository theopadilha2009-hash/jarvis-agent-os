...
FEATURE = {'slug': 'operator_router', 'title': 'Jarvis Pool Operator Router', 'objective': 'Generate an automated router for the operator area using local repo signals.', 'domain': 'operator', 'action': 'router'}

...
FEATURE = {'slug': 'release_pulse', 'title': 'Jarvis Pool Release Pulse', 'objective': 'Generate an automated pulse for the release area using local repo signals.', 'domain': 'release', 'action': 'pulse'}

...
FEATURE = {'slug': 'reviewer_brief', 'title': 'Jarvis Pool Reviewer Brief', 'objective': 'Generate an automated brief for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'brief'}

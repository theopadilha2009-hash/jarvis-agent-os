...
FEATURE = {'slug': 'builder_matrix', 'title': 'Jarvis Pool Builder Matrix', 'objective': 'Generate an automated matrix for the builder area using local repo signals.', 'domain': 'builder', 'action': 'matrix'}

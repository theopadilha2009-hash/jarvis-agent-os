...
FEATURE = {'slug': 'reviewer_advisor', 'title': 'Jarvis Pool Reviewer Advisor', 'objective': 'Generate an automated advisor for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'advisor'}

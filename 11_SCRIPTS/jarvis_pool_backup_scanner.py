...
FEATURE = {'slug': 'backup_scanner', 'title': 'Jarvis Pool Backup Scanner', 'objective': 'Generate an automated scanner for the backup area using local repo signals.', 'domain': 'backup', 'action': 'scanner'}

...
FEATURE = {'slug': 'operator_planner', 'title': 'Jarvis Pool Operator Planner', 'objective': 'Generate an automated planner for the operator area using local repo signals.', 'domain': 'operator', 'action': 'planner'}

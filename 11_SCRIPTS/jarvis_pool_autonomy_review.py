...
FEATURE = {'slug': 'autonomy_review', 'title': 'Jarvis Pool Autonomy Review', 'objective': 'Generate an automated review for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'review'}

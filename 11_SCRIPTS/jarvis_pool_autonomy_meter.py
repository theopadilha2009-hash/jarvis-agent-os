...
FEATURE = {'slug': 'autonomy_meter', 'title': 'Jarvis Pool Autonomy Meter', 'objective': 'Generate an automated meter for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'meter'}

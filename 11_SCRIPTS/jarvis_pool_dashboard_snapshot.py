...
FEATURE = {'slug': 'dashboard_snapshot', 'title': 'Jarvis Pool Dashboard Snapshot', 'objective': 'Generate an automated snapshot for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'snapshot'}

...
FEATURE = {'slug': 'memory_pulse', 'title': 'Jarvis Pool Memory Pulse', 'objective': 'Generate an automated pulse for the memory area using local repo signals.', 'domain': 'memory', 'action': 'pulse'}

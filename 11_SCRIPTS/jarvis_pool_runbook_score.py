...
FEATURE = {'slug': 'runbook_score', 'title': 'Jarvis Pool Runbook Score', 'objective': 'Generate an automated score for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'score'}

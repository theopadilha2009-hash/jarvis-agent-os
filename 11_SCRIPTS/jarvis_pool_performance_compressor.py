...
FEATURE = {'slug': 'performance_compressor', 'title': 'Jarvis Pool Performance Compressor', 'objective': 'Generate an automated compressor for the performance area using local repo signals.', 'domain': 'performance', 'action': 'compressor'}

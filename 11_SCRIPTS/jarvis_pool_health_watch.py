...
FEATURE = {'slug': 'health_watch', 'title': 'Jarvis Pool Health Watch', 'objective': 'Generate an automated watch for the health area using local repo signals.', 'domain': 'health', 'action': 'watch'}

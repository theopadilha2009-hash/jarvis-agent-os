...
FEATURE = {'slug': 'release_timeline', 'title': 'Jarvis Pool Release Timeline', 'objective': 'Generate an automated timeline for the release area using local repo signals.', 'domain': 'release', 'action': 'timeline'}

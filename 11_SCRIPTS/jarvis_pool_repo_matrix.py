...
FEATURE = {'slug': 'repo_matrix', 'title': 'Jarvis Pool Repo Matrix', 'objective': 'Generate an automated matrix for the repo area using local repo signals.', 'domain': 'repo', 'action': 'matrix'}

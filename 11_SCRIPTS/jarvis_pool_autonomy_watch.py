...
FEATURE = {'slug': 'autonomy_watch', 'title': 'Jarvis Pool Autonomy Watch', 'objective': 'Generate an automated watch for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'watch'}

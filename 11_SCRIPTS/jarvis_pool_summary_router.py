...
FEATURE = {'slug': 'summary_router', 'title': 'Jarvis Pool Summary Router', 'objective': 'Generate an automated router for the summary area using local repo signals.', 'domain': 'summary', 'action': 'router'}

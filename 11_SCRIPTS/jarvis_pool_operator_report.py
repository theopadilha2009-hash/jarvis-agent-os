...
FEATURE = {'slug': 'operator_report', 'title': 'Jarvis Pool Operator Report', 'objective': 'Generate an automated report for the operator area using local repo signals.', 'domain': 'operator', 'action': 'report'}

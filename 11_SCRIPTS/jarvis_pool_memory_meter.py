...
FEATURE = {'slug': 'memory_meter', 'title': 'Jarvis Pool Memory Meter', 'objective': 'Generate an automated meter for the memory area using local repo signals.', 'domain': 'memory', 'action': 'meter'}

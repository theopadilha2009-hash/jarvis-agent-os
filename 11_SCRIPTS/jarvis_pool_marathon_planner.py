...
FEATURE = {'slug': 'marathon_planner', 'title': 'Jarvis Pool Marathon Planner', 'objective': 'Generate an automated planner for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'planner'}

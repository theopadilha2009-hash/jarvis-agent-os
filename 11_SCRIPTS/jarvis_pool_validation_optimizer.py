...
FEATURE = {'slug': 'validation_optimizer', 'title': 'Jarvis Pool Validation Optimizer', 'objective': 'Generate an automated optimizer for the validation area using local repo signals.', 'domain': 'validation', 'action': 'optimizer'}

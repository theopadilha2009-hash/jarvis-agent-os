...
FEATURE = {'slug': 'integration_pulse', 'title': 'Jarvis Pool Integration Pulse', 'objective': 'Generate an automated pulse for the integration area using local repo signals.', 'domain': 'integration', 'action': 'pulse'}

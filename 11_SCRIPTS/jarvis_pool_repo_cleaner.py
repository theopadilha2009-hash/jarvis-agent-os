...
FEATURE = {'slug': 'repo_cleaner', 'title': 'Jarvis Pool Repo Cleaner', 'objective': 'Generate an automated cleaner for the repo area using local repo signals.', 'domain': 'repo', 'action': 'cleaner'}

...
FEATURE = {'slug': 'performance_index', 'title': 'Jarvis Pool Performance Index', 'objective': 'Generate an automated index for the performance area using local repo signals.', 'domain': 'performance', 'action': 'index'}

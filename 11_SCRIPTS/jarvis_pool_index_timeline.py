...
FEATURE = {'slug': 'index_timeline', 'title': 'Jarvis Pool Index Timeline', 'objective': 'Generate an automated timeline for the index area using local repo signals.', 'domain': 'index', 'action': 'timeline'}

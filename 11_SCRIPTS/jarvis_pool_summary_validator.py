...
FEATURE = {'slug': 'summary_validator', 'title': 'Jarvis Pool Summary Validator', 'objective': 'Generate an automated validator for the summary area using local repo signals.', 'domain': 'summary', 'action': 'validator'}

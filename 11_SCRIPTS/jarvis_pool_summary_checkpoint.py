...
FEATURE = {'slug': 'summary_checkpoint', 'title': 'Jarvis Pool Summary Checkpoint', 'objective': 'Generate an automated checkpoint for the summary area using local repo signals.', 'domain': 'summary', 'action': 'checkpoint'}

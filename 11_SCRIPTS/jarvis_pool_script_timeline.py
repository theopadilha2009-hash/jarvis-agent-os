...
FEATURE = {'slug': 'script_timeline', 'title': 'Jarvis Pool Script Timeline', 'objective': 'Generate an automated timeline for the script area using local repo signals.', 'domain': 'script', 'action': 'timeline'}

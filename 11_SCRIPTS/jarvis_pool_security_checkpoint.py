...
FEATURE = {'slug': 'security_checkpoint', 'title': 'Jarvis Pool Security Checkpoint', 'objective': 'Generate an automated checkpoint for the security area using local repo signals.', 'domain': 'security', 'action': 'checkpoint'}

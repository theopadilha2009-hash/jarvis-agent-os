...
FEATURE = {'slug': 'metrics_router', 'title': 'Jarvis Pool Metrics Router', 'objective': 'Generate an automated router for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'router'}

...
FEATURE = {'slug': 'runbook_catalog', 'title': 'Jarvis Pool Runbook Catalog', 'objective': 'Generate an automated catalog for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'catalog'}

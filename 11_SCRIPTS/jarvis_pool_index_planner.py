...
FEATURE = {'slug': 'index_planner', 'title': 'Jarvis Pool Index Planner', 'objective': 'Generate an automated planner for the index area using local repo signals.', 'domain': 'index', 'action': 'planner'}

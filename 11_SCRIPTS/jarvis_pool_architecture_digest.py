...
FEATURE = {'slug': 'architecture_digest', 'title': 'Jarvis Pool Architecture Digest', 'objective': 'Generate an automated digest for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'digest'}

...
FEATURE = {'slug': 'health_optimizer', 'title': 'Jarvis Pool Health Optimizer', 'objective': 'Generate an automated optimizer for the health area using local repo signals.', 'domain': 'health', 'action': 'optimizer'}

...
FEATURE = {'slug': 'metrics_scanner', 'title': 'Jarvis Pool Metrics Scanner', 'objective': 'Generate an automated scanner for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'scanner'}

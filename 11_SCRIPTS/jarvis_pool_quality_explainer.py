...
FEATURE = {'slug': 'quality_explainer', 'title': 'Jarvis Pool Quality Explainer', 'objective': 'Generate an automated explainer for the quality area using local repo signals.', 'domain': 'quality', 'action': 'explainer'}

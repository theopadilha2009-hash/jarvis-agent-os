...
FEATURE = {'slug': 'shipping_snapshot', 'title': 'Jarvis Pool Shipping Snapshot', 'objective': 'Generate an automated snapshot for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'snapshot'}

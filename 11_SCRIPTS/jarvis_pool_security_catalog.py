...
FEATURE = {'slug': 'security_catalog', 'title': 'Jarvis Pool Security Catalog', 'objective': 'Generate an automated catalog for the security area using local repo signals.', 'domain': 'security', 'action': 'catalog'}

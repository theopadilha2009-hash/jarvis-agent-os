...
FEATURE = {'slug': 'script_map', 'title': 'Jarvis Pool Script Map', 'objective': 'Generate an automated map for the script area using local repo signals.', 'domain': 'script', 'action': 'map'}

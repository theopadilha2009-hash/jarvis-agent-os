...
FEATURE = {'slug': 'metrics_check', 'title': 'Jarvis Pool Metrics Check', 'objective': 'Generate an automated check for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'check'}

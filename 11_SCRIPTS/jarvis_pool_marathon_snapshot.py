...
FEATURE = {'slug': 'marathon_snapshot', 'title': 'Jarvis Pool Marathon Snapshot', 'objective': 'Generate an automated snapshot for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'snapshot'}

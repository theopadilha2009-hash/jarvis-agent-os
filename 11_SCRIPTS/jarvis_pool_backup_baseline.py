...
FEATURE = {'slug': 'backup_baseline', 'title': 'Jarvis Pool Backup Baseline', 'objective': 'Generate an automated baseline for the backup area using local repo signals.', 'domain': 'backup', 'action': 'baseline'}

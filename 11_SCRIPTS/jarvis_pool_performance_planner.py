...
FEATURE = {'slug': 'performance_planner', 'title': 'Jarvis Pool Performance Planner', 'objective': 'Generate an automated planner for the performance area using local repo signals.', 'domain': 'performance', 'action': 'planner'}

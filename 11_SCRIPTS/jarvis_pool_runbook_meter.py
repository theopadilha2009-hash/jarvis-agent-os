...
FEATURE = {'slug': 'runbook_meter', 'title': 'Jarvis Pool Runbook Meter', 'objective': 'Generate an automated meter for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'meter'}

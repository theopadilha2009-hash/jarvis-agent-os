...
FEATURE = {'slug': 'validation_check', 'title': 'Jarvis Pool Validation Check', 'objective': 'Generate an automated check for the validation area using local repo signals.', 'domain': 'validation', 'action': 'check'}

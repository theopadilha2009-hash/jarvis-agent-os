...
FEATURE = {'slug': 'memory_tracker', 'title': 'Jarvis Pool Memory Tracker', 'objective': 'Generate an automated tracker for the memory area using local repo signals.', 'domain': 'memory', 'action': 'tracker'}

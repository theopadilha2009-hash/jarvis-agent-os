...
FEATURE = {'slug': 'architecture_router', 'title': 'Jarvis Pool Architecture Router', 'objective': 'Generate an automated router for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'router'}

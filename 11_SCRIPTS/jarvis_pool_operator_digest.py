...
FEATURE = {'slug': 'operator_digest', 'title': 'Jarvis Pool Operator Digest', 'objective': 'Generate an automated digest for the operator area using local repo signals.', 'domain': 'operator', 'action': 'digest'}

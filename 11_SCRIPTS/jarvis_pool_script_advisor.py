...
FEATURE = {'slug': 'script_advisor', 'title': 'Jarvis Pool Script Advisor', 'objective': 'Generate an automated advisor for the script area using local repo signals.', 'domain': 'script', 'action': 'advisor'}

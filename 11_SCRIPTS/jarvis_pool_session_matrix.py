...
FEATURE = {'slug': 'session_matrix', 'title': 'Jarvis Pool Session Matrix', 'objective': 'Generate an automated matrix for the session area using local repo signals.', 'domain': 'session', 'action': 'matrix'}

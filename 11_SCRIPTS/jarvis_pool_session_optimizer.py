...
FEATURE = {'slug': 'session_optimizer', 'title': 'Jarvis Pool Session Optimizer', 'objective': 'Generate an automated optimizer for the session area using local repo signals.', 'domain': 'session', 'action': 'optimizer'}

...
FEATURE = {'slug': 'metrics_cleaner', 'title': 'Jarvis Pool Metrics Cleaner', 'objective': 'Generate an automated cleaner for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'cleaner'}

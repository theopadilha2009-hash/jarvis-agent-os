...
FEATURE = {'slug': 'repo_snapshot', 'title': 'Jarvis Pool Repo Snapshot', 'objective': 'Generate an automated snapshot for the repo area using local repo signals.', 'domain': 'repo', 'action': 'snapshot'}

...
FEATURE = {'slug': 'autonomy_checkpoint', 'title': 'Jarvis Pool Autonomy Checkpoint', 'objective': 'Generate an automated checkpoint for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'checkpoint'}

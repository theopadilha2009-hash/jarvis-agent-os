...
FEATURE = {'slug': 'runbook_builder', 'title': 'Jarvis Pool Runbook Builder', 'objective': 'Generate an automated builder for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'builder'}

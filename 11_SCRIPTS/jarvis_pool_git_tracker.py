...
FEATURE = {'slug': 'git_tracker', 'title': 'Jarvis Pool Git Tracker', 'objective': 'Generate an automated tracker for the git area using local repo signals.', 'domain': 'git', 'action': 'tracker'}

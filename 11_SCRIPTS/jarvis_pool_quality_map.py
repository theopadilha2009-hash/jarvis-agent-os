...
FEATURE = {'slug': 'quality_map', 'title': 'Jarvis Pool Quality Map', 'objective': 'Generate an automated map for the quality area using local repo signals.', 'domain': 'quality', 'action': 'map'}

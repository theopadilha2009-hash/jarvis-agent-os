...
FEATURE = {'slug': 'git_checkpoint', 'title': 'Jarvis Pool Git Checkpoint', 'objective': 'Generate an automated checkpoint for the git area using local repo signals.', 'domain': 'git', 'action': 'checkpoint'}

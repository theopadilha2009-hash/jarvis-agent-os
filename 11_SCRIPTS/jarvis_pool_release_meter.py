...
FEATURE = {'slug': 'release_meter', 'title': 'Jarvis Pool Release Meter', 'objective': 'Generate an automated meter for the release area using local repo signals.', 'domain': 'release', 'action': 'meter'}

...
FEATURE = {'slug': 'quality_check', 'title': 'Jarvis Pool Quality Check', 'objective': 'Generate an automated check for the quality area using local repo signals.', 'domain': 'quality', 'action': 'check'}

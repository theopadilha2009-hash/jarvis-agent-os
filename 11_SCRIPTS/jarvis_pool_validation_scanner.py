...
FEATURE = {'slug': 'validation_scanner', 'title': 'Jarvis Pool Validation Scanner', 'objective': 'Generate an automated scanner for the validation area using local repo signals.', 'domain': 'validation', 'action': 'scanner'}

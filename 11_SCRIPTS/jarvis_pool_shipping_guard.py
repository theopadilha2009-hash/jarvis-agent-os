...
FEATURE = {'slug': 'shipping_guard', 'title': 'Jarvis Pool Shipping Guard', 'objective': 'Generate an automated guard for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'guard'}

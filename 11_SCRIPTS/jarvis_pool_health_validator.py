...
FEATURE = {'slug': 'health_validator', 'title': 'Jarvis Pool Health Validator', 'objective': 'Generate an automated validator for the health area using local repo signals.', 'domain': 'health', 'action': 'validator'}

...
FEATURE = {'slug': 'planning_optimizer', 'title': 'Jarvis Pool Planning Optimizer', 'objective': 'Generate an automated optimizer for the planning area using local repo signals.', 'domain': 'planning', 'action': 'optimizer'}

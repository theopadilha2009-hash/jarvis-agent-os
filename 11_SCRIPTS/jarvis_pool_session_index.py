...
FEATURE = {'slug': 'session_index', 'title': 'Jarvis Pool Session Index', 'objective': 'Generate an automated index for the session area using local repo signals.', 'domain': 'session', 'action': 'index'}

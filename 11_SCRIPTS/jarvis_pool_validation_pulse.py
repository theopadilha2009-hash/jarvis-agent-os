...
FEATURE = {'slug': 'validation_pulse', 'title': 'Jarvis Pool Validation Pulse', 'objective': 'Generate an automated pulse for the validation area using local repo signals.', 'domain': 'validation', 'action': 'pulse'}

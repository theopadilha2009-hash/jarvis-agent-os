...
FEATURE = {'slug': 'quality_meter', 'title': 'Jarvis Pool Quality Meter', 'objective': 'Generate an automated meter for the quality area using local repo signals.', 'domain': 'quality', 'action': 'meter'}

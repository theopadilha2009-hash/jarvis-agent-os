...
FEATURE = {'slug': 'metrics_tracker', 'title': 'Jarvis Pool Metrics Tracker', 'objective': 'Generate an automated tracker for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'tracker'}

...
FEATURE = {'slug': 'repo_checkpoint', 'title': 'Jarvis Pool Repo Checkpoint', 'objective': 'Generate an automated checkpoint for the repo area using local repo signals.', 'domain': 'repo', 'action': 'checkpoint'}

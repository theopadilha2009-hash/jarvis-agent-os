...
FEATURE = {'slug': 'shipping_check', 'title': 'Jarvis Pool Shipping Check', 'objective': 'Generate an automated check for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'check'}

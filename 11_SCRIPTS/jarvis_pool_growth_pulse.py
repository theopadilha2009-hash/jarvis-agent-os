...
FEATURE = {'slug': 'growth_pulse', 'title': 'Jarvis Pool Growth Pulse', 'objective': 'Generate an automated pulse for the growth area using local repo signals.', 'domain': 'growth', 'action': 'pulse'}

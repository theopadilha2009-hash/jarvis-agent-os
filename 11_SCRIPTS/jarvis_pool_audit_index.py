...
FEATURE = {'slug': 'audit_index', 'title': 'Jarvis Pool Audit Index', 'objective': 'Generate an automated index for the audit area using local repo signals.', 'domain': 'audit', 'action': 'index'}

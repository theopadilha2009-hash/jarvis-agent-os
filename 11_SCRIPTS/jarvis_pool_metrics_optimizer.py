...
FEATURE = {'slug': 'metrics_optimizer', 'title': 'Jarvis Pool Metrics Optimizer', 'objective': 'Generate an automated optimizer for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'optimizer'}

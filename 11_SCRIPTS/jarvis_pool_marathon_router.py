...
FEATURE = {'slug': 'marathon_router', 'title': 'Jarvis Pool Marathon Router', 'objective': 'Generate an automated router for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'router'}

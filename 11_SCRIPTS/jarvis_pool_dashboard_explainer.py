...
FEATURE = {'slug': 'dashboard_explainer', 'title': 'Jarvis Pool Dashboard Explainer', 'objective': 'Generate an automated explainer for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'explainer'}

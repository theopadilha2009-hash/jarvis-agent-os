...
FEATURE = {'slug': 'security_validator', 'title': 'Jarvis Pool Security Validator', 'objective': 'Generate an automated validator for the security area using local repo signals.', 'domain': 'security', 'action': 'validator'}

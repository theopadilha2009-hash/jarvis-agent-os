...
FEATURE = {'slug': 'integration_snapshot', 'title': 'Jarvis Pool Integration Snapshot', 'objective': 'Generate an automated snapshot for the integration area using local repo signals.', 'domain': 'integration', 'action': 'snapshot'}

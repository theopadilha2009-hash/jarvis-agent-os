...
FEATURE = {'slug': 'validation_snapshot', 'title': 'Jarvis Pool Validation Snapshot', 'objective': 'Generate an automated snapshot for the validation area using local repo signals.', 'domain': 'validation', 'action': 'snapshot'}

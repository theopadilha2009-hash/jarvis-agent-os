...
FEATURE = {'slug': 'health_coordinator', 'title': 'Jarvis Pool Health Coordinator', 'objective': 'Generate an automated coordinator for the health area using local repo signals.', 'domain': 'health', 'action': 'coordinator'}

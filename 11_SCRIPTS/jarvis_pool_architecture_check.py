...
FEATURE = {'slug': 'architecture_check', 'title': 'Jarvis Pool Architecture Check', 'objective': 'Generate an automated check for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'check'}

...
FEATURE = {'slug': 'growth_validator', 'title': 'Jarvis Pool Growth Validator', 'objective': 'Generate an automated validator for the growth area using local repo signals.', 'domain': 'growth', 'action': 'validator'}

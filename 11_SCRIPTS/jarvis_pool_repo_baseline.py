...
FEATURE = {'slug': 'repo_baseline', 'title': 'Jarvis Pool Repo Baseline', 'objective': 'Generate an automated baseline for the repo area using local repo signals.', 'domain': 'repo', 'action': 'baseline'}

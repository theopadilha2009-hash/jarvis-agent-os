...
FEATURE = {'slug': 'marathon_watch', 'title': 'Jarvis Pool Marathon Watch', 'objective': 'Generate an automated watch for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'watch'}

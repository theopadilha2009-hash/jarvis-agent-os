...
FEATURE = {'slug': 'runbook_matrix', 'title': 'Jarvis Pool Runbook Matrix', 'objective': 'Generate an automated matrix for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'matrix'}

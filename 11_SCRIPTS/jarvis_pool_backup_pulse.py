...
FEATURE = {'slug': 'backup_pulse', 'title': 'Jarvis Pool Backup Pulse', 'objective': 'Generate an automated pulse for the backup area using local repo signals.', 'domain': 'backup', 'action': 'pulse'}

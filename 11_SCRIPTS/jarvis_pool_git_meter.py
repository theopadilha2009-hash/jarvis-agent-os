...
FEATURE = {'slug': 'git_meter', 'title': 'Jarvis Pool Git Meter', 'objective': 'Generate an automated meter for the git area using local repo signals.', 'domain': 'git', 'action': 'meter'}

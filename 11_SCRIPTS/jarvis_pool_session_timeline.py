...
FEATURE = {'slug': 'session_timeline', 'title': 'Jarvis Pool Session Timeline', 'objective': 'Generate an automated timeline for the session area using local repo signals.', 'domain': 'session', 'action': 'timeline'}

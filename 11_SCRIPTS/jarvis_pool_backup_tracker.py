...
FEATURE = {'slug': 'backup_tracker', 'title': 'Jarvis Pool Backup Tracker', 'objective': 'Generate an automated tracker for the backup area using local repo signals.', 'domain': 'backup', 'action': 'tracker'}

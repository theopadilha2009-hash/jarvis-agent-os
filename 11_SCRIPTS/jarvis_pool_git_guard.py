...
FEATURE = {'slug': 'git_guard', 'title': 'Jarvis Pool Git Guard', 'objective': 'Generate an automated guard for the git area using local repo signals.', 'domain': 'git', 'action': 'guard'}

...
FEATURE = {'slug': 'integration_report', 'title': 'Jarvis Pool Integration Report', 'objective': 'Generate an automated report for the integration area using local repo signals.', 'domain': 'integration', 'action': 'report'}

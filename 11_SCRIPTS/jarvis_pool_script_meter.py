...
FEATURE = {'slug': 'script_meter', 'title': 'Jarvis Pool Script Meter', 'objective': 'Generate an automated meter for the script area using local repo signals.', 'domain': 'script', 'action': 'meter'}

...
FEATURE = {'slug': 'git_catalog', 'title': 'Jarvis Pool Git Catalog', 'objective': 'Generate an automated catalog for the git area using local repo signals.', 'domain': 'git', 'action': 'catalog'}

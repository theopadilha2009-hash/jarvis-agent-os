...
FEATURE = {'slug': 'dashboard_pulse', 'title': 'Jarvis Pool Dashboard Pulse', 'objective': 'Generate an automated pulse for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'pulse'}

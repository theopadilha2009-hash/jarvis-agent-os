...
FEATURE = {'slug': 'operator_advisor', 'title': 'Jarvis Pool Operator Advisor', 'objective': 'Generate an automated advisor for the operator area using local repo signals.', 'domain': 'operator', 'action': 'advisor'}

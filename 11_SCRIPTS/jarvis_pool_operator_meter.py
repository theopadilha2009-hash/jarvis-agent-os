...
FEATURE = {'slug': 'operator_meter', 'title': 'Jarvis Pool Operator Meter', 'objective': 'Generate an automated meter for the operator area using local repo signals.', 'domain': 'operator', 'action': 'meter'}

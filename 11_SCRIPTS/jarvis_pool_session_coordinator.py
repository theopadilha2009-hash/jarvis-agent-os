...
FEATURE = {'slug': 'session_coordinator', 'title': 'Jarvis Pool Session Coordinator', 'objective': 'Generate an automated coordinator for the session area using local repo signals.', 'domain': 'session', 'action': 'coordinator'}

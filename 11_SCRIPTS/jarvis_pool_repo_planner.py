...
FEATURE = {'slug': 'repo_planner', 'title': 'Jarvis Pool Repo Planner', 'objective': 'Generate an automated planner for the repo area using local repo signals.', 'domain': 'repo', 'action': 'planner'}

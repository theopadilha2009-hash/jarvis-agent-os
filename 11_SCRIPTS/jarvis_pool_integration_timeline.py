...
FEATURE = {'slug': 'integration_timeline', 'title': 'Jarvis Pool Integration Timeline', 'objective': 'Generate an automated timeline for the integration area using local repo signals.', 'domain': 'integration', 'action': 'timeline'}

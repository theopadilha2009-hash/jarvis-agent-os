...
FEATURE = {'slug': 'shipping_catalog', 'title': 'Jarvis Pool Shipping Catalog', 'objective': 'Generate an automated catalog for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'catalog'}

...
FEATURE = {'slug': 'memory_router', 'title': 'Jarvis Pool Memory Router', 'objective': 'Generate an automated router for the memory area using local repo signals.', 'domain': 'memory', 'action': 'router'}

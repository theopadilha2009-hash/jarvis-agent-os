...
FEATURE = {'slug': 'git_advisor', 'title': 'Jarvis Pool Git Advisor', 'objective': 'Generate an automated advisor for the git area using local repo signals.', 'domain': 'git', 'action': 'advisor'}

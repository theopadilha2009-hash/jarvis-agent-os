...
FEATURE = {'slug': 'script_guard', 'title': 'Jarvis Pool Script Guard', 'objective': 'Generate an automated guard for the script area using local repo signals.', 'domain': 'script', 'action': 'guard'}

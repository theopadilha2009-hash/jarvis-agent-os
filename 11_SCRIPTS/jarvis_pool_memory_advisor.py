...
FEATURE = {'slug': 'memory_advisor', 'title': 'Jarvis Pool Memory Advisor', 'objective': 'Generate an automated advisor for the memory area using local repo signals.', 'domain': 'memory', 'action': 'advisor'}

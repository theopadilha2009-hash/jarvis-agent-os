...
FEATURE = {'slug': 'architecture_guard', 'title': 'Jarvis Pool Architecture Guard', 'objective': 'Generate an automated guard for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'guard'}

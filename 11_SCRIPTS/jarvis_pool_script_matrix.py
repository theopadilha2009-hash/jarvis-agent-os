...
FEATURE = {'slug': 'script_matrix', 'title': 'Jarvis Pool Script Matrix', 'objective': 'Generate an automated matrix for the script area using local repo signals.', 'domain': 'script', 'action': 'matrix'}

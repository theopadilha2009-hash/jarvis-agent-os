...
FEATURE = {'slug': 'release_validator', 'title': 'Jarvis Pool Release Validator', 'objective': 'Generate an automated validator for the release area using local repo signals.', 'domain': 'release', 'action': 'validator'}

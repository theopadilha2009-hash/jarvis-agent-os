...
FEATURE = {'slug': 'summary_pulse', 'title': 'Jarvis Pool Summary Pulse', 'objective': 'Generate an automated pulse for the summary area using local repo signals.', 'domain': 'summary', 'action': 'pulse'}

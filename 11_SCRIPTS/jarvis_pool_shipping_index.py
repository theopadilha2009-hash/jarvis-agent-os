...
FEATURE = {'slug': 'shipping_index', 'title': 'Jarvis Pool Shipping Index', 'objective': 'Generate an automated index for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'index'}

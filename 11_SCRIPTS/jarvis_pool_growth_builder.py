...
FEATURE = {'slug': 'growth_builder', 'title': 'Jarvis Pool Growth Builder', 'objective': 'Generate an automated builder for the growth area using local repo signals.', 'domain': 'growth', 'action': 'builder'}

...
FEATURE = {'slug': 'health_matrix', 'title': 'Jarvis Pool Health Matrix', 'objective': 'Generate an automated matrix for the health area using local repo signals.', 'domain': 'health', 'action': 'matrix'}

...
FEATURE = {'slug': 'git_digest', 'title': 'Jarvis Pool Git Digest', 'objective': 'Generate an automated digest for the git area using local repo signals.', 'domain': 'git', 'action': 'digest'}

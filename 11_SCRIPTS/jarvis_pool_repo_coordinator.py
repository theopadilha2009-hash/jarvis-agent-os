...
FEATURE = {'slug': 'repo_coordinator', 'title': 'Jarvis Pool Repo Coordinator', 'objective': 'Generate an automated coordinator for the repo area using local repo signals.', 'domain': 'repo', 'action': 'coordinator'}

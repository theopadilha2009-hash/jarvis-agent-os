...
FEATURE = {'slug': 'reviewer_matrix', 'title': 'Jarvis Pool Reviewer Matrix', 'objective': 'Generate an automated matrix for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'matrix'}

...
FEATURE = {'slug': 'growth_baseline', 'title': 'Jarvis Pool Growth Baseline', 'objective': 'Generate an automated baseline for the growth area using local repo signals.', 'domain': 'growth', 'action': 'baseline'}

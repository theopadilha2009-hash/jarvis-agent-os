...
FEATURE = {'slug': 'planning_planner', 'title': 'Jarvis Pool Planning Planner', 'objective': 'Generate an automated planner for the planning area using local repo signals.', 'domain': 'planning', 'action': 'planner'}

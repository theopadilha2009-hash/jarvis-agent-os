...
FEATURE = {'slug': 'shipping_meter', 'title': 'Jarvis Pool Shipping Meter', 'objective': 'Generate an automated meter for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'meter'}

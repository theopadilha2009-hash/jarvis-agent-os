...
FEATURE = {'slug': 'operator_timeline', 'title': 'Jarvis Pool Operator Timeline', 'objective': 'Generate an automated timeline for the operator area using local repo signals.', 'domain': 'operator', 'action': 'timeline'}

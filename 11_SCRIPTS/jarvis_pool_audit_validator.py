...
FEATURE = {'slug': 'audit_validator', 'title': 'Jarvis Pool Audit Validator', 'objective': 'Generate an automated validator for the audit area using local repo signals.', 'domain': 'audit', 'action': 'validator'}

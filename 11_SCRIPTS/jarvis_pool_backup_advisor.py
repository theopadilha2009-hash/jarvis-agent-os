...
FEATURE = {'slug': 'backup_advisor', 'title': 'Jarvis Pool Backup Advisor', 'objective': 'Generate an automated advisor for the backup area using local repo signals.', 'domain': 'backup', 'action': 'advisor'}

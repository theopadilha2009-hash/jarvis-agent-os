...
FEATURE = {'slug': 'builder_optimizer', 'title': 'Jarvis Pool Builder Optimizer', 'objective': 'Generate an automated optimizer for the builder area using local repo signals.', 'domain': 'builder', 'action': 'optimizer'}

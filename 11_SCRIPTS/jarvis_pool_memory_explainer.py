...
FEATURE = {'slug': 'memory_explainer', 'title': 'Jarvis Pool Memory Explainer', 'objective': 'Generate an automated explainer for the memory area using local repo signals.', 'domain': 'memory', 'action': 'explainer'}

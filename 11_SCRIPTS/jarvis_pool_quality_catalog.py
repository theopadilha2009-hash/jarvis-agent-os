...
FEATURE = {'slug': 'quality_catalog', 'title': 'Jarvis Pool Quality Catalog', 'objective': 'Generate an automated catalog for the quality area using local repo signals.', 'domain': 'quality', 'action': 'catalog'}

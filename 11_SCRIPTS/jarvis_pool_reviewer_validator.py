...
FEATURE = {'slug': 'reviewer_validator', 'title': 'Jarvis Pool Reviewer Validator', 'objective': 'Generate an automated validator for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'validator'}

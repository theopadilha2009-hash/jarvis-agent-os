...
FEATURE = {'slug': 'doctor_cleaner', 'title': 'Jarvis Pool Doctor Cleaner', 'objective': 'Generate an automated cleaner for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'cleaner'}

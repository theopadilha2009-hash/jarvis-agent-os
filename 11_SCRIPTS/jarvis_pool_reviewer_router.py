...
FEATURE = {'slug': 'reviewer_router', 'title': 'Jarvis Pool Reviewer Router', 'objective': 'Generate an automated router for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'router'}

...
FEATURE = {'slug': 'shipping_digest', 'title': 'Jarvis Pool Shipping Digest', 'objective': 'Generate an automated digest for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'digest'}

...
FEATURE = {'slug': 'marathon_builder', 'title': 'Jarvis Pool Marathon Builder', 'objective': 'Generate an automated builder for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'builder'}

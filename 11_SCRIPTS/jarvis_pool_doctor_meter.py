...
FEATURE = {'slug': 'doctor_meter', 'title': 'Jarvis Pool Doctor Meter', 'objective': 'Generate an automated meter for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'meter'}

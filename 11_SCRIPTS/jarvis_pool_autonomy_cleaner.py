...
FEATURE = {'slug': 'autonomy_cleaner', 'title': 'Jarvis Pool Autonomy Cleaner', 'objective': 'Generate an automated cleaner for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'cleaner'}

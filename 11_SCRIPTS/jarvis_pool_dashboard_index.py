...
FEATURE = {'slug': 'dashboard_index', 'title': 'Jarvis Pool Dashboard Index', 'objective': 'Generate an automated index for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'index'}

...
FEATURE = {'slug': 'growth_check', 'title': 'Jarvis Pool Growth Check', 'objective': 'Generate an automated check for the growth area using local repo signals.', 'domain': 'growth', 'action': 'check'}

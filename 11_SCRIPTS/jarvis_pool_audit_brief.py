...
FEATURE = {'slug': 'audit_brief', 'title': 'Jarvis Pool Audit Brief', 'objective': 'Generate an automated brief for the audit area using local repo signals.', 'domain': 'audit', 'action': 'brief'}

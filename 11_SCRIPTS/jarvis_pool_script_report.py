...
FEATURE = {'slug': 'script_report', 'title': 'Jarvis Pool Script Report', 'objective': 'Generate an automated report for the script area using local repo signals.', 'domain': 'script', 'action': 'report'}

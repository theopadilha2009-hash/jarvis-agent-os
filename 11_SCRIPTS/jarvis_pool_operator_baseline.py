...
FEATURE = {'slug': 'operator_baseline', 'title': 'Jarvis Pool Operator Baseline', 'objective': 'Generate an automated baseline for the operator area using local repo signals.', 'domain': 'operator', 'action': 'baseline'}

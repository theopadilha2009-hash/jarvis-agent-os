...
FEATURE = {'slug': 'architecture_tracker', 'title': 'Jarvis Pool Architecture Tracker', 'objective': 'Generate an automated tracker for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'tracker'}

...
FEATURE = {'slug': 'builder_builder', 'title': 'Jarvis Pool Builder Builder', 'objective': 'Generate an automated builder for the builder area using local repo signals.', 'domain': 'builder', 'action': 'builder'}

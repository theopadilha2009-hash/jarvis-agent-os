...
FEATURE = {'slug': 'performance_check', 'title': 'Jarvis Pool Performance Check', 'objective': 'Generate an automated check for the performance area using local repo signals.', 'domain': 'performance', 'action': 'check'}

...
FEATURE = {'slug': 'health_guard', 'title': 'Jarvis Pool Health Guard', 'objective': 'Generate an automated guard for the health area using local repo signals.', 'domain': 'health', 'action': 'guard'}

...
FEATURE = {'slug': 'repo_brief', 'title': 'Jarvis Pool Repo Brief', 'objective': 'Generate an automated brief for the repo area using local repo signals.', 'domain': 'repo', 'action': 'brief'}

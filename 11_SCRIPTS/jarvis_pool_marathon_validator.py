...
FEATURE = {'slug': 'marathon_validator', 'title': 'Jarvis Pool Marathon Validator', 'objective': 'Generate an automated validator for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'validator'}

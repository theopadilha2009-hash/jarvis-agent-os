...
FEATURE = {'slug': 'performance_scanner', 'title': 'Jarvis Pool Performance Scanner', 'objective': 'Generate an automated scanner for the performance area using local repo signals.', 'domain': 'performance', 'action': 'scanner'}

...
FEATURE = {'slug': 'script_router', 'title': 'Jarvis Pool Script Router', 'objective': 'Generate an automated router for the script area using local repo signals.', 'domain': 'script', 'action': 'router'}

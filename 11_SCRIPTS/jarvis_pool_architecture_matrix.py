...
FEATURE = {'slug': 'architecture_matrix', 'title': 'Jarvis Pool Architecture Matrix', 'objective': 'Generate an automated matrix for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'matrix'}

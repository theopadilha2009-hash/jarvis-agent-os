...
FEATURE = {'slug': 'script_catalog', 'title': 'Jarvis Pool Script Catalog', 'objective': 'Generate an automated catalog for the script area using local repo signals.', 'domain': 'script', 'action': 'catalog'}

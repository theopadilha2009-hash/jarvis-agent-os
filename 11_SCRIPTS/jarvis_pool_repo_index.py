...
FEATURE = {'slug': 'repo_index', 'title': 'Jarvis Pool Repo Index', 'objective': 'Generate an automated index for the repo area using local repo signals.', 'domain': 'repo', 'action': 'index'}

...
FEATURE = {'slug': 'index_watch', 'title': 'Jarvis Pool Index Watch', 'objective': 'Generate an automated watch for the index area using local repo signals.', 'domain': 'index', 'action': 'watch'}

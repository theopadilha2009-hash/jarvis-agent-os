...
FEATURE = {'slug': 'runbook_guard', 'title': 'Jarvis Pool Runbook Guard', 'objective': 'Generate an automated guard for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'guard'}

...
FEATURE = {'slug': 'session_score', 'title': 'Jarvis Pool Session Score', 'objective': 'Generate an automated score for the session area using local repo signals.', 'domain': 'session', 'action': 'score'}

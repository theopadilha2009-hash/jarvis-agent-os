...
FEATURE = {'slug': 'git_score', 'title': 'Jarvis Pool Git Score', 'objective': 'Generate an automated score for the git area using local repo signals.', 'domain': 'git', 'action': 'score'}

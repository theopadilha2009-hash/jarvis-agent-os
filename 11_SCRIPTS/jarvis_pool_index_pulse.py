...
FEATURE = {'slug': 'index_pulse', 'title': 'Jarvis Pool Index Pulse', 'objective': 'Generate an automated pulse for the index area using local repo signals.', 'domain': 'index', 'action': 'pulse'}

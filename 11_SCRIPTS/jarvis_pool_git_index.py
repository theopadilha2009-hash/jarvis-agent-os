...
FEATURE = {'slug': 'git_index', 'title': 'Jarvis Pool Git Index', 'objective': 'Generate an automated index for the git area using local repo signals.', 'domain': 'git', 'action': 'index'}

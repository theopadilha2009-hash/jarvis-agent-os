...
FEATURE = {'slug': 'quality_matrix', 'title': 'Jarvis Pool Quality Matrix', 'objective': 'Generate an automated matrix for the quality area using local repo signals.', 'domain': 'quality', 'action': 'matrix'}

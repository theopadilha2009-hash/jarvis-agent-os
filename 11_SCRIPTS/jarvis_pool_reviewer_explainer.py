...
FEATURE = {'slug': 'reviewer_explainer', 'title': 'Jarvis Pool Reviewer Explainer', 'objective': 'Generate an automated explainer for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'explainer'}

...
FEATURE = {'slug': 'builder_watch', 'title': 'Jarvis Pool Builder Watch', 'objective': 'Generate an automated watch for the builder area using local repo signals.', 'domain': 'builder', 'action': 'watch'}

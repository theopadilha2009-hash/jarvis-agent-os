...
FEATURE = {'slug': 'integration_check', 'title': 'Jarvis Pool Integration Check', 'objective': 'Generate an automated check for the integration area using local repo signals.', 'domain': 'integration', 'action': 'check'}

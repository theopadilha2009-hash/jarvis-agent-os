...
FEATURE = {'slug': 'marathon_scanner', 'title': 'Jarvis Pool Marathon Scanner', 'objective': 'Generate an automated scanner for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'scanner'}

...
FEATURE = {'slug': 'validation_baseline', 'title': 'Jarvis Pool Validation Baseline', 'objective': 'Generate an automated baseline for the validation area using local repo signals.', 'domain': 'validation', 'action': 'baseline'}

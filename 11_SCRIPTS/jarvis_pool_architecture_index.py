...
FEATURE = {'slug': 'architecture_index', 'title': 'Jarvis Pool Architecture Index', 'objective': 'Generate an automated index for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'index'}

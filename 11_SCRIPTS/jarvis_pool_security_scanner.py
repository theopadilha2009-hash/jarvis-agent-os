...
FEATURE = {'slug': 'security_scanner', 'title': 'Jarvis Pool Security Scanner', 'objective': 'Generate an automated scanner for the security area using local repo signals.', 'domain': 'security', 'action': 'scanner'}

...
FEATURE = {'slug': 'shipping_report', 'title': 'Jarvis Pool Shipping Report', 'objective': 'Generate an automated report for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'report'}

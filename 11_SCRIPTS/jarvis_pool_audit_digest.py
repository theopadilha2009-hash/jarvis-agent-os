...
FEATURE = {'slug': 'audit_digest', 'title': 'Jarvis Pool Audit Digest', 'objective': 'Generate an automated digest for the audit area using local repo signals.', 'domain': 'audit', 'action': 'digest'}

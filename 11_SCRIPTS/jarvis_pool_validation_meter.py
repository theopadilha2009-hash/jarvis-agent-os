...
FEATURE = {'slug': 'validation_meter', 'title': 'Jarvis Pool Validation Meter', 'objective': 'Generate an automated meter for the validation area using local repo signals.', 'domain': 'validation', 'action': 'meter'}

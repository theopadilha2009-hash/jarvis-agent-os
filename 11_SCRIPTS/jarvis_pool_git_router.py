...
FEATURE = {'slug': 'git_router', 'title': 'Jarvis Pool Git Router', 'objective': 'Generate an automated router for the git area using local repo signals.', 'domain': 'git', 'action': 'router'}

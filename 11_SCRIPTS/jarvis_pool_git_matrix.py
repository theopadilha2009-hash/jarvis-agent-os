...
FEATURE = {'slug': 'git_matrix', 'title': 'Jarvis Pool Git Matrix', 'objective': 'Generate an automated matrix for the git area using local repo signals.', 'domain': 'git', 'action': 'matrix'}

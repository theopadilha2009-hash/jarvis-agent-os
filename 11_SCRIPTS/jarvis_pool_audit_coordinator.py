...
FEATURE = {'slug': 'audit_coordinator', 'title': 'Jarvis Pool Audit Coordinator', 'objective': 'Generate an automated coordinator for the audit area using local repo signals.', 'domain': 'audit', 'action': 'coordinator'}

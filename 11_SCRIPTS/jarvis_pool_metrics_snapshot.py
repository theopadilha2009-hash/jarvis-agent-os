...
FEATURE = {'slug': 'metrics_snapshot', 'title': 'Jarvis Pool Metrics Snapshot', 'objective': 'Generate an automated snapshot for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'snapshot'}

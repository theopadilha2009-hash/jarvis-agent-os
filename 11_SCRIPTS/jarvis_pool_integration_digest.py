...
FEATURE = {'slug': 'integration_digest', 'title': 'Jarvis Pool Integration Digest', 'objective': 'Generate an automated digest for the integration area using local repo signals.', 'domain': 'integration', 'action': 'digest'}

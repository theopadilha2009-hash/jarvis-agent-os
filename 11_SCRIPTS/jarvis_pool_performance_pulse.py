...
FEATURE = {'slug': 'performance_pulse', 'title': 'Jarvis Pool Performance Pulse', 'objective': 'Generate an automated pulse for the performance area using local repo signals.', 'domain': 'performance', 'action': 'pulse'}

...
FEATURE = {'slug': 'planning_coordinator', 'title': 'Jarvis Pool Planning Coordinator', 'objective': 'Generate an automated coordinator for the planning area using local repo signals.', 'domain': 'planning', 'action': 'coordinator'}

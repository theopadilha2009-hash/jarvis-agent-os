...
FEATURE = {'slug': 'release_baseline', 'title': 'Jarvis Pool Release Baseline', 'objective': 'Generate an automated baseline for the release area using local repo signals.', 'domain': 'release', 'action': 'baseline'}

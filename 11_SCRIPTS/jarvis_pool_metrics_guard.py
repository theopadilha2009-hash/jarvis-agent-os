...
FEATURE = {'slug': 'metrics_guard', 'title': 'Jarvis Pool Metrics Guard', 'objective': 'Generate an automated guard for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'guard'}

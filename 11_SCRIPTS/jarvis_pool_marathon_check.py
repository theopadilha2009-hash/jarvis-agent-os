...
FEATURE = {'slug': 'marathon_check', 'title': 'Jarvis Pool Marathon Check', 'objective': 'Generate an automated check for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'check'}

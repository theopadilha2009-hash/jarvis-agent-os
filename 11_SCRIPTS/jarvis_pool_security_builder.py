...
FEATURE = {'slug': 'security_builder', 'title': 'Jarvis Pool Security Builder', 'objective': 'Generate an automated builder for the security area using local repo signals.', 'domain': 'security', 'action': 'builder'}

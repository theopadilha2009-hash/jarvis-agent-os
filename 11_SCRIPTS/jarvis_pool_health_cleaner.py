...
FEATURE = {'slug': 'health_cleaner', 'title': 'Jarvis Pool Health Cleaner', 'objective': 'Generate an automated cleaner for the health area using local repo signals.', 'domain': 'health', 'action': 'cleaner'}

...
FEATURE = {'slug': 'script_snapshot', 'title': 'Jarvis Pool Script Snapshot', 'objective': 'Generate an automated snapshot for the script area using local repo signals.', 'domain': 'script', 'action': 'snapshot'}

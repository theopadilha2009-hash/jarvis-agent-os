...
FEATURE = {'slug': 'backup_checkpoint', 'title': 'Jarvis Pool Backup Checkpoint', 'objective': 'Generate an automated checkpoint for the backup area using local repo signals.', 'domain': 'backup', 'action': 'checkpoint'}

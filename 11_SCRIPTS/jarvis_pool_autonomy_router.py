...
FEATURE = {'slug': 'autonomy_router', 'title': 'Jarvis Pool Autonomy Router', 'objective': 'Generate an automated router for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'router'}

...
FEATURE = {'slug': 'runbook_brief', 'title': 'Jarvis Pool Runbook Brief', 'objective': 'Generate an automated brief for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'brief'}

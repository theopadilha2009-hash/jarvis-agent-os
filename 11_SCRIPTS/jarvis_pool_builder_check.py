...
FEATURE = {'slug': 'builder_check', 'title': 'Jarvis Pool Builder Check', 'objective': 'Generate an automated check for the builder area using local repo signals.', 'domain': 'builder', 'action': 'check'}

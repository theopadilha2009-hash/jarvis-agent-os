...
FEATURE = {'slug': 'backup_cleaner', 'title': 'Jarvis Pool Backup Cleaner', 'objective': 'Generate an automated cleaner for the backup area using local repo signals.', 'domain': 'backup', 'action': 'cleaner'}

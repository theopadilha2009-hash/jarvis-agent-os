...
FEATURE = {'slug': 'script_coordinator', 'title': 'Jarvis Pool Script Coordinator', 'objective': 'Generate an automated coordinator for the script area using local repo signals.', 'domain': 'script', 'action': 'coordinator'}

...
FEATURE = {'slug': 'architecture_snapshot', 'title': 'Jarvis Pool Architecture Snapshot', 'objective': 'Generate an automated snapshot for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'snapshot'}

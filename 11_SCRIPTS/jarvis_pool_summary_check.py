...
FEATURE = {'slug': 'summary_check', 'title': 'Jarvis Pool Summary Check', 'objective': 'Generate an automated check for the summary area using local repo signals.', 'domain': 'summary', 'action': 'check'}

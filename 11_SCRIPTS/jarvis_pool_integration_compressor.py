...
FEATURE = {'slug': 'integration_compressor', 'title': 'Jarvis Pool Integration Compressor', 'objective': 'Generate an automated compressor for the integration area using local repo signals.', 'domain': 'integration', 'action': 'compressor'}

...
FEATURE = {'slug': 'health_review', 'title': 'Jarvis Pool Health Review', 'objective': 'Generate an automated review for the health area using local repo signals.', 'domain': 'health', 'action': 'review'}

...
FEATURE = {'slug': 'doctor_planner', 'title': 'Jarvis Pool Doctor Planner', 'objective': 'Generate an automated planner for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'planner'}

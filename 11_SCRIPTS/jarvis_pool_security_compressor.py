...
FEATURE = {'slug': 'security_compressor', 'title': 'Jarvis Pool Security Compressor', 'objective': 'Generate an automated compressor for the security area using local repo signals.', 'domain': 'security', 'action': 'compressor'}

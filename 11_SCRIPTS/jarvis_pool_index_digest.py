...
FEATURE = {'slug': 'index_digest', 'title': 'Jarvis Pool Index Digest', 'objective': 'Generate an automated digest for the index area using local repo signals.', 'domain': 'index', 'action': 'digest'}

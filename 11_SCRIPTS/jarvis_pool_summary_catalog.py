...
FEATURE = {'slug': 'summary_catalog', 'title': 'Jarvis Pool Summary Catalog', 'objective': 'Generate an automated catalog for the summary area using local repo signals.', 'domain': 'summary', 'action': 'catalog'}

...
FEATURE = {'slug': 'summary_matrix', 'title': 'Jarvis Pool Summary Matrix', 'objective': 'Generate an automated matrix for the summary area using local repo signals.', 'domain': 'summary', 'action': 'matrix'}

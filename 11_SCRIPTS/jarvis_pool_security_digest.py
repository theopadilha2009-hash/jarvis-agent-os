...
FEATURE = {'slug': 'security_digest', 'title': 'Jarvis Pool Security Digest', 'objective': 'Generate an automated digest for the security area using local repo signals.', 'domain': 'security', 'action': 'digest'}

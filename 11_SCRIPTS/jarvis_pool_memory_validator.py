...
FEATURE = {'slug': 'memory_validator', 'title': 'Jarvis Pool Memory Validator', 'objective': 'Generate an automated validator for the memory area using local repo signals.', 'domain': 'memory', 'action': 'validator'}

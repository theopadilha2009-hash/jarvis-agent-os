...
FEATURE = {'slug': 'release_matrix', 'title': 'Jarvis Pool Release Matrix', 'objective': 'Generate an automated matrix for the release area using local repo signals.', 'domain': 'release', 'action': 'matrix'}

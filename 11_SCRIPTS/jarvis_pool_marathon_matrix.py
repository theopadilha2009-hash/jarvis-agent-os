...
FEATURE = {'slug': 'marathon_matrix', 'title': 'Jarvis Pool Marathon Matrix', 'objective': 'Generate an automated matrix for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'matrix'}

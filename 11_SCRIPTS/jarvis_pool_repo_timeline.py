...
FEATURE = {'slug': 'repo_timeline', 'title': 'Jarvis Pool Repo Timeline', 'objective': 'Generate an automated timeline for the repo area using local repo signals.', 'domain': 'repo', 'action': 'timeline'}

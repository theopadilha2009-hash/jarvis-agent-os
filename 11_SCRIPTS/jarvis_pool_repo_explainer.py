...
FEATURE = {'slug': 'repo_explainer', 'title': 'Jarvis Pool Repo Explainer', 'objective': 'Generate an automated explainer for the repo area using local repo signals.', 'domain': 'repo', 'action': 'explainer'}

...
FEATURE = {'slug': 'planning_advisor', 'title': 'Jarvis Pool Planning Advisor', 'objective': 'Generate an automated advisor for the planning area using local repo signals.', 'domain': 'planning', 'action': 'advisor'}

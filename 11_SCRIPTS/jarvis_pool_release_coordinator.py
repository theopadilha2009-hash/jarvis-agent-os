...
FEATURE = {'slug': 'release_coordinator', 'title': 'Jarvis Pool Release Coordinator', 'objective': 'Generate an automated coordinator for the release area using local repo signals.', 'domain': 'release', 'action': 'coordinator'}

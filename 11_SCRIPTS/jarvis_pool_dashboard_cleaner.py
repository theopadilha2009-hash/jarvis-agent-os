...
FEATURE = {'slug': 'dashboard_cleaner', 'title': 'Jarvis Pool Dashboard Cleaner', 'objective': 'Generate an automated cleaner for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'cleaner'}

...
FEATURE = {'slug': 'integration_score', 'title': 'Jarvis Pool Integration Score', 'objective': 'Generate an automated score for the integration area using local repo signals.', 'domain': 'integration', 'action': 'score'}

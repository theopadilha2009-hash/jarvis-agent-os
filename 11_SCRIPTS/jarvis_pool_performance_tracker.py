...
FEATURE = {'slug': 'performance_tracker', 'title': 'Jarvis Pool Performance Tracker', 'objective': 'Generate an automated tracker for the performance area using local repo signals.', 'domain': 'performance', 'action': 'tracker'}

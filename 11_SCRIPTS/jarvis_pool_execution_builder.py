...
FEATURE = {'slug': 'execution_builder', 'title': 'Jarvis Pool Execution Builder', 'objective': 'Generate an automated builder for the execution area using local repo signals.', 'domain': 'execution', 'action': 'builder'}

...
FEATURE = {'slug': 'audit_matrix', 'title': 'Jarvis Pool Audit Matrix', 'objective': 'Generate an automated matrix for the audit area using local repo signals.', 'domain': 'audit', 'action': 'matrix'}

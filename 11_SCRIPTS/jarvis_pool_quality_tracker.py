...
FEATURE = {'slug': 'quality_tracker', 'title': 'Jarvis Pool Quality Tracker', 'objective': 'Generate an automated tracker for the quality area using local repo signals.', 'domain': 'quality', 'action': 'tracker'}

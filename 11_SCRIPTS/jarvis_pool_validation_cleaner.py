...
FEATURE = {'slug': 'validation_cleaner', 'title': 'Jarvis Pool Validation Cleaner', 'objective': 'Generate an automated cleaner for the validation area using local repo signals.', 'domain': 'validation', 'action': 'cleaner'}

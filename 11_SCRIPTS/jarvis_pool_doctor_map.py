...
FEATURE = {'slug': 'doctor_map', 'title': 'Jarvis Pool Doctor Map', 'objective': 'Generate an automated map for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'map'}

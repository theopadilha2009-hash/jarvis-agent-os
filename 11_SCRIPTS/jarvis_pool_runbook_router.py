...
FEATURE = {'slug': 'runbook_router', 'title': 'Jarvis Pool Runbook Router', 'objective': 'Generate an automated router for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'router'}

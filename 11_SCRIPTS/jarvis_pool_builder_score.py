...
FEATURE = {'slug': 'builder_score', 'title': 'Jarvis Pool Builder Score', 'objective': 'Generate an automated score for the builder area using local repo signals.', 'domain': 'builder', 'action': 'score'}

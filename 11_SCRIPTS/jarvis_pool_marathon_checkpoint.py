...
FEATURE = {'slug': 'marathon_checkpoint', 'title': 'Jarvis Pool Marathon Checkpoint', 'objective': 'Generate an automated checkpoint for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'checkpoint'}

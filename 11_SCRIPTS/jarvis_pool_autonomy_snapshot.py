...
FEATURE = {'slug': 'autonomy_snapshot', 'title': 'Jarvis Pool Autonomy Snapshot', 'objective': 'Generate an automated snapshot for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'snapshot'}

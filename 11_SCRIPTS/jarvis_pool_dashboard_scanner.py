...
FEATURE = {'slug': 'dashboard_scanner', 'title': 'Jarvis Pool Dashboard Scanner', 'objective': 'Generate an automated scanner for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'scanner'}

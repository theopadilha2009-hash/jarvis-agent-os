...
FEATURE = {'slug': 'marathon_coordinator', 'title': 'Jarvis Pool Marathon Coordinator', 'objective': 'Generate an automated coordinator for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'coordinator'}

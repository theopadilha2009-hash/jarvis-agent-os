...
FEATURE = {'slug': 'marathon_baseline', 'title': 'Jarvis Pool Marathon Baseline', 'objective': 'Generate an automated baseline for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'baseline'}

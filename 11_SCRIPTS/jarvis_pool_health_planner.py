...
FEATURE = {'slug': 'health_planner', 'title': 'Jarvis Pool Health Planner', 'objective': 'Generate an automated planner for the health area using local repo signals.', 'domain': 'health', 'action': 'planner'}

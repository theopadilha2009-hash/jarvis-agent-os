...
FEATURE = {'slug': 'shipping_validator', 'title': 'Jarvis Pool Shipping Validator', 'objective': 'Generate an automated validator for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'validator'}

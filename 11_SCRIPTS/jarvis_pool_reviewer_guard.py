...
FEATURE = {'slug': 'reviewer_guard', 'title': 'Jarvis Pool Reviewer Guard', 'objective': 'Generate an automated guard for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'guard'}

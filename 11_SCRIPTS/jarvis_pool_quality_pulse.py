...
FEATURE = {'slug': 'quality_pulse', 'title': 'Jarvis Pool Quality Pulse', 'objective': 'Generate an automated pulse for the quality area using local repo signals.', 'domain': 'quality', 'action': 'pulse'}

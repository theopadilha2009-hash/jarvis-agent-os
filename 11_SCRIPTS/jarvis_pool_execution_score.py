...
FEATURE = {'slug': 'execution_score', 'title': 'Jarvis Pool Execution Score', 'objective': 'Generate an automated score for the execution area using local repo signals.', 'domain': 'execution', 'action': 'score'}

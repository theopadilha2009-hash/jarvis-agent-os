...
FEATURE = {'slug': 'health_baseline', 'title': 'Jarvis Pool Health Baseline', 'objective': 'Generate an automated baseline for the health area using local repo signals.', 'domain': 'health', 'action': 'baseline'}

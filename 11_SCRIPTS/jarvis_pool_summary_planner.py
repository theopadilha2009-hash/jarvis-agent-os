...
FEATURE = {'slug': 'summary_planner', 'title': 'Jarvis Pool Summary Planner', 'objective': 'Generate an automated planner for the summary area using local repo signals.', 'domain': 'summary', 'action': 'planner'}

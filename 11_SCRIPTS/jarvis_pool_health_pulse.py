...
FEATURE = {'slug': 'health_pulse', 'title': 'Jarvis Pool Health Pulse', 'objective': 'Generate an automated pulse for the health area using local repo signals.', 'domain': 'health', 'action': 'pulse'}

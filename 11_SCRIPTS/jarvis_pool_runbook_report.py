...
FEATURE = {'slug': 'runbook_report', 'title': 'Jarvis Pool Runbook Report', 'objective': 'Generate an automated report for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'report'}

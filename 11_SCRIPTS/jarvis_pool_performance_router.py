...
FEATURE = {'slug': 'performance_router', 'title': 'Jarvis Pool Performance Router', 'objective': 'Generate an automated router for the performance area using local repo signals.', 'domain': 'performance', 'action': 'router'}

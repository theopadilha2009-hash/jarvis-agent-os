...
FEATURE = {'slug': 'backup_explainer', 'title': 'Jarvis Pool Backup Explainer', 'objective': 'Generate an automated explainer for the backup area using local repo signals.', 'domain': 'backup', 'action': 'explainer'}

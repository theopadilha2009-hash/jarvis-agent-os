...
FEATURE = {'slug': 'memory_builder', 'title': 'Jarvis Pool Memory Builder', 'objective': 'Generate an automated builder for the memory area using local repo signals.', 'domain': 'memory', 'action': 'builder'}

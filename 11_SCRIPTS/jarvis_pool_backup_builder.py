...
FEATURE = {'slug': 'backup_builder', 'title': 'Jarvis Pool Backup Builder', 'objective': 'Generate an automated builder for the backup area using local repo signals.', 'domain': 'backup', 'action': 'builder'}

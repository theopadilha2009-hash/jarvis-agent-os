...
FEATURE = {'slug': 'quality_scanner', 'title': 'Jarvis Pool Quality Scanner', 'objective': 'Generate an automated scanner for the quality area using local repo signals.', 'domain': 'quality', 'action': 'scanner'}

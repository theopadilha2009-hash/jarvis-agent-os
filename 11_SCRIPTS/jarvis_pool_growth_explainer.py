...
FEATURE = {'slug': 'growth_explainer', 'title': 'Jarvis Pool Growth Explainer', 'objective': 'Generate an automated explainer for the growth area using local repo signals.', 'domain': 'growth', 'action': 'explainer'}

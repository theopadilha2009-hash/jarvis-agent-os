...
FEATURE = {'slug': 'execution_advisor', 'title': 'Jarvis Pool Execution Advisor', 'objective': 'Generate an automated advisor for the execution area using local repo signals.', 'domain': 'execution', 'action': 'advisor'}

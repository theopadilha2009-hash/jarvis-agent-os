...
FEATURE = {'slug': 'builder_guard', 'title': 'Jarvis Pool Builder Guard', 'objective': 'Generate an automated guard for the builder area using local repo signals.', 'domain': 'builder', 'action': 'guard'}

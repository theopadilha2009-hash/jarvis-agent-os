...
FEATURE = {'slug': 'autonomy_baseline', 'title': 'Jarvis Pool Autonomy Baseline', 'objective': 'Generate an automated baseline for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'baseline'}

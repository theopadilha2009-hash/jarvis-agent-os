...
FEATURE = {'slug': 'backup_score', 'title': 'Jarvis Pool Backup Score', 'objective': 'Generate an automated score for the backup area using local repo signals.', 'domain': 'backup', 'action': 'score'}

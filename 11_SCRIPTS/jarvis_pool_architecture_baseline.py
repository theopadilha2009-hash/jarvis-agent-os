...
FEATURE = {'slug': 'architecture_baseline', 'title': 'Jarvis Pool Architecture Baseline', 'objective': 'Generate an automated baseline for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'baseline'}

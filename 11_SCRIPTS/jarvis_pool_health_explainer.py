...
FEATURE = {'slug': 'health_explainer', 'title': 'Jarvis Pool Health Explainer', 'objective': 'Generate an automated explainer for the health area using local repo signals.', 'domain': 'health', 'action': 'explainer'}

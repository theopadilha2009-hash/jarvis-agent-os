...
FEATURE = {'slug': 'quality_timeline', 'title': 'Jarvis Pool Quality Timeline', 'objective': 'Generate an automated timeline for the quality area using local repo signals.', 'domain': 'quality', 'action': 'timeline'}

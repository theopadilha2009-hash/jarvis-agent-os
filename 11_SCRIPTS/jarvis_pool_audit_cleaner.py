...
FEATURE = {'slug': 'audit_cleaner', 'title': 'Jarvis Pool Audit Cleaner', 'objective': 'Generate an automated cleaner for the audit area using local repo signals.', 'domain': 'audit', 'action': 'cleaner'}

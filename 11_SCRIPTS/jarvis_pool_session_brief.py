...
FEATURE = {'slug': 'session_brief', 'title': 'Jarvis Pool Session Brief', 'objective': 'Generate an automated brief for the session area using local repo signals.', 'domain': 'session', 'action': 'brief'}

...
FEATURE = {'slug': 'summary_baseline', 'title': 'Jarvis Pool Summary Baseline', 'objective': 'Generate an automated baseline for the summary area using local repo signals.', 'domain': 'summary', 'action': 'baseline'}

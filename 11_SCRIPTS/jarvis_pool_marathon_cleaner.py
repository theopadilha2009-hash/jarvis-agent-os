...
FEATURE = {'slug': 'marathon_cleaner', 'title': 'Jarvis Pool Marathon Cleaner', 'objective': 'Generate an automated cleaner for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'cleaner'}

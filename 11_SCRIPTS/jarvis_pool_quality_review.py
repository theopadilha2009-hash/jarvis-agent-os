...
FEATURE = {'slug': 'quality_review', 'title': 'Jarvis Pool Quality Review', 'objective': 'Generate an automated review for the quality area using local repo signals.', 'domain': 'quality', 'action': 'review'}

...
FEATURE = {'slug': 'dashboard_catalog', 'title': 'Jarvis Pool Dashboard Catalog', 'objective': 'Generate an automated catalog for the dashboard area using local repo signals.', 'domain': 'dashboard', 'action': 'catalog'}

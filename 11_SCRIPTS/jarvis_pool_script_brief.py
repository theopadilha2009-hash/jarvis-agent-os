...
FEATURE = {'slug': 'script_brief', 'title': 'Jarvis Pool Script Brief', 'objective': 'Generate an automated brief for the script area using local repo signals.', 'domain': 'script', 'action': 'brief'}

...
FEATURE = {'slug': 'validation_brief', 'title': 'Jarvis Pool Validation Brief', 'objective': 'Generate an automated brief for the validation area using local repo signals.', 'domain': 'validation', 'action': 'brief'}

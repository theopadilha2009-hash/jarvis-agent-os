...
FEATURE = {'slug': 'summary_digest', 'title': 'Jarvis Pool Summary Digest', 'objective': 'Generate an automated digest for the summary area using local repo signals.', 'domain': 'summary', 'action': 'digest'}

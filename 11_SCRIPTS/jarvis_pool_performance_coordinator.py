...
FEATURE = {'slug': 'performance_coordinator', 'title': 'Jarvis Pool Performance Coordinator', 'objective': 'Generate an automated coordinator for the performance area using local repo signals.', 'domain': 'performance', 'action': 'coordinator'}

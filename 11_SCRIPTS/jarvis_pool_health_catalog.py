...
FEATURE = {'slug': 'health_catalog', 'title': 'Jarvis Pool Health Catalog', 'objective': 'Generate an automated catalog for the health area using local repo signals.', 'domain': 'health', 'action': 'catalog'}

...
FEATURE = {'slug': 'validation_checkpoint', 'title': 'Jarvis Pool Validation Checkpoint', 'objective': 'Generate an automated checkpoint for the validation area using local repo signals.', 'domain': 'validation', 'action': 'checkpoint'}

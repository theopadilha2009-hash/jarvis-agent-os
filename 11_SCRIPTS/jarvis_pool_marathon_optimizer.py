...
FEATURE = {'slug': 'marathon_optimizer', 'title': 'Jarvis Pool Marathon Optimizer', 'objective': 'Generate an automated optimizer for the marathon area using local repo signals.', 'domain': 'marathon', 'action': 'optimizer'}

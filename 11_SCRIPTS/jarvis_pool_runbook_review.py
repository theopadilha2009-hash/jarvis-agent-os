...
FEATURE = {'slug': 'runbook_review', 'title': 'Jarvis Pool Runbook Review', 'objective': 'Generate an automated review for the runbook area using local repo signals.', 'domain': 'runbook', 'action': 'review'}

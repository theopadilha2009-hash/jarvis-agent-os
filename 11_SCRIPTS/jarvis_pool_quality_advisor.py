...
FEATURE = {'slug': 'quality_advisor', 'title': 'Jarvis Pool Quality Advisor', 'objective': 'Generate an automated advisor for the quality area using local repo signals.', 'domain': 'quality', 'action': 'advisor'}

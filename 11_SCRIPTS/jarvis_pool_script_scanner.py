...
FEATURE = {'slug': 'script_scanner', 'title': 'Jarvis Pool Script Scanner', 'objective': 'Generate an automated scanner for the script area using local repo signals.', 'domain': 'script', 'action': 'scanner'}

...
FEATURE = {'slug': 'planning_digest', 'title': 'Jarvis Pool Planning Digest', 'objective': 'Generate an automated digest for the planning area using local repo signals.', 'domain': 'planning', 'action': 'digest'}

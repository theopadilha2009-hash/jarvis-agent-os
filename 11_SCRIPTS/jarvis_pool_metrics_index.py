...
FEATURE = {'slug': 'metrics_index', 'title': 'Jarvis Pool Metrics Index', 'objective': 'Generate an automated index for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'index'}

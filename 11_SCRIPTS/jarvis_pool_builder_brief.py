...
FEATURE = {'slug': 'builder_brief', 'title': 'Jarvis Pool Builder Brief', 'objective': 'Generate an automated brief for the builder area using local repo signals.', 'domain': 'builder', 'action': 'brief'}

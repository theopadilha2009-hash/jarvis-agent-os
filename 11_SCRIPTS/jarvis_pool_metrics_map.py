...
FEATURE = {'slug': 'metrics_map', 'title': 'Jarvis Pool Metrics Map', 'objective': 'Generate an automated map for the metrics area using local repo signals.', 'domain': 'metrics', 'action': 'map'}

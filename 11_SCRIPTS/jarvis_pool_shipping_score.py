...
FEATURE = {'slug': 'shipping_score', 'title': 'Jarvis Pool Shipping Score', 'objective': 'Generate an automated score for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'score'}

...
FEATURE = {'slug': 'release_router', 'title': 'Jarvis Pool Release Router', 'objective': 'Generate an automated router for the release area using local repo signals.', 'domain': 'release', 'action': 'router'}

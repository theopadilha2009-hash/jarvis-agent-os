...
FEATURE = {'slug': 'autonomy_digest', 'title': 'Jarvis Pool Autonomy Digest', 'objective': 'Generate an automated digest for the autonomy area using local repo signals.', 'domain': 'autonomy', 'action': 'digest'}

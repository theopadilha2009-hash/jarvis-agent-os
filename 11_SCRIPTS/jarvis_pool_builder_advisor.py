...
FEATURE = {'slug': 'builder_advisor', 'title': 'Jarvis Pool Builder Advisor', 'objective': 'Generate an automated advisor for the builder area using local repo signals.', 'domain': 'builder', 'action': 'advisor'}

...
FEATURE = {'slug': 'validation_explainer', 'title': 'Jarvis Pool Validation Explainer', 'objective': 'Generate an automated explainer for the validation area using local repo signals.', 'domain': 'validation', 'action': 'explainer'}

...
FEATURE = {'slug': 'release_map', 'title': 'Jarvis Pool Release Map', 'objective': 'Generate an automated map for the release area using local repo signals.', 'domain': 'release', 'action': 'map'}

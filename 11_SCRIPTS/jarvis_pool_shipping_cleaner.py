...
FEATURE = {'slug': 'shipping_cleaner', 'title': 'Jarvis Pool Shipping Cleaner', 'objective': 'Generate an automated cleaner for the shipping area using local repo signals.', 'domain': 'shipping', 'action': 'cleaner'}

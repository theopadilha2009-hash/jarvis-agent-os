...
FEATURE = {'slug': 'memory_review', 'title': 'Jarvis Pool Memory Review', 'objective': 'Generate an automated review for the memory area using local repo signals.', 'domain': 'memory', 'action': 'review'}

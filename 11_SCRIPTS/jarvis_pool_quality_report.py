...
FEATURE = {'slug': 'quality_report', 'title': 'Jarvis Pool Quality Report', 'objective': 'Generate an automated report for the quality area using local repo signals.', 'domain': 'quality', 'action': 'report'}

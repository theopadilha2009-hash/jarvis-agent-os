...
FEATURE = {'slug': 'validation_router', 'title': 'Jarvis Pool Validation Router', 'objective': 'Generate an automated router for the validation area using local repo signals.', 'domain': 'validation', 'action': 'router'}

...
FEATURE = {'slug': 'memory_map', 'title': 'Jarvis Pool Memory Map', 'objective': 'Generate an automated map for the memory area using local repo signals.', 'domain': 'memory', 'action': 'map'}

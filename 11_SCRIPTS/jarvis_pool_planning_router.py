...
FEATURE = {'slug': 'planning_router', 'title': 'Jarvis Pool Planning Router', 'objective': 'Generate an automated router for the planning area using local repo signals.', 'domain': 'planning', 'action': 'router'}

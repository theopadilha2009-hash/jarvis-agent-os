...
FEATURE = {'slug': 'operator_scanner', 'title': 'Jarvis Pool Operator Scanner', 'objective': 'Generate an automated scanner for the operator area using local repo signals.', 'domain': 'operator', 'action': 'scanner'}

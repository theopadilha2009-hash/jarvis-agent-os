...
FEATURE = {'slug': 'script_score', 'title': 'Jarvis Pool Script Score', 'objective': 'Generate an automated score for the script area using local repo signals.', 'domain': 'script', 'action': 'score'}

...
FEATURE = {'slug': 'doctor_advisor', 'title': 'Jarvis Pool Doctor Advisor', 'objective': 'Generate an automated advisor for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'advisor'}

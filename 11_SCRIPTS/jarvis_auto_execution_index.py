...
FEATURE = {'slug': 'execution_index', 'title': 'Jarvis Auto Execution Index', 'objective': 'Index execution output folders so the operator can quickly see recent system artifacts.'}

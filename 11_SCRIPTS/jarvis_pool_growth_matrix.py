...
FEATURE = {'slug': 'growth_matrix', 'title': 'Jarvis Pool Growth Matrix', 'objective': 'Generate an automated matrix for the growth area using local repo signals.', 'domain': 'growth', 'action': 'matrix'}

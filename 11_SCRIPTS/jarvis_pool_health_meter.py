...
FEATURE = {'slug': 'health_meter', 'title': 'Jarvis Pool Health Meter', 'objective': 'Generate an automated meter for the health area using local repo signals.', 'domain': 'health', 'action': 'meter'}

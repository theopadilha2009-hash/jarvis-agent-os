...
FEATURE = {'slug': 'audit_scanner', 'title': 'Jarvis Pool Audit Scanner', 'objective': 'Generate an automated scanner for the audit area using local repo signals.', 'domain': 'audit', 'action': 'scanner'}

...
FEATURE = {'slug': 'performance_report', 'title': 'Jarvis Pool Performance Report', 'objective': 'Generate an automated report for the performance area using local repo signals.', 'domain': 'performance', 'action': 'report'}

...
FEATURE = {'slug': 'planning_map', 'title': 'Jarvis Pool Planning Map', 'objective': 'Generate an automated map for the planning area using local repo signals.', 'domain': 'planning', 'action': 'map'}

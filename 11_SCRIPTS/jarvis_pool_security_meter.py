...
FEATURE = {'slug': 'security_meter', 'title': 'Jarvis Pool Security Meter', 'objective': 'Generate an automated meter for the security area using local repo signals.', 'domain': 'security', 'action': 'meter'}

...
FEATURE = {'slug': 'planning_report', 'title': 'Jarvis Pool Planning Report', 'objective': 'Generate an automated report for the planning area using local repo signals.', 'domain': 'planning', 'action': 'report'}

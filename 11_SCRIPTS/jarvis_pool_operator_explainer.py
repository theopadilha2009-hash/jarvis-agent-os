...
FEATURE = {'slug': 'operator_explainer', 'title': 'Jarvis Pool Operator Explainer', 'objective': 'Generate an automated explainer for the operator area using local repo signals.', 'domain': 'operator', 'action': 'explainer'}

...
FEATURE = {'slug': 'execution_meter', 'title': 'Jarvis Pool Execution Meter', 'objective': 'Generate an automated meter for the execution area using local repo signals.', 'domain': 'execution', 'action': 'meter'}

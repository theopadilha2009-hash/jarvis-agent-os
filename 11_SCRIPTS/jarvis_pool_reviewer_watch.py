...
FEATURE = {'slug': 'reviewer_watch', 'title': 'Jarvis Pool Reviewer Watch', 'objective': 'Generate an automated watch for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'watch'}

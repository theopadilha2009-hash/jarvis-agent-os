...
FEATURE = {'slug': 'growth_guard', 'title': 'Jarvis Pool Growth Guard', 'objective': 'Generate an automated guard for the growth area using local repo signals.', 'domain': 'growth', 'action': 'guard'}

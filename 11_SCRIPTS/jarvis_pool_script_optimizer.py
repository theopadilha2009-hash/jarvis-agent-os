...
FEATURE = {'slug': 'script_optimizer', 'title': 'Jarvis Pool Script Optimizer', 'objective': 'Generate an automated optimizer for the script area using local repo signals.', 'domain': 'script', 'action': 'optimizer'}

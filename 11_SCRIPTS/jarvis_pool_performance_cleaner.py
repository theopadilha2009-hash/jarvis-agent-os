...
FEATURE = {'slug': 'performance_cleaner', 'title': 'Jarvis Pool Performance Cleaner', 'objective': 'Generate an automated cleaner for the performance area using local repo signals.', 'domain': 'performance', 'action': 'cleaner'}

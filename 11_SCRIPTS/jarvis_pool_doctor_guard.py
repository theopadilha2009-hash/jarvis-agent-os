...
FEATURE = {'slug': 'doctor_guard', 'title': 'Jarvis Pool Doctor Guard', 'objective': 'Generate an automated guard for the doctor area using local repo signals.', 'domain': 'doctor', 'action': 'guard'}

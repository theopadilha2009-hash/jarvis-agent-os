...
FEATURE = {'slug': 'validation_compressor', 'title': 'Jarvis Pool Validation Compressor', 'objective': 'Generate an automated compressor for the validation area using local repo signals.', 'domain': 'validation', 'action': 'compressor'}

...
FEATURE = {'slug': 'memory_score', 'title': 'Jarvis Pool Memory Score', 'objective': 'Generate an automated score for the memory area using local repo signals.', 'domain': 'memory', 'action': 'score'}

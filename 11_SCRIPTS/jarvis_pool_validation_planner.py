...
FEATURE = {'slug': 'validation_planner', 'title': 'Jarvis Pool Validation Planner', 'objective': 'Generate an automated planner for the validation area using local repo signals.', 'domain': 'validation', 'action': 'planner'}

...
FEATURE = {'slug': 'integration_explainer', 'title': 'Jarvis Pool Integration Explainer', 'objective': 'Generate an automated explainer for the integration area using local repo signals.', 'domain': 'integration', 'action': 'explainer'}

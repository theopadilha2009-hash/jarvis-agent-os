...
FEATURE = {'slug': 'audit_router', 'title': 'Jarvis Pool Audit Router', 'objective': 'Generate an automated router for the audit area using local repo signals.', 'domain': 'audit', 'action': 'router'}

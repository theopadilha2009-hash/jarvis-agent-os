...
FEATURE = {'slug': 'architecture_builder', 'title': 'Jarvis Pool Architecture Builder', 'objective': 'Generate an automated builder for the architecture area using local repo signals.', 'domain': 'architecture', 'action': 'builder'}

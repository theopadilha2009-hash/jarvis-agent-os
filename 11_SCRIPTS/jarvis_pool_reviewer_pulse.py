...
FEATURE = {'slug': 'reviewer_pulse', 'title': 'Jarvis Pool Reviewer Pulse', 'objective': 'Generate an automated pulse for the reviewer area using local repo signals.', 'domain': 'reviewer', 'action': 'pulse'}

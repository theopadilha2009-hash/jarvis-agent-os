...
FEATURE = {'slug': 'repo_meter', 'title': 'Jarvis Pool Repo Meter', 'objective': 'Generate an automated meter for the repo area using local repo signals.', 'domain': 'repo', 'action': 'meter'}

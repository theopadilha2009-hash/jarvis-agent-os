...
FEATURE = {'slug': 'execution_router', 'title': 'Jarvis Pool Execution Router', 'objective': 'Generate an automated router for the execution area using local repo signals.', 'domain': 'execution', 'action': 'router'}

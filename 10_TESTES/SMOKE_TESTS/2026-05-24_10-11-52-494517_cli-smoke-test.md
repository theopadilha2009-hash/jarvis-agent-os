...
OK  Snapshots de release existem — 274 arquivo(s)
OK  Smoke tests registrados — 101 arquivo(s)
OK  Release checks registrados — 106 arquivo(s)
...
- Local exec review: 05_EXECUCAO/16_LOCAL_EXEC_REVIEWS/2026-05-23_13-21-13-790151_local-exec-output-negated-only-sample_local-exec-review.md
...
- Release-check: 10_TESTES/RELEASE_CHECKS/2026-05-23_14-09-16-399472_release-check.md
- Safety-gate: 10_TESTES/SAFETY_GATES/2026-05-23_14-09-17-828220_safety-gate.md
- Smoke-test: 10_TESTES/SMOKE_TESTS/2026-05-23_14-09-01-469515_cli-smoke-test.md
...
## visual-cockpit
Comando: `env JARVIS_NO_REPORT=1 ./jarvis visual-cockpit`
Status: OK
Exit code: 0
Conteúdo ausente: nenhum

```text
JARVIS — Theo Padilha AI Worker Visual Cockpit
Status real: painel local. Nada executado em projeto real.
...
| smoke-test    | PASSOU          | 20h  | 10_TESTES/SMOKE_TESTS/2026-05-23_14-09-01-469515_cli-smoke-test.md |
| release-check | PASSOU          | 20h  | 10_TESTES/RELEASE_CHECKS/2026-05-23_14-09-16-399472_release-check.md |
| safety-gate   | PASSOU          | 20h  | 10_TESTES/SAFETY_GATES/2026-05-23_14-09-17-828220_safety-gate.md |
...
## claude-mission-jarvis-core-audit-no-report
Comando: `env JARVIS_NO_REPORT=1 ./jarvis claude-mission --jarvis-core --type audit plan safe next improvement`
Status: OK
Exit code: 0
Conteúdo ausente: nenhum

```text
JARVIS — Theo Padilha AI Worker Claude Mission
Status real: pacote de missão local. Nenhum projeto foi editado.

Scope: --jarvis-core
Type: audit
Task: plan safe next improvement

=== PREVIEW: 00_MISSION_SUMMARY.md ===
...
=== PREVIEW: 02_VALIDATION_CHECKLIST.md ===
...
## claude-mission-latest
Comando: `./jarvis claude-mission-latest`
Status: OK
Exit code: 0
Conteúdo ausente: nenhum

```text
JARVIS — Theo Padilha AI Worker Claude Mission Latest
Status real: leitura local da missão mais recente. Nenhum projeto foi editado.

Mission pack: 05_EXECUCAO/21_CLAUDE_MISSIONS/2026-05-23_14-03-56-165572_jarvis-core_patch_improve-jarvis-safely-without-production
Idade: 20h

Arquivos:
- [OK] 05_EXECUCAO/21_CLAUDE_MISSIONS/2026-05-23_14-03-56-165572_jarvis-core_patch_improve-jarvis-safely-without-production/00_MISSION_SUMMARY.md
- [OK] 05_EXECUCAO/21_CLAUDE_MISSIONS/2026-05-23_14-03-56-165572_jarvis-core_patch_improve-jarvis-safely-without-production/01_CLAUDE_PROMPT.md
- [OK] 05_EXECUCAO/21_CLAUDE_MISSIONS/2026-05-23_14-03-56-165572_jarvis-core_patch_improve-jarvis-safely-without-production/02_VALIDATION_CHECKLIST.md
- [OK] 05_EXECUCAO/21_CLAUDE_MISSIONS/2026-05-23_14-03-56-165572_jarvis-core_patch_improve-jarvis-safely-without-production/03_RETURN_FORMAT.md

=== Preview: 00_MISSION_SUMMARY.md (primeiras 30 linhas) ===
# Claude Mission Summary
...
Para colar no Claude Code, abra: 05_EXECUCAO/21_CLAUDE_MISSIONS/2026-05-23_14-03-56-165572_jarvis-core_patch_improve-jarvis-safely-without-production/01_CLAUDE_PROMPT.md
Produção: nada alterado.
```

## operator-workbench-general
Comando: `env JARVIS_NO_REPORT=1 ./jarvis operator-workbench`
Status: OK
Exit code: 0
Conteúdo ausente: nenhum

```text
JARVIS — Theo Padilha AI Worker Operator Workbench
Status real: painel local. Nada aplicado em projeto real.
...
2. Criar Claude mission segura — modo audit (read-only).
3. Criar Claude mission segura — modo patch (escopo curto e aprovado).
4. Abrir a última Claude mission gerada.
5. Escolher projeto travado (project-menu) e sair do modo geral.
...
Comando: `env JARVIS_NO_REPORT=1 ./jarvis operator-workbench --jarvis-core`
Status: OK
Exit code: 0
Conteúdo ausente: nenhum
...
3. Criar Claude mission segura — modo patch (escopo curto e aprovado).
4. Abrir a última Claude mission gerada.
5. Fechar/snapshotar versão atual quando tudo estiver verde.
...
Comando: `env JARVIS_NO_REPORT=1 ./jarvis operator-workbench --project oficina`
Status: OK
Exit code: 0
Conteúdo ausente: nenhum
...
10_TESTES/RELEASE_CHECKS/2026-05-23_14-09-16-399472_release-check.md

## Último smoke-test
10_TESTES/SMOKE_TESTS/2026-05-23_14-09-01-469515_cli-smoke-test.md
...
- review LOCAL_EXEC: 05_EXECUCAO/16_LOCAL_EXEC_REVIEWS/2026-05-23_13-21-13-790151_local-exec-output-negated-only-sample_local-exec-review.md
...
Arquivo: /Users/usuario1/Theo/JARVIS/VAMOO_JARVIS_LAB_v0_2_PRONTO/05_EXECUCAO/16_LOCAL_EXEC_REVIEWS/2026-05-23_13-21-13-790151_local-exec-output-negated-only-sample_local-exec-review.md
...
Comando: `env JARVIS_NO_REPORT=1 ./jarvis local-exec-review 10_TESTES/FIXTURES/local_exec_output_safe_sample.md`
Status: OK
Exit code: 0
Conteúdo ausente: nenhum
...
OK  /Users/usuario1/Theo/JARVIS/VAMOO_JARVIS_LAB_v0_2_PRONTO/10_TESTES/FIXTURES/local_exec_output_safe_sample.md -> (no report) [PODE SEGUIR COM REVISÃO]

Status real: revisão local. Projeto não alterado.
Relatório: desativado por JARVIS_NO_REPORT=1
Produção: nada alterado.
```

## local-exec-review-fixture-risky
Comando: `env JARVIS_NO_REPORT=1 ./jarvis local-exec-review 10_TESTES/FIXTURES/local_exec_output_risky_sample.md`
Status: OK
Exit code: 0
Conteúdo ausente: nenhum
...
OK  /Users/usuario1/Theo/JARVIS/VAMOO_JARVIS_LAB_v0_2_PRONTO/10_TESTES/FIXTURES/local_exec_output_risky_sample.md -> (no report) [PARAR E REVISAR COM HUMANO]
...
Comando: `env JARVIS_NO_REPORT=1 ./jarvis local-exec-review 10_TESTES/FIXTURES/local_exec_output_mixed_sample.md`
Status: OK
Exit code: 0
Conteúdo ausente: nenhum
...
OK  /Users/usuario1/Theo/JARVIS/VAMOO_JARVIS_LAB_v0_2_PRONTO/10_TESTES/FIXTURES/local_exec_output_mixed_sample.md -> (no report) [PARAR E REVISAR COM HUMANO]
...
Comando: `env JARVIS_NO_REPORT=1 ./jarvis local-exec-review 10_TESTES/FIXTURES/local_exec_output_codefence_sample.md`
Status: OK
Exit code: 0
Conteúdo ausente: nenhum
...
OK  /Users/usuario1/Theo/JARVIS/VAMOO_JARVIS_LAB_v0_2_PRONTO/10_TESTES/FIXTURES/local_exec_output_codefence_sample.md -> (no report) [PARAR E REVISAR COM HUMANO]
...
Comando: `env JARVIS_NO_REPORT=1 ./jarvis local-exec-review 10_TESTES/FIXTURES/local_exec_output_negated_only_sample.md`
Status: OK
Exit code: 0
Conteúdo ausente: nenhum
...
OK  /Users/usuario1/Theo/JARVIS/VAMOO_JARVIS_LAB_v0_2_PRONTO/10_TESTES/FIXTURES/local_exec_output_negated_only_sample.md -> (no report) [PODE SEGUIR COM REVISÃO]

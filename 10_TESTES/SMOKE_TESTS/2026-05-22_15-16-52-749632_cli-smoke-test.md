...
OK  Smoke tests registrados — 73 arquivo(s)
OK  Release checks registrados — 66 arquivo(s)
...
-  M 11_SCRIPTS/command_audit.py
-  M 11_SCRIPTS/jarvis_core.py
- ?? 11_SCRIPTS/local_exec_ready.py

Categorias detectadas:
- outros: 5 item(ns)

Comando de add sugerido:
# revisar manualmente antes de git add
...
- Release-check: 10_TESTES/RELEASE_CHECKS/2026-05-22_15-14-38-235633_release-check.md
- Safety-gate: 10_TESTES/SAFETY_GATES/2026-05-22_15-14-39-330959_safety-gate.md
- Smoke-test: 10_TESTES/SMOKE_TESTS/2026-05-22_15-14-30-002519_cli-smoke-test.md
...
10_TESTES/RELEASE_CHECKS/2026-05-22_15-14-38-235633_release-check.md

## Último smoke-test
10_TESTES/SMOKE_TESTS/2026-05-22_15-14-30-002519_cli-smoke-test.md
...
Status: FALHA
Exit code: 0
Conteúdo ausente: LOCAL_EXEC Ready Check, Projeto selecionado, Relatório: desativado por JARVIS_NO_REPORT=1

```text
File "/Users/usuario1/Theo/JARVIS/VAMOO_JARVIS_LAB_v0_2_PRONTO/11_SCRIPTS/local_exec_ready.py", line 187
    *[f"- {x}" for x in blockers] if blockers else ["- nenhum blocker crítico"],
                                  ^

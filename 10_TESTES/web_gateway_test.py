...
class WebGatewayTest(unittest.TestCase):
    ...
    def test_cockpit_and_model_asset(self):
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260813-uipolish1', html)
        self.assertIn(b'/ui/jarvis.css?v=20260813-uipolish1', html)
        ...
        self.assertIn(b"jarvis-mobile-shell-20260813-uipolish1", service_worker)

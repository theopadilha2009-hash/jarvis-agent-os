...
class WebGatewayTest(unittest.TestCase):
    ...
    def test_cockpit_and_model_asset(self):
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260812-frontal1', html)
        self.assertIn(b'/ui/jarvis.css?v=20260812-frontal1', html)
        ...
        self.assertIn(b"normalizeModel(visitorModel, -Math.PI / 2);", visual_js)
        ...
        self.assertIn(b"jarvis-mobile-shell-20260812-frontal1", service_worker)

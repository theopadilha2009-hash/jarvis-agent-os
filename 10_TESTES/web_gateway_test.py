...
class WebGatewayTest(unittest.TestCase):
    ...
    def test_cockpit_and_model_asset(self):
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260821-edit1', html)
        self.assertIn(b'id="updateToast"', html)
        self.assertIn(b'id="shellVersion"', html)
        self.assertIn(b'/ui/local-voice.js?v=20260818-voice2', html)
        self.assertIn(b'/ui/shell.css?v=20260821-edit1', html)
        self.assertIn(b'id="welcomeLogin"', html)
        self.assertIn(b'/ui/jarvis.css?v=20260821-edit1', html)
        ...
        self.assertIn(b"jarvis-mobile-shell-20260821-edit1", service_worker)
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260821-edit1', service_worker)
        self.assertIn(b'/ui/local-voice.js?v=20260818-voice2', service_worker)
        self.assertIn(b'/ui/jarvis.css?v=20260821-edit1', service_worker)
        self.assertIn(b"await caches.match(request);", service_worker)
        self.assertIn(b'/ui/shell.css?v=20260821-edit1', service_worker)

...
class WebGatewayTest(unittest.TestCase):
    ...
    def test_status_and_security_headers(self):
        ...
        self.assertIn("http://127.0.0.1:8123", headers["Content-Security-Policy"])
        self.assertIn("http://localhost:8123", headers["Content-Security-Policy"])
        self.assertNotIn("upgrade-insecure-requests", headers["Content-Security-Policy"])
    ...
    def test_fala_app_and_mac_download_pack(self):
        ...
        self.assertIn(b'id="updateToast"', html)
        self.assertIn(b'id="buildLine"', html)
    ...
    def test_cockpit_and_model_asset(self):
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260820-update1', html)
        self.assertIn(b'id="updateToast"', html)
        self.assertIn(b'id="shellVersion"', html)
        self.assertIn(b'/ui/local-voice.js?v=20260818-voice2', html)
        self.assertIn(b'/ui/shell.css?v=20260820-update1', html)
        self.assertIn(b'id="welcomeLogin"', html)
        self.assertIn(b'/ui/jarvis.css?v=20260820-update1', html)
        ...
        self.assertIn(b"jarvis-mobile-shell-20260820-update1", service_worker)
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260820-update1', service_worker)
        self.assertIn(b'/ui/local-voice.js?v=20260818-voice2', service_worker)
        self.assertIn(b'/ui/jarvis.css?v=20260820-update1', service_worker)
        self.assertIn(b"await caches.match(request);", service_worker)
        self.assertIn(b'/ui/shell.css?v=20260820-update1', service_worker)
    ...
    def test_ultron_maximum_strength_uses_private_persona_and_deep_route(self):
        ...
        system_prompt = sent_payload["messages"][0]["content"]
        self.assertIn("Você é JARVIS", system_prompt)
        self.assertIn("CAPACIDADE MÁXIMA", system_prompt)
        self.assertIn("FORÇA MÁXIMA", system_prompt)
        self.assertIn("mantenha as proteções reais", system_prompt)
        self.assertNotIn("nunca se chame JARVIS", system_prompt)
        self.assertNotIn("ULTRON", system_prompt)
        self.assertIn("português brasileiro nativo", system_prompt)
        self.assertEqual(payload["persona"]["id"], "jarvis_owner")
...
"""
    ...
    def test_ultron_orchestrates_three_verified_model_tools_and_reports_each_front(self):
        ...
        self.assertTrue(payload["ok"])
        self.assertTrue(payload["agentic"])
        self.assertEqual(payload["provider"], "jarvis_orchestrator")
        self.assertEqual(payload["orchestration"]["protocol"], "jarvis-orchestration/1")
    ...
    def test_tool_orchestrator_caps_three_fronts_and_keeps_partial_failure_visible(self):
        ...
        self.assertFalse(payload["ok"])
        self.assertEqual(payload["status_real"], "jarvis_orchestration_partial")
    ...
    def test_execution_power_profile_is_one_x_for_jarvis_and_three_x_for_ultron(self):
        ...
        self.assertEqual(ultron["mode"], "jarvis_3x")

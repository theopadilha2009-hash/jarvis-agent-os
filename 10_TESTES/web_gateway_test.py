...
class WebGatewayTest(unittest.TestCase):
    ...
    def test_cockpit_and_model_asset(self):
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260814-chatfix12', html)
        self.assertIn(b'/ui/shell-final.css?v=20260814-chatfix12', html)
        self.assertIn(b'/ui/jarvis.css?v=20260814-chatfix1', html)
        self.assertIn(b'/ui/ui-repair.css?v=20260814-chatfix11', html)
        self.assertIn(b'/ui/api-panel.css?v=20260813-ultronfix1', html)
        self.assertNotIn(b'/ui/integration-health.css?v=', html)
        self.assertIn(b'/ui/responsive-polish.css?v=20260814-chatfix11', html)
        ...
        self.assertIn(b"jarvis-mobile-shell-20260814-chatfix12", service_worker)
        self.assertIn(b'/ui/jarvis-logo.png?v=20260813-logonative1', service_worker)
        self.assertIn(b'/ui/ui-repair.css?v=20260814-chatfix11', service_worker)
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260814-chatfix12', service_worker)
        self.assertIn(b'/ui/shell-final.css?v=20260814-chatfix12', service_worker)
        ...
        self.assertIn(b'/ui/responsive-polish.css?v=20260814-chatfix11', service_worker)

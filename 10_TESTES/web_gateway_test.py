...
class WebGatewayTest(unittest.TestCase):
    ...
    def test_cockpit_and_model_asset(self):
        ...
        self.assertIn(b'/ui/jarvis-logo.png?v=20260813-uipolish1', html)
        self.assertIn(b'/ui/api-vault.js?v=20260813-apiux1', html)
        self.assertIn(b'/ui/jarvis.js?v=20260813-apiux1', html)
        self.assertIn(b'/ui/jarvis.css?v=20260813-apiux1', html)
        self.assertIn(b'/ui/ui-repair.css?v=20260813-uipolish1', html)
        self.assertIn(b'/ui/api-panel.css?v=20260813-apiux1', html)
        ...
        self.assertIn(b'/ui/aurora.js', html)
        self.assertIn(b'/ui/strands.js', html)
        ...
        status, headers, logo_filter = self.request("/ui/logo-filter.svg")
        self.assertEqual(status, 200)
        self.assertEqual(headers.get_content_type(), "image/svg+xml")
        self.assertIn(b'id="logoNoBlack"', logo_filter)
        ...
        self.assertIn(b"jarvis-mobile-shell-20260813-apiux1", service_worker)
        self.assertIn(b'/ui/jarvis-logo.png?v=20260813-uipolish1', service_worker)
        self.assertIn(b'/ui/ui-repair.css?v=20260813-uipolish1', service_worker)
        self.assertIn(b'/ui/logo-filter.svg?v=20260813-uipolish1', service_worker)
        self.assertIn(b'/ui/api-vault.js?v=20260813-apiux1', service_worker)
        self.assertIn(b'/ui/api-panel.css?v=20260813-apiux1', service_worker)

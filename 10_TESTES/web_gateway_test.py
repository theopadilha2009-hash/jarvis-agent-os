...
class WebGatewayTest(unittest.TestCase):
    ...
    def test_cockpit_and_model_asset(self):
        ...
        self.assertIn(b'id="visitorPresenceLite"', html)
        self.assertIn(b'class="lite-wave-field"', html)
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260812-lite1', html)
        self.assertIn(b'/ui/jarvis.css?v=20260812-lite1', html)
        ...
        self.assertIn(b"loadOwnerPresence", html)
        self.assertIn("Avatar leve · 0 GPU".encode(), html)
        self.assertNotIn(b'import { createStrands }', html)
        ...
        self.assertIn(b"20260812-lite1", visual_js)
        ...
        self.assertIn(b"pointerX * 0.1", visual_js)
        self.assertIn(b"orientationEase", visual_js)
        self.assertNotIn(b"loadObjHead", visual_js)
        self.assertNotIn(b"male_head.obj", visual_js)
        self.assertIn(b'light-visitor+ultron-owner', visual_js)
        ...
        self.assertIn(b"jarvis-mobile-shell-20260812-lite1", service_worker)
        self.assertNotIn(b"strands.js", service_worker)

...
class WebGatewayTest(unittest.TestCase):
    ...
    def test_cockpit_and_model_asset(self):
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260818-parse1', html)
        ...
        self.assertIn(b"jarvis-mobile-shell-20260818-parse1", service_worker)
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260818-parse1', service_worker)

...
class WebGatewayTest(unittest.TestCase):
    ...
    def test_cockpit_and_model_asset(self):
        ...
        self.assertIn(b'/ui/jarvis-logo.png?v=20260813-essence1', html)
        self.assertIn(b'/ui/jarvis.js?v=20260813-essence1', html)
        self.assertIn(b'/ui/jarvis.css?v=20260813-essence1', html)
        self.assertIn(b'/ui/manifest.webmanifest?v=20260813-essence1', html)
        ...
        self.assertNotIn(b'/ui/strands.js', html)
        ...
        self.assertIn(b"visitor-internal-neural-network", visual_js)
        self.assertIn(b"TubeGeometry", visual_js)
        self.assertIn(b"visitor-real-eye", visual_js)
        self.assertIn(b"neuralNodes", visual_js)
        ...
        self.assertIn(b"jarvis-mobile-shell-20260813-essence1", service_worker)
        self.assertIn(b'/ui/jarvis-logo.png?v=20260813-essence1', service_worker)

...
class WebGatewayTest(unittest.TestCase):
    ...
    def test_cockpit_and_model_asset(self):
        ...
        self.assertIn(b'class="voice-wave"', html)
        self.assertNotIn(b'id="strandsVisual"', html)
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260812-purplebust6', html)
        self.assertIn(b'/ui/jarvis.css?v=20260812-purplebust6', html)
        ...
        self.assertIn(b".voice-wave", app_css)
        ...
        self.assertIn(b"color: 0x9b67e8", visual_js)
        self.assertIn(b"opacity: 0.64", visual_js)
        self.assertIn(b"detailPositions", visual_js)
        self.assertIn(b"eyeDetail", visual_js)
        self.assertIn(b"cheekDetail", visual_js)
        self.assertIn(b"templeDetail", visual_js)
        self.assertIn(b"visitor-triangulation-detail", visual_js)
        ...
        self.assertIn(b"jarvis-mobile-shell-20260812-purplebust6", service_worker)

...
class WebGatewayTest(unittest.TestCase):
    ...
    def test_cockpit_and_model_asset(self):
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260814-chatfix10', html)
        self.assertIn(b'/ui/jarvis.css?v=20260814-chatfix1', html)
        self.assertIn(b'/ui/ui-repair.css?v=20260814-chatfix10', html)
        ...
        self.assertEqual(status, 200)
        self.assertEqual(headers.get_content_type(), "text/javascript")
        self.assertIn(b"jarvis-3d.js?v=20260813-ultronfix1", presence_loader)
        ...
        self.assertIn(b"jarvis-mobile-shell-20260814-chatfix10", service_worker)
        self.assertIn(b'/ui/jarvis-logo.png?v=20260813-logonative1', service_worker)
        self.assertIn(b'/ui/ui-repair.css?v=20260814-chatfix10', service_worker)
        ...
        self.assertIn(b'/ui/jarvis.js?v=20260814-chatfix10', service_worker)

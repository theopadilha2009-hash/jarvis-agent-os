...
class FalaOverlayTest(unittest.TestCase):
    ...
    def test_wake_loop_listens_for_oi_jarvis(self):
        ...
        self.assertIn("20260820-listen14", FALA_HTML)
        ...
        self.assertIn("vizwave", (ROOT / "web" / "fala.css").read_text(encoding="utf-8"))
        self.assertIn("168, 85, 247", (ROOT / "web" / "fala.css").read_text(encoding="utf-8"))
        self.assertIn("idle-orb", (ROOT / "web" / "fala.css").read_text(encoding="utf-8"))

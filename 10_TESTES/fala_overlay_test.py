...
class FalaOverlayTest(unittest.TestCase):
    ...
    def test_wake_loop_listens_for_oi_jarvis(self):
        ...
        self.assertIn("A mesma conta do site.", FALA_HTML)
        ...
        self.assertIn("20260821-park2", FALA_HTML)
        self.assertIn('nativeWindow("hide")', FALA_JS)
        self.assertIn("parkSoon", FALA_JS)
        self.assertIn("parkNow", FALA_JS)
        self.assertIn("holdReply", FALA_JS)
        self.assertIn("compactReply", FALA_JS)
        self.assertIn(", 2000)", FALA_JS)
        self.assertIn("reply:", FALA_JS)
        self.assertIn("has-reply", FALA_JS)
        ...
        self.assertIn("analisa isso", FALA_JS)
        self.assertIn("paintHome", FALA_JS)
        self.assertIn("app-mode.needs-login", (ROOT / "web" / "fala.css").read_text(encoding="utf-8"))
        ...
        self.assertIn("has-reply", css)
        self.assertIn("#lastAnswer", css)
